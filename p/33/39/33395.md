...
version:0
lang:zh
rawUrl:https://developer.mozilla.org/en-US/docs/Web/CSS/::-ms-value
---
...
The**`::-ms-value`**[CSS]427 "")[pseudo-element]3563 "")is a[Microsoft extension]28320 "")that applies rules to the value of a text or password[`<input>`]17158 "The HTML <input> element is used to create interactive controls for web-based forms in order to accept data from the user.")control or the content of a[`<select>`]18852 "The HTML <select> element represents a control that provides a menu of options:")control.
