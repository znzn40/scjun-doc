...
version:0
lang:zh
rawUrl:https://developer.mozilla.org/en-US/docs/Web/CSS/::-ms-fill-upper
---
...
The**`::-ms-fill-upper`**[CSS]427 "")[pseudo-element]3563 "")is a[Microsoft extension]28320 "")that represents the upper portion of the track of a slider control; that is, the portion corresponding to values greater than the value currently selected by the thumb. A slider control is one possible representation of[&lt;input type=&quot;range&quot;&gt;]37447 "").


## Allowable Properties<a name="Allowable_properties"></a>


Only the following CSS properties can be used in a rule with`::-ms-fill-upper`in its selector. Other properties are ignored.
