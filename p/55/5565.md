...
## Creating a Git repository<a name="_creating_a_git_repository"></a>
...
## Populating a Git repository<a name="_populating_a_git_repository"></a>
...
## Committing Git state<a name="_committing_git_state"></a>
...
## Making a change<a name="_making_a_change"></a>
...
## Inspecting Changes<a name="_inspecting_changes"></a>
...
## Tagging a version<a name="_tagging_a_version"></a>
...
## Copying repositories<a name="_copying_repositories"></a>
...
## Creating a new branch<a name="_creating_a_new_branch"></a>
...
Note | If you make the decision to start your new branch at some other point in the history than the current`HEAD`, you can do so by just telling*git checkout*what the base of the checkout would be. In other words, if you have an earlier tag or branch, you’d just do
...
## Merging two branches<a name="_merging_two_branches"></a>
...
## Merging external work<a name="_merging_external_work"></a>
...
<dl><dt id='gitcore-tutorial-SSH'>SSH</dt><dd>
...
</dd><dt id='gitcore-tutorial-Localdirectory'>Local directory</dt><dd>
...
</dd><dt id='gitcore-tutorial-GitNative'>Git Native</dt><dd>
...
</dd><dt id='gitcore-tutorial-HTTPS'>HTTP(S)</dt><dd>
...
## How does the merge work?<a name="_how_does_the_merge_work"></a>
...
## Publishing your work<a name="_publishing_your_work"></a>
...
## Packing your repository<a name="_packing_your_repository"></a>
...
## Working with Others<a name="_working_with_others"></a>
...
1. *git repack*the public repository. This establishes a big pack that contains the initial set of objects as the baseline, and possibly*git prune*if the transport used for pulling from your repository supports packed repositories.
...
1. Every once in a while,*git repack*the public repository. Go back to step 5. and continue working.
...
1. Push into the public repository from your primary repository. Run*git repack*, and possibly*git prune*if the transport used for pulling from your repository supports packed repositories.
...
1. Do your work in your repository on*master*branch.
...
## Working with Others, Shared Repository Style<a name="_working_with_others_shared_repository_style"></a>
...
## Bundling your work together<a name="_bundling_your_work_together"></a>
