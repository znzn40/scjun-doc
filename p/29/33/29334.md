...
The animation starts slowly, accelerates sharply, and then slows gradually towards the end. This keyword represents the timing function`cubic-bezier(0.25, 0.1, 0.25, 1.0)`. It is similar to[`ease-in-out`](%28336#ease-in-out ""), though it accelerates more sharply at the beginning.
...
The animation starts slowly, speeds up, and then slows down towards the end. This keyword represents the timing function`cubic-bezier(0.42, 0.0, 0.58, 1.0)`. At the beginning, it behaves like the[`ease-in`](%28336#ease-in "")function; at the end, it is like the[`ease-out`](%28336#ease-out "")function.
