...
<dl><dt id='git-read-tree--m'>-m</dt><dd>
...
</dd><dt id='git-read-tree---aggressive'>--aggressive</dt><dd>
...
</dd><dt id='git-read-tree---prefixltprefixgt'>--prefix=&lt;prefix&gt;</dt><dd>
...
</dd><dt id='git-read-tree---exclude-per-directoryltgitignoregt'>--exclude-per-directory=&lt;gitignore&gt;</dt><dd>
...
</dd><dt id='git-read-tree---index-outputltfilegt'>--index-output=&lt;file&gt;</dt><dd>
...
</dd><dt id='git-read-tree---no-recurse-submodules'>--[no-]recurse-submodules</dt><dd>
...
</dd><dt id='git-read-tree---no-sparse-checkout'>--no-sparse-checkout</dt><dd>

Disable sparse checkout support even if`core.sparseCheckout`is true.

</dd><dt id='git-read-tree---empty'>--empty</dt><dd>

Instead of reading tree object(s) into the index, just empty it.

</dd><dt id='git-read-tree-lttree-ishgt'>&lt;tree-ish#&gt;</dt><dd>
...
### Single Tree Merge<a name="_single_tree_merge"></a>
...
### Two Tree Merge<a name="_two_tree_merge"></a>
...
### 3-Way Merge<a name="_3_way_merge"></a>
...
## SPARSE CHECKOUT<a name="_sparse_checkout"></a>
