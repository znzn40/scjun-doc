...
version:0
lang:zh
rawUrl:https://developer.mozilla.org/en-US/docs/Web/CSS/::-ms-clear
---
...
The`**::-ms-clear**`CSS[pseudo-element]28397 "en/CSS/Pseudo-elements")creates a clear button at the edge of an[&lt;input type=&quot;text&quot;&gt;]37431 "")text control that clears the current value. This pseudo-element is non-standard, supported only in Internet Explorer 10, Internet Explorer 11, and Microsoft Edge. The clear button is only shown on focused, non-empty text controls.
...
<iframe src='https://mdn.mozillademos.org/en-US/docs/Web/CSS/::-ms-clear$samples/Example?revision=1378012' width='null' height='null'></iframe>
...
[1] In an[&lt;input type=&quot;text&quot;&gt;]37431 "")element styled with[`text-align`]33033 "The text-align CSS property describes how inline content like text is aligned in its parent block element. text-align does not control the alignment of block elements, only their inline content.")`: right`, if the clear button is shown, it will clip off the right edge of the text value of the[input type=&quot;text&quot;&gt;]37431 "")element. A workaround is to hide the clear button using[`display`]30836 "The display CSS property specifies the type of rendering box used for an element. In HTML, default display property values are taken from behaviors described in the HTML specifications or from the browser/user default stylesheet. The default value in XML is inline, including SVG elements.")`: none`.
