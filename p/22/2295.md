...
<dl><dt id='git-svn-eminitem'><em>init</em></dt><dd>
...
<dl><dt id='git-svn--Tlttrunksubdirgt'>-T&lt;trunk_subdir&gt;</dt><dt id='git-svn---trunklttrunksubdirgt'>--trunk=&lt;trunk_subdir&gt;</dt><dt id='git-svn--tlttagssubdirgt'>-t&lt;tags_subdir&gt;</dt><dt id='git-svn---tagslttagssubdirgt'>--tags=&lt;tags_subdir&gt;</dt><dt id='git-svn--bltbranchessubdirgt'>-b&lt;branches_subdir&gt;</dt><dt id='git-svn---branchesltbranchessubdirgt'>--branches=&lt;branches_subdir&gt;</dt><dt id='git-svn--s'>-s</dt><dt id='git-svn---stdlayout'>--stdlayout</dt><dd>
...
</dd><dt id='git-svn---no-metadata'>--no-metadata</dt><dd>
...
</dd><dt id='git-svn---use-svm-props'>--use-svm-props</dt><dd>

Set the<em>useSvmProps</em>option in the [svn-remote] config.

</dd><dt id='git-svn---use-svnsync-props'>--use-svnsync-props</dt><dd>

Set the<em>useSvnsyncProps</em>option in the [svn-remote] config.

</dd><dt id='git-svn---rewrite-rootltURLgt'>--rewrite-root=&lt;URL&gt;</dt><dd>

Set the<em>rewriteRoot</em>option in the [svn-remote] config.

</dd><dt id='git-svn---rewrite-uuidltUUIDgt'>--rewrite-uuid=&lt;UUID&gt;</dt><dd>

Set the<em>rewriteUUID</em>option in the [svn-remote] config.

</dd><dt id='git-svn---usernameltusergt'>--username=&lt;user&gt;</dt><dd>
...
</dd><dt id='git-svn---prefixltprefixgt'>--prefix=&lt;prefix&gt;</dt><dd>
...
</dd><dt id='git-svn---ignore-refsltregexgt'>--ignore-refs=&lt;regex&gt;</dt><dd>
...
</dd><dt id='git-svn---ignore-pathsltregexgt'>--ignore-paths=&lt;regex&gt;</dt><dd>
...
</dd><dt id='git-svn---include-pathsltregexgt'>--include-paths=&lt;regex&gt;</dt><dd>
...
</dd><dt id='git-svn---no-minimize-url'>--no-minimize-url</dt><dd>
...
</dd><dt id='git-svn-emfetchem'><em>fetch</em></dt><dd>
...
<dl><dt id='git-svn---localtime'>--localtime</dt><dd>
...
</dd><dt id='git-svn---parent'>--parent</dt><dd>
...
<dl><dt id='git-svn-Skipdocdirectoryforeveryfetch'>Skip &quot;doc*&quot; directory for every fetch</dt><dd>
```
--ignore-paths="^doc"
```


</dd><dt id='git-svn-Skipbranchesandtagsoffirstleveldirectories'>Skip &quot;branches&quot; and &quot;tags&quot; of first level directories</dt><dd>
```
...
</dd><dt id='git-svn---log-window-sizeltngt'>--log-window-size=&lt;n&gt;</dt><dd>
...
</dd><dt id='git-svn-emcloneem'><em>clone</em></dt><dd>
...
<dl><dt id='git-svn---preserve-empty-dirs'>--preserve-empty-dirs</dt><dd>
...
</dd><dt id='git-svn---placeholder-filenameltfilenamegt'>--placeholder-filename=&lt;filename&gt;</dt><dd>

Set the name of placeholder files created by --preserve-empty-dirs. Default: &quot;.gitignore&quot;

</dd></dl>
</dd><dt id='git-svn-emrebaseem'><em>rebase</em></dt><dd>
...
<dl><dt id='git-svn--l'>-l</dt><dt id='git-svn---local'>--local</dt><dd>

Do not fetch remotely; only run<em>git rebase</em>against the last fetched commit from the upstream SVN.

</dd></dl>
</dd><dt id='git-svn-emdcommitem'><em>dcommit</em></dt><dd>
...
<dl><dt id='git-svn---no-rebase'>--no-rebase</dt><dd>

After committing, do not rebase or reset.

</dd><dt id='git-svn---commit-urlltURLgt'>--commit-url &lt;URL&gt;</dt><dd>
...
</dd><dt id='git-svn---mergeinfoltmergeinfogt'>--mergeinfo=&lt;mergeinfo&gt;</dt><dd>
...
</dd><dt id='git-svn---interactive'>--interactive</dt><dd>
...
</dd><dt id='git-svn-embranchem'><em>branch</em></dt><dd>

Create a branch in the SVN repository.

<dl><dt id='git-svn--m'>-m</dt><dt id='git-svn---message'>--message</dt><dd>

Allows to specify the commit message.

</dd><dt id='git-svn--t'>-t</dt><dt id='git-svn---tag'>--tag</dt><dd>

Create a tag by using the tags_subdir instead of the branches_subdir specified during git svn init.

</dd><dt id='git-svn--dltpathgt'>-d&lt;path&gt;</dt><dt id='git-svn---destinationltpathgt'>--destination=&lt;path&gt;</dt><dd>
...
</dd><dt id='git-svn---parents'>--parents</dt><dd>
...
</dd><dt id='git-svn-emtagem'><em>tag</em></dt><dd>

Create a tag in the SVN repository. This is a shorthand for<em>branch -t</em>.

</dd><dt id='git-svn-emlogem'><em>log</em></dt><dd>
...
<dl><dt id='git-svn--rltngtltngt'>-r &lt;n&gt;[:&lt;n&gt;]</dt><dt id='git-svn---revisionltngtltngt'>--revision=&lt;n&gt;[:&lt;n&gt;]</dt><dd>

is supported, non-numeric args are not: HEAD, NEXT, BASE, PREV, etc …​

</dd><dt id='git-svn--v'>-v</dt><dt id='git-svn---verbose'>--verbose</dt><dd>

it’s not completely compatible with the --verbose output in svn log, but reasonably close.

</dd><dt id='git-svn---limitltngt'>--limit=&lt;n&gt;</dt><dd>

is NOT the same as --max-count, doesn’t count merged/excluded commits

</dd><dt id='git-svn---incremental'>--incremental</dt><dd>
...
<dl><dt id='git-svn---show-commit'>--show-commit</dt><dd>

shows the Git commit sha1, as well

</dd><dt id='git-svn---oneline'>--oneline</dt><dd>
...
</dd><dt id='git-svn-emblameem'><em>blame</em></dt><dd>
...
<dl><dt id='git-svn---git-format'>--git-format</dt><dd>
...
</dd><dt id='git-svn-emfind-revem'><em>find-rev</em></dt><dd>
...
<dl><dt id='git-svn--B'>-B</dt><dt id='git-svn---before'>--before</dt><dd>
...
</dd><dt id='git-svn--A'>-A</dt><dt id='git-svn---after'>--after</dt><dd>
...
</dd><dt id='git-svn-emset-treeem'><em>set-tree</em></dt><dd>
...
</dd><dt id='git-svn-emcreate-ignoreem'><em>create-ignore</em></dt><dd>
...
</dd><dt id='git-svn-emshow-ignoreem'><em>show-ignore</em></dt><dd>
...
</dd><dt id='git-svn-emmkdirsem'><em>mkdirs</em></dt><dd>
...
</dd><dt id='git-svn-emcommit-diffem'><em>commit-diff</em></dt><dd>
...
<dl><dt id='git-svn--mltmsggt'>-m &lt;msg&gt;</dt><dt id='git-svn---messageltmsggt'>--message=&lt;msg&gt;</dt><dd>

Use the given`msg`as the commit message. This option disables the`--edit`option.

</dd><dt id='git-svn--Fltfilenamegt'>-F &lt;filename&gt;</dt><dt id='git-svn---fileltfilenamegt'>--file=&lt;filename&gt;</dt><dd>

Take the commit message from the given file. This option disables the`--edit`option.

</dd></dl>
</dd><dt id='git-svn-eminfoem'><em>info</em></dt><dd>
...
</dd><dt id='git-svn-emproplistem'><em>proplist</em></dt><dd>
...
<dl><dt id='git-svn--rltngt'>-r &lt;n&gt;</dt><dt id='git-svn---revisionltngt'>--revision=&lt;n&gt;</dt><dd>

Specify the most recent revision to keep. All later revisions are discarded.

</dd><dt id='git-svn--p'>-p</dt><dt id='git-svn---parent'>--parent</dt><dd>

Discard the specified revision as well, keeping the nearest parent instead.

</dd><dt id='git-svn-Example'>Example:</dt><dd>
...
<dl><dt id='git-svn---sharedfalsetrueumaskgroupallworldeverybody'>--shared[=(false|true|umask|group|all|world|everybody)]</dt><dt id='git-svn---templatelttemplatedirectorygt'>--template=&lt;template_directory&gt;</dt><dd>

Only used with the<em>init</em>command. These are passed directly to<em>git init</em>.

</dd><dt id='git-svn--rltarggt'>-r &lt;arg&gt;</dt><dt id='git-svn---revisionltarggt'>--revision &lt;arg&gt;</dt><dd>
...
</dd><dt id='git-svn--'>-</dt><dt id='git-svn---stdin'>--stdin</dt><dd>
...
</dd><dt id='git-svn---rmdir'>--rmdir</dt><dd>
...
</dd><dt id='git-svn--e'>-e</dt><dt id='git-svn---edit'>--edit</dt><dd>
...
</dd><dt id='git-svn--lltnumgt'>-l&lt;num&gt;</dt><dt id='git-svn---find-copies-harder'>--find-copies-harder</dt><dd>
...
</dd><dt id='git-svn--Altfilenamegt'>-A&lt;filename&gt;</dt><dt id='git-svn---authors-fileltfilenamegt'>--authors-file=&lt;filename&gt;</dt><dd>
...
</dd><dt id='git-svn---authors-progltfilenamegt'>--authors-prog=&lt;filename&gt;</dt><dd>
...
</dd><dt id='git-svn--q'>-q</dt><dt id='git-svn---quiet'>--quiet</dt><dd>

Make<em>git svn</em>less verbose. Specify a second time to make it even less verbose.

</dd><dt id='git-svn--m'>-m</dt><dt id='git-svn---merge'>--merge</dt><dt id='git-svn--sltstrategygt'>-s&lt;strategy&gt;</dt><dt id='git-svn---strategyltstrategygt'>--strategy=&lt;strategy&gt;</dt><dt id='git-svn--p'>-p</dt><dt id='git-svn---preserve-merges'>--preserve-merges</dt><dd>
...
</dd><dt id='git-svn--n'>-n</dt><dt id='git-svn---dry-run'>--dry-run</dt><dd>
...
</dd><dt id='git-svn---use-log-author'>--use-log-author</dt><dd>
...
</dd><dt id='git-svn---add-author-from'>--add-author-from</dt><dd>
...
## ADVANCED OPTIONS<a name="_advanced_options"></a>
<dl><dt id='git-svn--iltGITSVNIDgt'>-i&lt;GIT_SVN_ID&gt;</dt><dt id='git-svn---idltGITSVNIDgt'>--id &lt;GIT_SVN_ID&gt;</dt><dd>
...
</dd><dt id='git-svn--Rltremotenamegt'>-R&lt;remote name&gt;</dt><dt id='git-svn---svn-remoteltremotenamegt'>--svn-remote &lt;remote name&gt;</dt><dd>

Specify the [svn-remote &quot;&lt;remote name&gt;&quot;] section to use, this allows SVN multiple repositories to be tracked. Default: &quot;svn&quot;

</dd><dt id='git-svn---follow-parent'>--follow-parent</dt><dd>
...
## CONFIG FILE-ONLY OPTIONS<a name="_config_file_only_options"></a>
<dl><dt id='git-svn-svnnoMetadata'>svn.noMetadata</dt><dt id='git-svn-svn-remoteltnamegtnoMetadata'>svn-remote.&lt;name&gt;.noMetadata</dt><dd>
...
</dd><dt id='git-svn-svnuseSvmProps'>svn.useSvmProps</dt><dt id='git-svn-svn-remoteltnamegtuseSvmProps'>svn-remote.&lt;name&gt;.useSvmProps</dt><dd>
...
</dd><dt id='git-svn-svnuseSvnsyncProps'>svn.useSvnsyncProps</dt><dt id='git-svn-svn-remoteltnamegtuseSvnsyncprops'>svn-remote.&lt;name&gt;.useSvnsyncprops</dt><dd>

Similar to the useSvmProps option; this is for users of the svnsync(1) command distributed with SVN 1.4.x and later.

</dd><dt id='git-svn-svn-remoteltnamegtrewriteRoot'>svn-remote.&lt;name&gt;.rewriteRoot</dt><dd>
...
</dd><dt id='git-svn-svn-remoteltnamegtrewriteUUID'>svn-remote.&lt;name&gt;.rewriteUUID</dt><dd>
...
</dd><dt id='git-svn-svn-remoteltnamegtpushurl'>svn-remote.&lt;name&gt;.pushurl</dt><dd>
...
</dd><dt id='git-svn-svnbrokenSymlinkWorkaround'>svn.brokenSymlinkWorkaround</dt><dd>
...
</dd><dt id='git-svn-svnpathnameencoding'>svn.pathnameencoding</dt><dd>
...
</dd><dt id='git-svn-svn-remoteltnamegtautomkdirs'>svn-remote.&lt;name&gt;.automkdirs</dt><dd>
...
## BASIC EXAMPLES<a name="_basic_examples"></a>
...
## REBASE VS. PULL/MERGE<a name="_rebase_vs_pull_merge"></a>
...
## MERGE TRACKING<a name="_merge_tracking"></a>
...
## HANDLING OF SVN BRANCHES<a name="_handling_of_svn_branches"></a>
...
<dl><dt id='git-svn-GITDIRsvnrevmap'>$GIT_DIR/svn/*\*/.rev_map.*</dt><dd>
