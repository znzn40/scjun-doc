...
version:2.*
lang:en
rawUrl:https://git-scm.com/docs/user-manual.html
---
...
See also[Appendix A: Git Quick Reference](%5214#git-quick-start "")for a brief overview of Git commands, without any explanation.
...
# Repositories and Branches<a name="repositories-and-branches"></a>

## How to get a Git repository<a name="how-to-get-a-git-repository"></a>
...
The clone command creates a new directory named after the project (`git`or`linux`in the examples above). After you cd into this directory, you will see that it contains a copy of the project files, called the[working tree](%5214#def_working_tree ""), together with a special top-level directory named`.git`, which contains all the information about the history of the project.





## How to check out a different version of a project<a name="how-to-check-out"></a>


Git is best thought of as a tool for storing the history of a collection of files. It stores the history as a compressed collection of interrelated snapshots of the project’s contents. In Git each such version is called a[commit](%5214#def_commit "").




Those snapshots aren’t necessarily all arranged in a single line from oldest to newest; instead, work may simultaneously proceed along parallel lines of development, called[branches](%5214#def_branch ""), which may merge and diverge.




A single Git repository can track development on multiple branches. It does this by keeping a list of[heads](%5214#def_head "")which reference the latest commit on each branch; the[git-branch[1]](%2260  "")command shows you the list of branch heads:
...
Most projects also use[tags](%5214#def_tag ""). Tags, like heads, are references into the project’s history, and can be listed using the[git-tag[1]](%2266  "")command:
...
## Understanding History: Commits<a name="understanding-commits"></a>
...
### Understanding history: commits, parents, and reachability<a name="understanding-reachability"></a>
...
### Understanding history: History diagrams<a name="history-diagrams"></a>
...
### Understanding history: What is a branch?<a name="what-is-a-branch"></a>
...
## Manipulating branches<a name="manipulating-branches"></a>


Creating, deleting, and modifying branches is quick and easy; here’s a summary of the commands:


<dl><dt id='user-manual-codegitbranchcode'>`git branch`</dt><dd>

list all branches.

</dd><dt id='user-manual-codegitbranchltbranchgtcode'>`git branch <branch>`</dt><dd>

create a new branch named`<branch>`, referencing the same point in history as the current branch.

</dd><dt id='user-manual-codegitbranchltbranchgtltstart-pointgtcode'>`git branch <branch> <start-point>`</dt><dd>
...
</dd><dt id='user-manual-codegitbranch-dltbranchgtcode'>`git branch -d <branch>`</dt><dd>
...
</dd><dt id='user-manual-codegitcheckoutltbranchgtcode'>`git checkout <branch>`</dt><dd>

make the current branch`<branch>`, updating the working directory to reflect the version referenced by`<branch>`.

</dd><dt id='user-manual-codegitcheckout-bltnewgtltstart-pointgtcode'>`git checkout -b <new> <start-point>`</dt><dd>
...
## Examining an old version without creating a new branch<a name="detached-head"></a>
...
## Examining branches from a remote repository<a name="examining-remote-branches"></a>
...
## Naming branches, tags, and other references<a name="how-git-stores-references"></a>
...
## Updating a repository with git fetch<a name="Updating-a-repository-With-git-fetch"></a>
...
## Fetching branches from other repositories<a name="fetching-branches"></a>
...
# Exploring Git history<a name="exploring-git-history"></a>
...
## How to use bisect to find a regression<a name="using-bisect"></a>
...
## Naming commits<a name="naming-commits"></a>
...
## Creating tags<a name="creating-tags"></a>
...
## Browsing revisions<a name="browsing-revisions"></a>
...
## Generating diffs<a name="generating-diffs"></a>
...
## Viewing old file versions<a name="viewing-old-file-versions"></a>
...
## Examples<a name="history-examples"></a>

### Counting the number of commits on a branch<a name="counting-commits-on-a-branch"></a>
...
### Check whether two branches point at the same history<a name="checking-for-equal-branches"></a>
...
### Find first tagged version including a given fix<a name="finding-tagged-descendants"></a>
...
### Showing commits unique to a given branch<a name="showing-commits-unique-to-a-branch"></a>
...
### Creating a changelog and tarball for a software release<a name="making-a-release"></a>
...
### Finding commits referencing a file with given content<a name="Finding-commits-With-given-Content"></a>
...
# Developing with Git<a name="Developing-With-git"></a>

## Telling Git your name<a name="telling-git-your-name"></a>
...
## How to make a commit<a name="how-to-make-a-commit"></a>
...
## Creating good commit messages<a name="creating-good-commit-messages"></a>
...
## How to merge<a name="how-to-merge"></a>
...
## Resolving a merge<a name="resolving-a-merge"></a>
...
### Getting conflict-resolution help during a merge<a name="conflict-resolution"></a>
...
## Undoing a merge<a name="undoing-a-merge"></a>
...
## Fast-forward merges<a name="fast-forwards"></a>
...
## Fixing mistakes<a name="fixing-mistakes"></a>
...
### Fixing a mistake with a new commit<a name="reverting-a-commit"></a>
...
### Fixing a mistake by rewriting history<a name="fixing-a-mistake-by-rewriting-history"></a>
...
### Checking out an old version of a file<a name="checkout-of-path"></a>
...
### Temporarily setting aside work in progress<a name="interrupted-work"></a>
...
## Ensuring good performance<a name="ensuring-good-performance"></a>
...
## Ensuring reliability<a name="ensuring-reliability"></a>

### Checking the repository for corruption<a name="checking-for-corruption"></a>
...
### Recovering lost changes<a name="recovering-lost-changes"></a>

#### Reflogs<a name="reflogs"></a>
...
#### Examining dangling objects<a name="dangling-object-recovery"></a>
...
# Sharing development with others<a name="sharing-development"></a>

## Getting updates with git pull<a name="getting-updates-With-git-pull"></a>
...
## Submitting patches to a project<a name="submitting-patches"></a>
...
## Importing patches to a project<a name="importing-patches"></a>
...
## Public Git repositories<a name="public-repositories"></a>
...
### Setting up a public repository<a name="setting-up-a-public-repository"></a>
...
### Exporting a Git repository via the Git protocol<a name="exporting-via-git"></a>
...
### Exporting a git repository via HTTP<a name="exporting-via-http"></a>
...
### Pushing changes to a public repository<a name="pushing-changes-to-a-public-repository"></a>
...
Note that the target of a`push`is normally a[bare](%5214#def_bare_repository "")repository. You can also push to a repository that has a checked-out working tree, but a push to update the currently checked-out branch is denied by default to prevent confusion. See the description of the receive.denyCurrentBranch option in[git-config[1]](%2249  "")for details.
...
### What to do when a push fails<a name="forcing-push"></a>
...
### Setting up a shared repository<a name="setting-up-a-shared-repository"></a>
...
### Allowing web browsing of a repository<a name="setting-up-gitweb"></a>
...
## How to get a Git repository with minimal history<a name="how-to-get-a-git-repository-with-minimal-history"></a>


A[shallow clone](%5214#def_shallow_clone ""), with its truncated history, is useful when one is interested only in recent history of a project and getting full history from the upstream is expensive.




A[shallow clone](%5214#def_shallow_clone "")is created by specifying the[git-clone[1]](%2252  "")`--depth`switch. The depth can later be changed with the[git-fetch[1]](%2268  "")`--depth`switch, or full history restored with`--unshallow`.




Merging inside a[shallow clone](%5214#def_shallow_clone "")will work as long as a merge base is in the recent history. Otherwise, it will be like merging unrelated histories and may have to result in huge conflicts. This limitation may make such a repository unsuitable to be used in merge based workflows.





## Examples<a name="sharing-development-examples"></a>

### Maintaining topic branches for a Linux subsystem maintainer<a name="maintaining-topic-branches"></a>
...
# Rewriting history and maintaining patch series<a name="cleaning-up-history"></a>
...
## Creating the perfect patch series<a name="patch-series"></a>
...
## Keeping a patch series up to date using git rebase<a name="using-git-rebase"></a>
...
## Rewriting a single commit<a name="rewriting-one-commit"></a>
...
## Reordering or selecting from a patch series<a name="reordering-patch-series"></a>
...
## Using interactive rebases<a name="interactive-rebase"></a>
...
## Other tools<a name="patch-series-tools"></a>
...
## Problems with rewriting history<a name="problems-With-rewriting-history"></a>
...
## Why bisecting merge commits can be harder than bisecting linear history<a name="bisect-merges"></a>
...
# Advanced branch management<a name="advanced-branch-management"></a>

## Fetching individual branches<a name="fetching-individual-branches"></a>
...
## git fetch and fast-forwards<a name="fetch-fast-forwards"></a>
...
## Forcing git fetch to do non-fast-forward updates<a name="forcing-fetch"></a>
...
## Configuring remote-tracking branches<a name="remote-branch-configuration"></a>
...
# Git concepts<a name="git-concepts"></a>
...
We start with the most important, the[object database](%5214#def_object_database "")and the[index](%5214#def_index "").





## The Object Database<a name="the-object-database"></a>
...
* A[&quot;blob&quot; object](%5214#def_blob_object "")is used to store file data.
* A[&quot;tree&quot; object](%5214#def_tree_object "")ties one or more &quot;blob&quot; objects into a directory structure. In addition, a tree object can refer to other tree objects, thus creating a directory hierarchy.
* A[&quot;commit&quot; object](%5214#def_commit_object "")ties such directory hierarchies together into a[directed acyclic graph](%5214#def_DAG "")of revisions—​each commit contains the object name of exactly one tree designating the directory hierarchy at the time of the commit. In addition, a commit refers to &quot;parent&quot; commit objects that describe the history of how we arrived at that directory hierarchy.
* A[&quot;tag&quot; object](%5214#def_tag_object "")symbolically identifies and can be used to sign other objects. It contains the object name and type of another object, a symbolic name (of course!) and, optionally, a signature.
...
### Commit Object<a name="commit-object"></a>
...
### Tree Object<a name="tree-object"></a>
...
### Blob Object<a name="blob-object"></a>
...
### Tag Object<a name="tag-object"></a>
...
### How Git stores objects efficiently: pack files<a name="pack-files"></a>
...
### Dangling objects<a name="dangling-objects"></a>
...
### Recovering from repository corruption<a name="recovering-from-repository-corruption"></a>
...
We saw in[Getting conflict-resolution help during a merge](%5214#conflict-resolution "")that during a merge the index can store multiple versions of a single file (called &quot;stages&quot;). The third column in the[git-ls-files[1]](%2315  "")output above is the stage number, and will take on values other than 0 for files with merge conflicts.
...
## Pitfalls with submodules<a name="_pitfalls_with_submodules"></a>
...
# Low-level Git operations<a name="low-level-operations"></a>
...
## Object access and manipulation<a name="object-manipulation"></a>
...
## The Workflow<a name="the-workflow"></a>
...
### working directory → index<a name="working-directory-to-index"></a>
...
### index → object database<a name="index-to-object-database"></a>
...
### object database → index<a name="object-database-to-index"></a>
...
### index → working directory<a name="index-to-working-directory"></a>
...
### Tying it all together<a name="tying-it-all-together"></a>
...
## Examining the data<a name="examining-the-data"></a>
...
## Merging multiple trees<a name="merging-multiple-trees"></a>
...
## Merging multiple trees, continued<a name="merging-multiple-trees-2"></a>
...
## A birds-eye view of Git’s source code<a name="birdview-on-the-source-code"></a>
...
Note that terminology has changed since that revision. For example, the README in that revision uses the word &quot;changeset&quot; to describe what we now call a[commit](%5214#def_commit_object "").
...
Next step: get familiar with the object naming. Read[Naming commits](%5214#naming-commits ""). There are quite a few ways to name an object (and not only revisions!). All of these are handled in`sha1_name.c`. Just have a quick look at the function`get_sha1()`. A lot of the special handling is done by functions like`get_sha1_basic()`or the likes.
...
# Git Glossary<a name="glossary"></a>

## Git explained<a name="git-explained"></a>
<dl><dt id='user-manual-aiddefalternateobjectdatabaseaalternateobjectdatabase'>alternate object database</dt><dd>

Via the alternates mechanism, a[repository](%5214#def_repository "")can inherit part of its[object database](%5214#def_object_database "")from another object database, which is called an &quot;alternate&quot;.

</dd><dt id='user-manual-aiddefbarerepositoryabarerepository'>bare repository</dt><dd>

A bare repository is normally an appropriately named[directory](%5214#def_directory "")with a`.git`suffix that does not have a locally checked-out copy of any of the files under revision control. That is, all of the Git administrative and control files that would normally be present in the hidden`.git`sub-directory are directly present in the`repository.git`directory instead, and no other files are present and checked out. Usually publishers of public repositories make bare repositories available.

</dd><dt id='user-manual-aiddefblobobjectablobobject'>blob object</dt><dd>

Untyped[object](%5214#def_object ""), e.g. the contents of a file.

</dd><dt id='user-manual-aiddefbranchabranch'>branch</dt><dd>

A &quot;branch&quot; is an active line of development. The most recent[commit](%5214#def_commit "")on a branch is referred to as the tip of that branch. The tip of the branch is referenced by a branch[head](%5214#def_head ""), which moves forward as additional development is done on the branch. A single Git[repository](%5214#def_repository "")can track an arbitrary number of branches, but your[working tree](%5214#def_working_tree "")is associated with just one of them (the &quot;current&quot; or &quot;checked out&quot; branch), and[HEAD](%5214#def_HEAD "")points to that branch.

</dd><dt id='user-manual-aiddefcacheacache'>cache</dt><dd>

Obsolete for:[index](%5214#def_index "").

</dd><dt id='user-manual-aiddefchainachain'>chain</dt><dd>

A list of objects, where each[object](%5214#def_object "")in the list contains a reference to its successor (for example, the successor of a[commit](%5214#def_commit "")could be one of its[parents](%5214#def_parent "")).

</dd><dt id='user-manual-aiddefchangesetachangeset'>changeset</dt><dd>

BitKeeper/cvsps speak for &quot;[commit](%5214#def_commit "")&quot;. Since Git does not store changes, but states, it really does not make sense to use the term &quot;changesets&quot; with Git.

</dd><dt id='user-manual-aiddefcheckoutacheckout'>checkout</dt><dd>

The action of updating all or part of the[working tree](%5214#def_working_tree "")with a[tree object](%5214#def_tree_object "")or[blob](%5214#def_blob_object "")from the[object database](%5214#def_object_database ""), and updating the[index](%5214#def_index "")and[HEAD](%5214#def_HEAD "")if the whole working tree has been pointed at a new[branch](%5214#def_branch "").

</dd><dt id='user-manual-aiddefcherry-pickingacherry-picking'>cherry-picking</dt><dd>

In[SCM](%5214#def_SCM "")jargon, &quot;cherry pick&quot; means to choose a subset of changes out of a series of changes (typically commits) and record them as a new series of changes on top of a different codebase. In Git, this is performed by the &quot;git cherry-pick&quot; command to extract the change introduced by an existing[commit](%5214#def_commit "")and to record it based on the tip of the current[branch](%5214#def_branch "")as a new commit.

</dd><dt id='user-manual-aiddefcleanaclean'>clean</dt><dd>

A[working tree](%5214#def_working_tree "")is clean, if it corresponds to the[revision](%5214#def_revision "")referenced by the current[head](%5214#def_head ""). Also see &quot;[dirty](%5214#def_dirty "")&quot;.

</dd><dt id='user-manual-aiddefcommitacommit'>commit</dt><dd>

As a noun: A single point in the Git history; the entire history of a project is represented as a set of interrelated commits. The word &quot;commit&quot; is often used by Git in the same places other revision control systems use the words &quot;revision&quot; or &quot;version&quot;. Also used as a short hand for[commit object](%5214#def_commit_object "").



As a verb: The action of storing a new snapshot of the project’s state in the Git history, by creating a new commit representing the current state of the[index](%5214#def_index "")and advancing[HEAD](%5214#def_HEAD "")to point at the new commit.


</dd><dt id='user-manual-aiddefcommitobjectacommitobject'>commit object</dt><dd>

An[object](%5214#def_object "")which contains the information about a particular[revision](%5214#def_revision ""), such as[parents](%5214#def_parent ""), committer, author, date and the[tree object](%5214#def_tree_object "")which corresponds to the top[directory](%5214#def_directory "")of the stored revision.

</dd><dt id='user-manual-aiddefcommit-ishacommit-ishalsocommittish'>commit-ish (also committish)</dt><dd>

A[commit object](%5214#def_commit_object "")or an[object](%5214#def_object "")that can be recursively dereferenced to a commit object. The following are all commit-ishes: a commit object, a[tag object](%5214#def_tag_object "")that points to a commit object, a tag object that points to a tag object that points to a commit object, etc.

</dd><dt id='user-manual-aiddefcoregitacoreGit'>core Git</dt><dd>

Fundamental data structures and utilities of Git. Exposes only limited source code management tools.

</dd><dt id='user-manual-aiddefDAGaDAG'>DAG</dt><dd>

Directed acyclic graph. The[commit objects](%5214#def_commit_object "")form a directed acyclic graph, because they have parents (directed), and the graph of commit objects is acyclic (there is no[chain](%5214#def_chain "")which begins and ends with the same[object](%5214#def_object "")).

</dd><dt id='user-manual-aiddefdanglingobjectadanglingobject'>dangling object</dt><dd>

An[unreachable object](%5214#def_unreachable_object "")which is not[reachable](%5214#def_reachable "")even from other unreachable objects; a dangling object has no references to it from any reference or[object](%5214#def_object "")in the[repository](%5214#def_repository "").

</dd><dt id='user-manual-aiddefdetachedHEADadetachedHEAD'>detached HEAD</dt><dd>

Normally the[HEAD](%5214#def_HEAD "")stores the name of a[branch](%5214#def_branch ""), and commands that operate on the history HEAD represents operate on the history leading to the tip of the branch the HEAD points at. However, Git also allows you to[check out](%5214#def_checkout "")an arbitrary[commit](%5214#def_commit "")that isn’t necessarily the tip of any particular branch. The HEAD in such a state is called &quot;detached&quot;.
...
</dd><dt id='user-manual-aiddefdirectoryadirectory'>directory</dt><dd>

The list you get with &quot;ls&quot; :-)

</dd><dt id='user-manual-aiddefdirtyadirty'>dirty</dt><dd>

A[working tree](%5214#def_working_tree "")is said to be &quot;dirty&quot; if it contains modifications which have not been[committed](%5214#def_commit "")to the current[branch](%5214#def_branch "").

</dd><dt id='user-manual-aiddefevilmergeaevilmerge'>evil merge</dt><dd>

An evil merge is a[merge](%5214#def_merge "")that introduces changes that do not appear in any[parent](%5214#def_parent "").

</dd><dt id='user-manual-aiddeffastforwardafast-forward'>fast-forward</dt><dd>

A fast-forward is a special type of[merge](%5214#def_merge "")where you have a[revision](%5214#def_revision "")and you are &quot;merging&quot; another[branch](%5214#def_branch "")&#39;s changes that happen to be a descendant of what you have. In such a case, you do not make a new[merge](%5214#def_merge "")[commit](%5214#def_commit "")but instead just update to his revision. This will happen frequently on a[remote-tracking branch](%5214#def_remote_tracking_branch "")of a remote[repository](%5214#def_repository "").

</dd><dt id='user-manual-aiddeffetchafetch'>fetch</dt><dd>

Fetching a[branch](%5214#def_branch "")means to get the branch’s[head ref](%5214#def_head_ref "")from a remote[repository](%5214#def_repository ""), to find out which objects are missing from the local[object database](%5214#def_object_database ""), and to get them, too. See also[git-fetch[1]](%2268  "").

</dd><dt id='user-manual-aiddeffilesystemafilesystem'>file system</dt><dd>

Linus Torvalds originally designed Git to be a user space file system, i.e. the infrastructure to hold files and directories. That ensured the efficiency and speed of Git.

</dd><dt id='user-manual-aiddefgitarchiveaGitarchive'>Git archive</dt><dd>

Synonym for[repository](%5214#def_repository "")(for arch people).

</dd><dt id='user-manual-aiddefgitfileagitfile'>gitfile</dt><dd>

A plain file`.git`at the root of a working tree that points at the directory that is the real repository.

</dd><dt id='user-manual-aiddefgraftsagrafts'>grafts</dt><dd>

Grafts enables two otherwise different lines of development to be joined together by recording fake ancestry information for commits. This way you can make Git pretend the set of[parents](%5214#def_parent "")a[commit](%5214#def_commit "")has is different from what was recorded when the commit was created. Configured via the`.git/info/grafts`file.
...
</dd><dt id='user-manual-aiddefhashahash'>hash</dt><dd>

In Git’s context, synonym for[object name](%5214#def_object_name "").

</dd><dt id='user-manual-aiddefheadahead'>head</dt><dd>

A[named reference](%5214#def_ref "")to the[commit](%5214#def_commit "")at the tip of a[branch](%5214#def_branch ""). Heads are stored in a file in`$GIT_DIR/refs/heads/`directory, except when using packed refs. (See[git-pack-refs[1]](%5305  "").)

</dd><dt id='user-manual-aiddefHEADaHEAD'>HEAD</dt><dd>

The current[branch](%5214#def_branch ""). In more detail: Your[working tree](%5214#def_working_tree "")is normally derived from the state of the tree referred to by HEAD. HEAD is a reference to one of the[heads](%5214#def_head "")in your repository, except when using a[detached HEAD](%5214#def_detached_HEAD ""), in which case it directly references an arbitrary commit.

</dd><dt id='user-manual-aiddefheadrefaheadref'>head ref</dt><dd>

A synonym for[head](%5214#def_head "").

</dd><dt id='user-manual-aiddefhookahook'>hook</dt><dd>

During the normal execution of several Git commands, call-outs are made to optional scripts that allow a developer to add functionality or checking. Typically, the hooks allow for a command to be pre-verified and potentially aborted, and allow for a post-notification after the operation is done. The hook scripts are found in the`$GIT_DIR/hooks/`directory, and are enabled by simply removing the`.sample`suffix from the filename. In earlier versions of Git you had to make them executable.

</dd><dt id='user-manual-aiddefindexaindex'>index</dt><dd>

A collection of files with stat information, whose contents are stored as objects. The index is a stored version of your[working tree](%5214#def_working_tree ""). Truth be told, it can also contain a second, and even a third version of a working tree, which are used when[merging](%5214#def_merge "").

</dd><dt id='user-manual-aiddefindexentryaindexentry'>index entry</dt><dd>

The information regarding a particular file, stored in the[index](%5214#def_index ""). An index entry can be unmerged, if a[merge](%5214#def_merge "")was started, but not yet finished (i.e. if the index contains multiple versions of that file).

</dd><dt id='user-manual-aiddefmasteramaster'>master</dt><dd>

The default development[branch](%5214#def_branch ""). Whenever you create a Git[repository](%5214#def_repository ""), a branch named &quot;master&quot; is created, and becomes the active branch. In most cases, this contains the local development, though that is purely by convention and is not required.

</dd><dt id='user-manual-aiddefmergeamerge'>merge</dt><dd>

As a verb: To bring the contents of another[branch](%5214#def_branch "")(possibly from an external[repository](%5214#def_repository "")) into the current branch. In the case where the merged-in branch is from a different repository, this is done by first[fetching](%5214#def_fetch "")the remote branch and then merging the result into the current branch. This combination of fetch and merge operations is called a[pull](%5214#def_pull ""). Merging is performed by an automatic process that identifies changes made since the branches diverged, and then applies all those changes together. In cases where changes conflict, manual intervention may be required to complete the merge.



As a noun: unless it is a[fast-forward](%5214#def_fast_forward ""), a successful merge results in the creation of a new[commit](%5214#def_commit "")representing the result of the merge, and having as[parents](%5214#def_parent "")the tips of the merged[branches](%5214#def_branch ""). This commit is referred to as a &quot;merge commit&quot;, or sometimes just a &quot;merge&quot;.


</dd><dt id='user-manual-aiddefobjectaobject'>object</dt><dd>

The unit of storage in Git. It is uniquely identified by the[SHA-1](%5214#def_SHA1 "")of its contents. Consequently, an object can not be changed.

</dd><dt id='user-manual-aiddefobjectdatabaseaobjectdatabase'>object database</dt><dd>

Stores a set of &quot;objects&quot;, and an individual[object](%5214#def_object "")is identified by its[object name](%5214#def_object_name ""). The objects usually live in`$GIT_DIR/objects/`.

</dd><dt id='user-manual-aiddefobjectidentifieraobjectidentifier'>object identifier</dt><dd>

Synonym for[object name](%5214#def_object_name "").

</dd><dt id='user-manual-aiddefobjectnameaobjectname'>object name</dt><dd>

The unique identifier of an[object](%5214#def_object ""). The object name is usually represented by a 40 character hexadecimal string. Also colloquially called[SHA-1](%5214#def_SHA1 "").

</dd><dt id='user-manual-aiddefobjecttypeaobjecttype'>object type</dt><dd>

One of the identifiers &quot;[commit](%5214#def_commit_object "")&quot;, &quot;[tree](%5214#def_tree_object "")&quot;, &quot;[tag](%5214#def_tag_object "")&quot; or &quot;[blob](%5214#def_blob_object "")&quot; describing the type of an[object](%5214#def_object "").

</dd><dt id='user-manual-aiddefoctopusaoctopus'>octopus</dt><dd>

To[merge](%5214#def_merge "")more than two[branches](%5214#def_branch "").

</dd><dt id='user-manual-aiddeforiginaorigin'>origin</dt><dd>

The default upstream[repository](%5214#def_repository ""). Most projects have at least one upstream project which they track. By default<em>origin</em>is used for that purpose. New upstream updates will be fetched into[remote-tracking branches](%5214#def_remote_tracking_branch "")named origin/name-of-upstream-branch, which you can see using`git branch -r`.

</dd><dt id='user-manual-aiddefpackapack'>pack</dt><dd>

A set of objects which have been compressed into one file (to save space or to transmit them efficiently).

</dd><dt id='user-manual-aiddefpackindexapackindex'>pack index</dt><dd>

The list of identifiers, and other information, of the objects in a[pack](%5214#def_pack ""), to assist in efficiently accessing the contents of a pack.

</dd><dt id='user-manual-aiddefpathspecapathspec'>pathspec</dt><dd>
...
<dl><dt id='user-manual-top'>top</dt><dd>
...
</dd><dt id='user-manual-literal'>literal</dt><dd>

Wildcards in the pattern such as`*`or`?`are treated as literal characters.

</dd><dt id='user-manual-icase'>icase</dt><dd>

Case insensitive match.

</dd><dt id='user-manual-glob'>glob</dt><dd>
...
</dd><dt id='user-manual-attr'>attr</dt><dd>
...
</dd><dt id='user-manual-exclude'>exclude</dt><dd>
...
</dd><dt id='user-manual-aiddefparentaparent'>parent</dt><dd>

A[commit object](%5214#def_commit_object "")contains a (possibly empty) list of the logical predecessor(s) in the line of development, i.e. its parents.

</dd><dt id='user-manual-aiddefpickaxeapickaxe'>pickaxe</dt><dd>

The term[pickaxe](%5214#def_pickaxe "")refers to an option to the diffcore routines that help select changes that add or delete a given text string. With the`--pickaxe-all`option, it can be used to view the full[changeset](%5214#def_changeset "")that introduced or removed, say, a particular line of text. See[git-diff[1]](%2255  "").

</dd><dt id='user-manual-aiddefplumbingaplumbing'>plumbing</dt><dd>

Cute name for[core Git](%5214#def_core_git "").

</dd><dt id='user-manual-aiddefporcelainaporcelain'>porcelain</dt><dd>

Cute name for programs and program suites depending on[core Git](%5214#def_core_git ""), presenting a high level access to core Git. Porcelains expose more of a[SCM](%5214#def_SCM "")interface than the[plumbing](%5214#def_plumbing "").

</dd><dt id='user-manual-aiddefperworktreerefaper-worktreeref'>per-worktree ref</dt><dd>

Refs that are per-[worktree](%5214#def_working_tree ""), rather than global. This is presently only[HEAD](%5214#def_HEAD "")and any refs that start with`refs/bisect/`, but might later include other unusual refs.

</dd><dt id='user-manual-aiddefpseudorefapseudoref'>pseudoref</dt><dd>

Pseudorefs are a class of files under`$GIT_DIR`which behave like refs for the purposes of rev-parse, but which are treated specially by git. Pseudorefs both have names that are all-caps, and always start with a line consisting of a[SHA-1](%5214#def_SHA1 "")followed by whitespace. So, HEAD is not a pseudoref, because it is sometimes a symbolic ref. They might optionally contain some additional data.`MERGE_HEAD`and`CHERRY_PICK_HEAD`are examples. Unlike[per-worktree refs](%5214#def_per_worktree_ref ""), these files cannot be symbolic refs, and never have reflogs. They also cannot be updated through the normal ref update machinery. Instead, they are updated by directly writing to the files. However, they can be read as if they were refs, so`git rev-parse MERGE_HEAD`will work.

</dd><dt id='user-manual-aiddefpullapull'>pull</dt><dd>

Pulling a[branch](%5214#def_branch "")means to[fetch](%5214#def_fetch "")it and[merge](%5214#def_merge "")it. See also[git-pull[1]](%2269  "").

</dd><dt id='user-manual-aiddefpushapush'>push</dt><dd>

Pushing a[branch](%5214#def_branch "")means to get the branch’s[head ref](%5214#def_head_ref "")from a remote[repository](%5214#def_repository ""), find out if it is an ancestor to the branch’s local head ref, and in that case, putting all objects, which are[reachable](%5214#def_reachable "")from the local head ref, and which are missing from the remote repository, into the remote[object database](%5214#def_object_database ""), and updating the remote head ref. If the remote[head](%5214#def_head "")is not an ancestor to the local head, the push fails.

</dd><dt id='user-manual-aiddefreachableareachable'>reachable</dt><dd>

All of the ancestors of a given[commit](%5214#def_commit "")are said to be &quot;reachable&quot; from that commit. More generally, one[object](%5214#def_object "")is reachable from another if we can reach the one from the other by a[chain](%5214#def_chain "")that follows[tags](%5214#def_tag "")to whatever they tag,[commits](%5214#def_commit_object "")to their parents or trees, and[trees](%5214#def_tree_object "")to the trees or[blobs](%5214#def_blob_object "")that they contain.

</dd><dt id='user-manual-aiddefrebasearebase'>rebase</dt><dd>

To reapply a series of changes from a[branch](%5214#def_branch "")to a different base, and reset the[head](%5214#def_head "")of that branch to the result.

</dd><dt id='user-manual-aiddefrefaref'>ref</dt><dd>

A name that begins with`refs/`(e.g.`refs/heads/master`) that points to an[object name](%5214#def_object_name "")or another ref (the latter is called a[symbolic ref](%5214#def_symref "")). For convenience, a ref can sometimes be abbreviated when used as an argument to a Git command; see[gitrevisions[7]](%2288  "")for details. Refs are stored in the[repository](%5214#def_repository "").
...
</dd><dt id='user-manual-aiddefreflogareflog'>reflog</dt><dd>
...
</dd><dt id='user-manual-aiddefrefspecarefspec'>refspec</dt><dd>

A &quot;refspec&quot; is used by[fetch](%5214#def_fetch "")and[push](%5214#def_push "")to describe the mapping between remote[ref](%5214#def_ref "")and local ref.

</dd><dt id='user-manual-aiddefremotearemoterepository'>remote repository</dt><dd>

A[repository](%5214#def_repository "")which is used to track the same project but resides somewhere else. To communicate with remotes, see[fetch](%5214#def_fetch "")or[push](%5214#def_push "").

</dd><dt id='user-manual-aiddefremotetrackingbrancharemote-trackingbranch'>remote-tracking branch</dt><dd>

A[ref](%5214#def_ref "")that is used to follow changes from another[repository](%5214#def_repository ""). It typically looks like<em>refs/remotes/foo/bar</em>(indicating that it tracks a branch named<em>bar</em>in a remote named<em>foo</em>), and matches the right-hand-side of a configured fetch[refspec](%5214#def_refspec ""). A remote-tracking branch should not contain direct modifications or have local commits made to it.

</dd><dt id='user-manual-aiddefrepositoryarepository'>repository</dt><dd>

A collection of[refs](%5214#def_ref "")together with an[object database](%5214#def_object_database "")containing all objects which are[reachable](%5214#def_reachable "")from the refs, possibly accompanied by meta data from one or more[porcelains](%5214#def_porcelain ""). A repository can share an object database with other repositories via[alternates mechanism](%5214#def_alternate_object_database "").

</dd><dt id='user-manual-aiddefresolvearesolve'>resolve</dt><dd>

The action of fixing up manually what a failed automatic[merge](%5214#def_merge "")left behind.

</dd><dt id='user-manual-aiddefrevisionarevision'>revision</dt><dd>

Synonym for[commit](%5214#def_commit "")(the noun).

</dd><dt id='user-manual-aiddefrewindarewind'>rewind</dt><dd>

To throw away part of the development, i.e. to assign the[head](%5214#def_head "")to an earlier[revision](%5214#def_revision "").

</dd><dt id='user-manual-aiddefSCMaSCM'>SCM</dt><dd>

Source code management (tool).

</dd><dt id='user-manual-aiddefSHA1aSHA-1'>SHA-1</dt><dd>

&quot;Secure Hash Algorithm 1&quot;; a cryptographic hash function. In the context of Git used as a synonym for[object name](%5214#def_object_name "").

</dd><dt id='user-manual-aiddefshallowcloneashallowclone'>shallow clone</dt><dd>

Mostly a synonym to[shallow repository](%5214#def_shallow_repository "")but the phrase makes it more explicit that it was created by running`git clone --depth=...`command.

</dd><dt id='user-manual-aiddefshallowrepositoryashallowrepository'>shallow repository</dt><dd>

A shallow[repository](%5214#def_repository "")has an incomplete history some of whose[commits](%5214#def_commit "")have[parents](%5214#def_parent "")cauterized away (in other words, Git is told to pretend that these commits do not have the parents, even though they are recorded in the[commit object](%5214#def_commit_object "")). This is sometimes useful when you are interested only in the recent history of a project even though the real history recorded in the upstream is much larger. A shallow repository is created by giving the`--depth`option to[git-clone[1]](%2252  ""), and its history can be later deepened with[git-fetch[1]](%2268  "").

</dd><dt id='user-manual-aiddefstashastashentry'>stash entry</dt><dd>

An[object](%5214#def_object "")used to temporarily store the contents of a[dirty](%5214#def_dirty "")working directory and the index for future reuse.

</dd><dt id='user-manual-aiddefsubmoduleasubmodule'>submodule</dt><dd>

A[repository](%5214#def_repository "")that holds the history of a separate project inside another repository (the latter of which is called[superproject](%5214#def_superproject "")).

</dd><dt id='user-manual-aiddefsuperprojectasuperproject'>superproject</dt><dd>

A[repository](%5214#def_repository "")that references repositories of other projects in its working tree as[submodules](%5214#def_submodule ""). The superproject knows about the names of (but does not hold copies of) commit objects of the contained submodules.

</dd><dt id='user-manual-aiddefsymrefasymref'>symref</dt><dd>

Symbolic reference: instead of containing the[SHA-1](%5214#def_SHA1 "")id itself, it is of the format<em>ref: refs/some/thing</em>and when referenced, it recursively dereferences to this reference.<em>[HEAD](%5214#def_HEAD "")</em>is a prime example of a symref. Symbolic references are manipulated with the[git-symbolic-ref[1]](%2321  "")command.

</dd><dt id='user-manual-aiddeftagatag'>tag</dt><dd>

A[ref](%5214#def_ref "")under`refs/tags/`namespace that points to an object of an arbitrary type (typically a tag points to either a[tag](%5214#def_tag_object "")or a[commit object](%5214#def_commit_object "")). In contrast to a[head](%5214#def_head ""), a tag is not updated by the`commit`command. A Git tag has nothing to do with a Lisp tag (which would be called an[object type](%5214#def_object_type "")in Git’s context). A tag is most typically used to mark a particular point in the commit ancestry[chain](%5214#def_chain "").

</dd><dt id='user-manual-aiddeftagobjectatagobject'>tag object</dt><dd>

An[object](%5214#def_object "")containing a[ref](%5214#def_ref "")pointing to another object, which can contain a message just like a[commit object](%5214#def_commit_object ""). It can also contain a (PGP) signature, in which case it is called a &quot;signed tag object&quot;.

</dd><dt id='user-manual-aiddeftopicbranchatopicbranch'>topic branch</dt><dd>

A regular Git[branch](%5214#def_branch "")that is used by a developer to identify a conceptual line of development. Since branches are very easy and inexpensive, it is often desirable to have several small branches that each contain very well defined concepts or small incremental yet related changes.

</dd><dt id='user-manual-aiddeftreeatree'>tree</dt><dd>

Either a[working tree](%5214#def_working_tree ""), or a[tree object](%5214#def_tree_object "")together with the dependent[blob](%5214#def_blob_object "")and tree objects (i.e. a stored representation of a working tree).

</dd><dt id='user-manual-aiddeftreeobjectatreeobject'>tree object</dt><dd>

An[object](%5214#def_object "")containing a list of file names and modes along with refs to the associated blob and/or tree objects. A[tree](%5214#def_tree "")is equivalent to a[directory](%5214#def_directory "").

</dd><dt id='user-manual-aiddeftree-ishatree-ishalsotreeish'>tree-ish (also treeish)</dt><dd>

A[tree object](%5214#def_tree_object "")or an[object](%5214#def_object "")that can be recursively dereferenced to a tree object. Dereferencing a[commit object](%5214#def_commit_object "")yields the tree object corresponding to the[revision](%5214#def_revision "")&#39;s top[directory](%5214#def_directory ""). The following are all tree-ishes: a[commit-ish](%5214#def_commit-ish ""), a tree object, a[tag object](%5214#def_tag_object "")that points to a tree object, a tag object that points to a tag object that points to a tree object, etc.

</dd><dt id='user-manual-aiddefunmergedindexaunmergedindex'>unmerged index</dt><dd>

An[index](%5214#def_index "")which contains unmerged[index entries](%5214#def_index_entry "").

</dd><dt id='user-manual-aiddefunreachableobjectaunreachableobject'>unreachable object</dt><dd>

An[object](%5214#def_object "")which is not[reachable](%5214#def_reachable "")from a[branch](%5214#def_branch ""),[tag](%5214#def_tag ""), or any other reference.

</dd><dt id='user-manual-aiddefupstreambranchaupstreambranch'>upstream branch</dt><dd>

The default[branch](%5214#def_branch "")that is merged into the branch in question (or the branch in question is rebased onto). It is configured via branch.&lt;name&gt;.remote and branch.&lt;name&gt;.merge. If the upstream branch of<em>A</em>is<em>origin/B</em>sometimes we say &quot;<em>A</em>is tracking<em>origin/B</em>&quot;.

</dd><dt id='user-manual-aiddefworkingtreeaworkingtree'>working tree</dt><dd>

The tree of actual checked out files. The working tree normally contains the contents of the[HEAD](%5214#def_HEAD "")commit’s tree, plus any local changes that you have made but not yet committed.

</dd></dl>



# Appendix A: Git Quick Reference<a name="git-quick-start"></a>
This is a quick summary of the major commands; the previous chapters explain how these work in more detail.


## Creating a new repository<a name="quick-creating-a-new-repository"></a>
...
## Managing branches<a name="managing-branches"></a>
...
## Exploring history<a name="exploring-history"></a>
...
## Sharing your changes<a name="sharing-your-changes"></a>
...
## Repository maintenance<a name="repository-maintenance"></a>
...
# Appendix B: Notes and todo list for this manual<a name="todo"></a>
