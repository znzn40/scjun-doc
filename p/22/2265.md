...
<dl><dt id='git-stash-push-p--patch-k--no-keep-index-u--include-untracked-a--all-q--quiet-m--messageltmessagegt--ltpathspecgt82308203'>push [-p|--patch] [-k|--[no-]keep-index] [-u|--include-untracked] [-a|--all] [-q|--quiet] [-m|--message &lt;message&gt;] [--] [&lt;pathspec&gt;…​]</dt><dd>
...
</dd><dt id='git-stash-save-p--patch-k--no-keep-index-u--include-untracked-a--all-q--quietltmessagegt'>save [-p|--patch] [-k|--[no-]keep-index] [-u|--include-untracked] [-a|--all] [-q|--quiet] [&lt;message&gt;]</dt><dd>
...
</dd><dt id='git-stash-listltoptionsgt'>list [&lt;options&gt;]</dt><dd>
...
</dd><dt id='git-stash-showltstashgt'>show [&lt;stash&gt;]</dt><dd>
...
</dd><dt id='git-stash-pop--index-q--quietltstashgt'>pop [--index] [-q|--quiet] [&lt;stash&gt;]</dt><dd>
...
</dd><dt id='git-stash-apply--index-q--quietltstashgt'>apply [--index] [-q|--quiet] [&lt;stash&gt;]</dt><dd>
...
</dd><dt id='git-stash-branchltbranchnamegtltstashgt'>branch &lt;branchname&gt; [&lt;stash&gt;]</dt><dd>
...
</dd><dt id='git-stash-clear'>clear</dt><dd>
...
</dd><dt id='git-stash-drop-q--quietltstashgt'>drop [-q|--quiet] [&lt;stash&gt;]</dt><dd>
...
</dd><dt id='git-stash-create'>create</dt><dd>
...
</dd><dt id='git-stash-store'>store</dt><dd>
...
<dl><dt id='git-stash-Pullingintoadirtytree'>Pulling into a dirty tree</dt><dd>
...
</dd><dt id='git-stash-Interruptedworkflow'>Interrupted workflow</dt><dd>
...
</dd><dt id='git-stash-Testingpartialcommits'>Testing partial commits</dt><dd>
...
</dd><dt id='git-stash-Recoveringstashentriesthatwerecleareddroppederroneously'>Recovering stash entries that were cleared/dropped erroneously</dt><dd>
