...
version:2.3.9
lang:zh
rawUrl:http://element-cn.eleme.io/#/zh-CN/component/time-picker#timepicker-shi-jian-xuan-ze-qi
---
...
### [¶](%1948 "") Time Select Options<a name="time-select-options"></a>
参数 | 说明 | 类型 | 可选值 | 默认值 
 ---  |  ---  |  ---  |  ---  |  ---  | 
...
### [¶](%1949 "") Time Picker Options<a name="time-picker-options"></a>
参数 | 说明 | 类型 | 可选值 | 默认值 
 ---  |  ---  |  ---  |  ---  |  ---  | 
