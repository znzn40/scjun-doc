...
version:0
lang:zh
rawUrl:https://developer.mozilla.org/en-US/docs/Web/CSS/-moz-border-end
---
...
**This is an[experimental technology]3404 "")**<br></br>Check the[Browser compatibility table](%28809#Browser_compatibility "")carefully before using this in production.
