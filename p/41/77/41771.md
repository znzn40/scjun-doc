...
version:0
lang:zh
rawUrl:https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/Global_Objects/Atomics/add
---
...
<iframe src='https://interactive-examples.mdn.mozilla.net/pages/js/atomics-add.html' width='100%' height='250'></iframe>
...
* `typedArray`不是一个shared typed array类型，则抛出[`TypeError`]3682 "TypeError（类型错误） 对象用来表示值的类型非预期类型时发生的错误。")。
...
[ECMAScript Latest Draft (ECMA-262)<br></br><small>Atomics.add</small>]45229 "") | Draft | Initial definition in ES2017. 
...
* [`Atomics.sub()`]41780 "此页面仍未被本地化, 期待您的翻译!")
