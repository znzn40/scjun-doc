...
version:2.*
lang:en
rawUrl:https://git-scm.com/docs/git-bisect-lk2009.html#1
---


## [](%8392#_abstract "")Abstract<a name="_abstract"></a>
...
## [](%8392#_introduction_to_git_bisect "")Introduction to &quot;git bisect&quot;<a name="_introduction_to_git_bisect"></a>
...
## [](%8392#_fighting_regressions_overview "")Fighting regressions overview<a name="_fighting_regressions_overview"></a>

### [](%8392#_regressions_a_big_problem "")Regressions: a big problem<a name="_regressions_a_big_problem"></a>
...
### [](%8392#_other_tools_to_fight_regressions "")Other tools to fight regressions<a name="_other_tools_to_fight_regressions"></a>
...
## [](%8392#_git_bisect_overview "")&quot;git bisect&quot; overview<a name="_git_bisect_overview"></a>

### [](%8392#_starting_a_bisection "")Starting a bisection<a name="_starting_a_bisection"></a>
...
### [](%8392#_driving_a_bisection_manually "")Driving a bisection manually<a name="_driving_a_bisection_manually"></a>
...
### [](%8392#_driving_a_bisection_automatically "")Driving a bisection automatically<a name="_driving_a_bisection_automatically"></a>
...
### [](%8392#_avoiding_untestable_commits "")Avoiding untestable commits<a name="_avoiding_untestable_commits"></a>
...
### [](%8392#_saving_a_log_and_replaying_it "")Saving a log and replaying it<a name="_saving_a_log_and_replaying_it"></a>
...
## [](%8392#_git_bisect_details "")&quot;git bisect&quot; details<a name="_git_bisect_details"></a>

### [](%8392#_bisection_algorithm "")Bisection algorithm<a name="_bisection_algorithm"></a>
...
### [](%8392#_bisection_algorithm_debugging "")Bisection algorithm debugging<a name="_bisection_algorithm_debugging"></a>
...
### [](%8392#_bisection_algorithm_discussed "")Bisection algorithm discussed<a name="_bisection_algorithm_discussed"></a>
...
### [](%8392#_skip_algorithm "")Skip algorithm<a name="_skip_algorithm"></a>
...
### [](%8392#_skip_algorithm_discussed "")Skip algorithm discussed<a name="_skip_algorithm_discussed"></a>
...
### [](%8392#_checking_merge_bases "")Checking merge bases<a name="_checking_merge_bases"></a>
...
## [](%8392#_best_bisecting_practices "")Best bisecting practices<a name="_best_bisecting_practices"></a>

### [](%8392#_using_test_suites_and_git_bisect_together "")Using test suites and git bisect together<a name="_using_test_suites_and_git_bisect_together"></a>
...
### [](%8392#_bisecting_build_failures "")Bisecting build failures<a name="_bisecting_build_failures"></a>
...
### [](%8392#_passing_sh_c_some_commands_to_git_bisect_run "")Passing sh -c &quot;some commands&quot; to &quot;git bisect run&quot;<a name="_passing_sh_c_some_commands_to_git_bisect_run"></a>
...
### [](%8392#_finding_performance_regressions "")Finding performance regressions<a name="_finding_performance_regressions"></a>
...
### [](%8392#_following_general_best_practices "")Following general best practices<a name="_following_general_best_practices"></a>
...
### [](%8392#_avoiding_bug_prone_merges "")Avoiding bug prone merges<a name="_avoiding_bug_prone_merges"></a>
...
### [](%8392#_adapting_your_work_flow "")Adapting your work-flow<a name="_adapting_your_work_flow"></a>
...
### [](%8392#_involving_qa_people_and_if_possible_end_users "")Involving QA people and if possible end users<a name="_involving_qa_people_and_if_possible_end_users"></a>
...
### [](%8392#_using_complex_scripts "")Using complex scripts<a name="_using_complex_scripts"></a>
...
### [](%8392#_combining_test_suites_git_bisect_and_other_systems_together "")Combining test suites, git bisect and other systems together<a name="_combining_test_suites_git_bisect_and_other_systems_together"></a>
...
## [](%8392#_the_future_of_bisecting "")The future of bisecting<a name="_the_future_of_bisecting"></a>

### [](%8392#_git_replace "")&quot;git replace&quot;<a name="_git_replace"></a>
...
### [](%8392#_bisecting_sporadic_bugs "")Bisecting sporadic bugs<a name="_bisecting_sporadic_bugs"></a>
...
## [](%8392#_conclusion "")Conclusion<a name="_conclusion"></a>
...
## [](%8392#_acknowledgments "")Acknowledgments<a name="_acknowledgments"></a>
...
## [](%8392#_references "")References<a name="_references"></a>
