...
### applypatch-msg<a name="_applypatch_msg"></a>
...
### pre-applypatch<a name="_pre_applypatch"></a>
...
### post-applypatch<a name="_post_applypatch"></a>
...
### pre-commit<a name="_pre_commit"></a>
...
### prepare-commit-msg<a name="_prepare_commit_msg"></a>
...
### commit-msg<a name="_commit_msg"></a>
...
### post-commit<a name="_post_commit"></a>
...
### pre-rebase<a name="_pre_rebase"></a>
...
### post-checkout<a name="_post_checkout"></a>
...
### post-merge<a name="_post_merge"></a>
...
### pre-receive<a name="pre-receive"></a>
...
### post-receive<a name="post-receive"></a>
...
### post-update<a name="post-update"></a>
...
### push-to-checkout<a name="_push_to_checkout"></a>
...
### pre-auto-gc<a name="_pre_auto_gc"></a>
...
### post-rewrite<a name="_post_rewrite"></a>
...
<dl><dt id='githooks-rebase'>rebase</dt><dd>
...
### sendemail-validate<a name="_sendemail_validate"></a>
...
### fsmonitor-watchman<a name="_fsmonitor_watchman"></a>
