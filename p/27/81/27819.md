...
version:0
lang:zh
rawUrl:https://developer.mozilla.org/zh-CN/docs/Web/CSS/border-block-end
---



<bdi>我们的志愿者还没有将这篇文章翻译为<bdi>中文 (简体)</bdi>。[加入我们帮助完成翻译]28795 "")<br></br>您也可以阅读此文章的[English (US)]28796 "")版。</bdi>
...
**This is an[experimental technology]3404 "")**<br></br>Check the[Browser compatibility table](%27819#Browser_compatibility "")carefully before using this in production.




The**`border-block-end`**[CSS]427 "CSS")property is a[shorthand property]28797 "")for setting the individual logical block-end border property values in a single place in the style sheet.
...
<iframe src='https://mdn.mozillademos.org/en-US/docs/Web/CSS/border-block-end$samples/Example?revision=1314305' width='140' height='140'></iframe>
...
Specification | Status | Comment 
 ---  |  ---  |  ---  | 
[CSS Logical Properties and Values Level 1<br></br><small>The definition of &#39;border-block-end&#39; in that specification.</small>]28821 "") | Editor&#39;s Draft | Initial definition 
