...
### [](%5214#counting-commits-on-a-branch "")Counting the number of commits on a branch<a name="counting-commits-on-a-branch"></a>
...
## [](%5214#the-index "")The index<a name="the-index"></a>
...
# [](%5214#submodules "")Submodules<a name="submodules"></a>
...
## [](%5214#_pitfalls_with_submodules "")Pitfalls with submodules<a name="_pitfalls_with_submodules"></a>
...
# [](%5214#low-level-operations "")Low-level Git operations<a name="low-level-operations"></a>
...
## [](%5214#object-manipulation "")Object access and manipulation<a name="object-manipulation"></a>
...
## [](%5214#the-workflow "")The Workflow<a name="the-workflow"></a>
...
### [](%5214#working-directory-to-index "")working directory → index<a name="working-directory-to-index"></a>
...
### [](%5214#index-to-object-database "")index → object database<a name="index-to-object-database"></a>
...
### [](%5214#object-database-to-index "")object database → index<a name="object-database-to-index"></a>
...
### [](%5214#index-to-working-directory "")index → working directory<a name="index-to-working-directory"></a>
...
### [](%5214#tying-it-all-together "")Tying it all together<a name="tying-it-all-together"></a>
...
## [](%5214#examining-the-data "")Examining the data<a name="examining-the-data"></a>
...
## [](%5214#merging-multiple-trees "")Merging multiple trees<a name="merging-multiple-trees"></a>
...
## [](%5214#merging-multiple-trees-2 "")Merging multiple trees, continued<a name="merging-multiple-trees-2"></a>
...
## [](%5214#birdview-on-the-source-code "")A birds-eye view of Git’s source code<a name="birdview-on-the-source-code"></a>
...
# [](%5214#glossary "")Git Glossary<a name="glossary"></a>

## [](%5214#git-explained "")Git explained<a name="git-explained"></a>
<dl><dt id='user-manual-aiddefalternateobjectdatabaseaalternateobjectdatabase'>[](%5214#user-manual-aiddefalternateobjectdatabaseaalternateobjectdatabase "")alternate object database</dt><dd>
...
</dd><dt id='user-manual-aiddefbarerepositoryabarerepository'>[](%5214#user-manual-aiddefbarerepositoryabarerepository "")bare repository</dt><dd>
...
</dd><dt id='user-manual-aiddefblobobjectablobobject'>[](%5214#user-manual-aiddefblobobjectablobobject "")blob object</dt><dd>

Untyped[object](%5214#def_object ""), e.g. the contents of a file.

</dd><dt id='user-manual-aiddefbranchabranch'>[](%5214#user-manual-aiddefbranchabranch "")branch</dt><dd>
...
</dd><dt id='user-manual-aiddefcacheacache'>[](%5214#user-manual-aiddefcacheacache "")cache</dt><dd>

Obsolete for:[index](%5214#def_index "").

</dd><dt id='user-manual-aiddefchainachain'>[](%5214#user-manual-aiddefchainachain "")chain</dt><dd>
...
</dd><dt id='user-manual-aiddefchangesetachangeset'>[](%5214#user-manual-aiddefchangesetachangeset "")changeset</dt><dd>
...
</dd><dt id='user-manual-aiddefcheckoutacheckout'>[](%5214#user-manual-aiddefcheckoutacheckout "")checkout</dt><dd>
...
</dd><dt id='user-manual-aiddefcherry-pickingacherry-picking'>[](%5214#user-manual-aiddefcherry-pickingacherry-picking "")cherry-picking</dt><dd>
...
</dd><dt id='user-manual-aiddefcleanaclean'>[](%5214#user-manual-aiddefcleanaclean "")clean</dt><dd>
...
</dd><dt id='user-manual-aiddefcommitacommit'>[](%5214#user-manual-aiddefcommitacommit "")commit</dt><dd>
...
</dd><dt id='user-manual-aiddefcommitobjectacommitobject'>[](%5214#user-manual-aiddefcommitobjectacommitobject "")commit object</dt><dd>
...
</dd><dt id='user-manual-aiddefcommit-ishacommit-ishalsocommittish'>[](%5214#user-manual-aiddefcommit-ishacommit-ishalsocommittish "")commit-ish (also committish)</dt><dd>
...
</dd><dt id='user-manual-aiddefcoregitacoreGit'>[](%5214#user-manual-aiddefcoregitacoreGit "")core Git</dt><dd>

Fundamental data structures and utilities of Git. Exposes only limited source code management tools.

</dd><dt id='user-manual-aiddefDAGaDAG'>[](%5214#user-manual-aiddefDAGaDAG "")DAG</dt><dd>
...
</dd><dt id='user-manual-aiddefdanglingobjectadanglingobject'>[](%5214#user-manual-aiddefdanglingobjectadanglingobject "")dangling object</dt><dd>
...
</dd><dt id='user-manual-aiddefdetachedHEADadetachedHEAD'>[](%5214#user-manual-aiddefdetachedHEADadetachedHEAD "")detached HEAD</dt><dd>
...
</dd><dt id='user-manual-aiddefdirectoryadirectory'>[](%5214#user-manual-aiddefdirectoryadirectory "")directory</dt><dd>

The list you get with &quot;ls&quot; :-)

</dd><dt id='user-manual-aiddefdirtyadirty'>[](%5214#user-manual-aiddefdirtyadirty "")dirty</dt><dd>
...
</dd><dt id='user-manual-aiddefevilmergeaevilmerge'>[](%5214#user-manual-aiddefevilmergeaevilmerge "")evil merge</dt><dd>

An evil merge is a[merge](%5214#def_merge "")that introduces changes that do not appear in any[parent](%5214#def_parent "").

</dd><dt id='user-manual-aiddeffastforwardafast-forward'>[](%5214#user-manual-aiddeffastforwardafast-forward "")fast-forward</dt><dd>
...
</dd><dt id='user-manual-aiddeffetchafetch'>[](%5214#user-manual-aiddeffetchafetch "")fetch</dt><dd>
...
</dd><dt id='user-manual-aiddeffilesystemafilesystem'>[](%5214#user-manual-aiddeffilesystemafilesystem "")file system</dt><dd>

Linus Torvalds originally designed Git to be a user space file system, i.e. the infrastructure to hold files and directories. That ensured the efficiency and speed of Git.

</dd><dt id='user-manual-aiddefgitarchiveaGitarchive'>[](%5214#user-manual-aiddefgitarchiveaGitarchive "")Git archive</dt><dd>

Synonym for[repository](%5214#def_repository "")(for arch people).

</dd><dt id='user-manual-aiddefgitfileagitfile'>[](%5214#user-manual-aiddefgitfileagitfile "")gitfile</dt><dd>

A plain file`.git`at the root of a working tree that points at the directory that is the real repository.

</dd><dt id='user-manual-aiddefgraftsagrafts'>[](%5214#user-manual-aiddefgraftsagrafts "")grafts</dt><dd>
...
</dd><dt id='user-manual-aiddefhashahash'>[](%5214#user-manual-aiddefhashahash "")hash</dt><dd>

In Git’s context, synonym for[object name](%5214#def_object_name "").

</dd><dt id='user-manual-aiddefheadahead'>[](%5214#user-manual-aiddefheadahead "")head</dt><dd>
...
</dd><dt id='user-manual-aiddefheadrefaheadref'>[](%5214#user-manual-aiddefheadrefaheadref "")head ref</dt><dd>

A synonym for[head](%5214#def_head "").

</dd><dt id='user-manual-aiddefhookahook'>[](%5214#user-manual-aiddefhookahook "")hook</dt><dd>

During the normal execution of several Git commands, call-outs are made to optional scripts that allow a developer to add functionality or checking. Typically, the hooks allow for a command to be pre-verified and potentially aborted, and allow for a post-notification after the operation is done. The hook scripts are found in the`$GIT_DIR/hooks/`directory, and are enabled by simply removing the`.sample`suffix from the filename. In earlier versions of Git you had to make them executable.

</dd><dt id='user-manual-aiddefindexaindex'>[](%5214#user-manual-aiddefindexaindex "")index</dt><dd>
...
</dd><dt id='user-manual-aiddefindexentryaindexentry'>[](%5214#user-manual-aiddefindexentryaindexentry "")index entry</dt><dd>
...
</dd><dt id='user-manual-aiddefmasteramaster'>[](%5214#user-manual-aiddefmasteramaster "")master</dt><dd>
...
</dd><dt id='user-manual-aiddefmergeamerge'>[](%5214#user-manual-aiddefmergeamerge "")merge</dt><dd>
...
</dd><dt id='user-manual-aiddefobjectaobject'>[](%5214#user-manual-aiddefobjectaobject "")object</dt><dd>
...
</dd><dt id='user-manual-aiddefobjectdatabaseaobjectdatabase'>[](%5214#user-manual-aiddefobjectdatabaseaobjectdatabase "")object database</dt><dd>
...
</dd><dt id='user-manual-aiddefobjectidentifieraobjectidentifier'>[](%5214#user-manual-aiddefobjectidentifieraobjectidentifier "")object identifier</dt><dd>

Synonym for[object name](%5214#def_object_name "").

</dd><dt id='user-manual-aiddefobjectnameaobjectname'>[](%5214#user-manual-aiddefobjectnameaobjectname "")object name</dt><dd>
...
</dd><dt id='user-manual-aiddefobjecttypeaobjecttype'>[](%5214#user-manual-aiddefobjecttypeaobjecttype "")object type</dt><dd>
...
</dd><dt id='user-manual-aiddefoctopusaoctopus'>[](%5214#user-manual-aiddefoctopusaoctopus "")octopus</dt><dd>

To[merge](%5214#def_merge "")more than two[branches](%5214#def_branch "").

</dd><dt id='user-manual-aiddeforiginaorigin'>[](%5214#user-manual-aiddeforiginaorigin "")origin</dt><dd>
...
</dd><dt id='user-manual-aiddefpackapack'>[](%5214#user-manual-aiddefpackapack "")pack</dt><dd>

A set of objects which have been compressed into one file (to save space or to transmit them efficiently).

</dd><dt id='user-manual-aiddefpackindexapackindex'>[](%5214#user-manual-aiddefpackindexapackindex "")pack index</dt><dd>
...
</dd><dt id='user-manual-aiddefpathspecapathspec'>[](%5214#user-manual-aiddefpathspecapathspec "")pathspec</dt><dd>
...
<dl><dt id='user-manual-top'>[](%5214#user-manual-top "")top</dt><dd>
...
</dd><dt id='user-manual-literal'>[](%5214#user-manual-literal "")literal</dt><dd>

Wildcards in the pattern such as`*`or`?`are treated as literal characters.

</dd><dt id='user-manual-icase'>[](%5214#user-manual-icase "")icase</dt><dd>

Case insensitive match.

</dd><dt id='user-manual-glob'>[](%5214#user-manual-glob "")glob</dt><dd>
...
</dd><dt id='user-manual-attr'>[](%5214#user-manual-attr "")attr</dt><dd>
...
</dd><dt id='user-manual-exclude'>[](%5214#user-manual-exclude "")exclude</dt><dd>
...
</dd><dt id='user-manual-aiddefparentaparent'>[](%5214#user-manual-aiddefparentaparent "")parent</dt><dd>
...
</dd><dt id='user-manual-aiddefpickaxeapickaxe'>[](%5214#user-manual-aiddefpickaxeapickaxe "")pickaxe</dt><dd>
...
</dd><dt id='user-manual-aiddefplumbingaplumbing'>[](%5214#user-manual-aiddefplumbingaplumbing "")plumbing</dt><dd>

Cute name for[core Git](%5214#def_core_git "").

</dd><dt id='user-manual-aiddefporcelainaporcelain'>[](%5214#user-manual-aiddefporcelainaporcelain "")porcelain</dt><dd>
...
</dd><dt id='user-manual-aiddefperworktreerefaper-worktreeref'>[](%5214#user-manual-aiddefperworktreerefaper-worktreeref "")per-worktree ref</dt><dd>
...
</dd><dt id='user-manual-aiddefpseudorefapseudoref'>[](%5214#user-manual-aiddefpseudorefapseudoref "")pseudoref</dt><dd>
...
</dd><dt id='user-manual-aiddefpullapull'>[](%5214#user-manual-aiddefpullapull "")pull</dt><dd>

Pulling a[branch](%5214#def_branch "")means to[fetch](%5214#def_fetch "")it and[merge](%5214#def_merge "")it. See also[git-pull[1]](%2269  "").

</dd><dt id='user-manual-aiddefpushapush'>[](%5214#user-manual-aiddefpushapush "")push</dt><dd>
...
</dd><dt id='user-manual-aiddefreachableareachable'>[](%5214#user-manual-aiddefreachableareachable "")reachable</dt><dd>
...
</dd><dt id='user-manual-aiddefrebasearebase'>[](%5214#user-manual-aiddefrebasearebase "")rebase</dt><dd>
...
</dd><dt id='user-manual-aiddefrefaref'>[](%5214#user-manual-aiddefrefaref "")ref</dt><dd>
...
</dd><dt id='user-manual-aiddefreflogareflog'>[](%5214#user-manual-aiddefreflogareflog "")reflog</dt><dd>
...
</dd><dt id='user-manual-aiddefrefspecarefspec'>[](%5214#user-manual-aiddefrefspecarefspec "")refspec</dt><dd>
...
</dd><dt id='user-manual-aiddefremotearemoterepository'>[](%5214#user-manual-aiddefremotearemoterepository "")remote repository</dt><dd>
...
</dd><dt id='user-manual-aiddefremotetrackingbrancharemote-trackingbranch'>[](%5214#user-manual-aiddefremotetrackingbrancharemote-trackingbranch "")remote-tracking branch</dt><dd>
...
</dd><dt id='user-manual-aiddefrepositoryarepository'>[](%5214#user-manual-aiddefrepositoryarepository "")repository</dt><dd>
...
</dd><dt id='user-manual-aiddefresolvearesolve'>[](%5214#user-manual-aiddefresolvearesolve "")resolve</dt><dd>

The action of fixing up manually what a failed automatic[merge](%5214#def_merge "")left behind.

</dd><dt id='user-manual-aiddefrevisionarevision'>[](%5214#user-manual-aiddefrevisionarevision "")revision</dt><dd>

Synonym for[commit](%5214#def_commit "")(the noun).

</dd><dt id='user-manual-aiddefrewindarewind'>[](%5214#user-manual-aiddefrewindarewind "")rewind</dt><dd>

To throw away part of the development, i.e. to assign the[head](%5214#def_head "")to an earlier[revision](%5214#def_revision "").

</dd><dt id='user-manual-aiddefSCMaSCM'>[](%5214#user-manual-aiddefSCMaSCM "")SCM</dt><dd>

Source code management (tool).

</dd><dt id='user-manual-aiddefSHA1aSHA-1'>[](%5214#user-manual-aiddefSHA1aSHA-1 "")SHA-1</dt><dd>
...
</dd><dt id='user-manual-aiddefshallowcloneashallowclone'>[](%5214#user-manual-aiddefshallowcloneashallowclone "")shallow clone</dt><dd>
...
</dd><dt id='user-manual-aiddefshallowrepositoryashallowrepository'>[](%5214#user-manual-aiddefshallowrepositoryashallowrepository "")shallow repository</dt><dd>
...
</dd><dt id='user-manual-aiddefstashastashentry'>[](%5214#user-manual-aiddefstashastashentry "")stash entry</dt><dd>
...
</dd><dt id='user-manual-aiddefsubmoduleasubmodule'>[](%5214#user-manual-aiddefsubmoduleasubmodule "")submodule</dt><dd>
...
</dd><dt id='user-manual-aiddefsuperprojectasuperproject'>[](%5214#user-manual-aiddefsuperprojectasuperproject "")superproject</dt><dd>
...
</dd><dt id='user-manual-aiddefsymrefasymref'>[](%5214#user-manual-aiddefsymrefasymref "")symref</dt><dd>
...
</dd><dt id='user-manual-aiddeftagatag'>[](%5214#user-manual-aiddeftagatag "")tag</dt><dd>
...
</dd><dt id='user-manual-aiddeftagobjectatagobject'>[](%5214#user-manual-aiddeftagobjectatagobject "")tag object</dt><dd>
...
</dd><dt id='user-manual-aiddeftopicbranchatopicbranch'>[](%5214#user-manual-aiddeftopicbranchatopicbranch "")topic branch</dt><dd>
...
</dd><dt id='user-manual-aiddeftreeatree'>[](%5214#user-manual-aiddeftreeatree "")tree</dt><dd>
...
</dd><dt id='user-manual-aiddeftreeobjectatreeobject'>[](%5214#user-manual-aiddeftreeobjectatreeobject "")tree object</dt><dd>
...
</dd><dt id='user-manual-aiddeftree-ishatree-ishalsotreeish'>[](%5214#user-manual-aiddeftree-ishatree-ishalsotreeish "")tree-ish (also treeish)</dt><dd>
...
</dd><dt id='user-manual-aiddefunmergedindexaunmergedindex'>[](%5214#user-manual-aiddefunmergedindexaunmergedindex "")unmerged index</dt><dd>

An[index](%5214#def_index "")which contains unmerged[index entries](%5214#def_index_entry "").

</dd><dt id='user-manual-aiddefunreachableobjectaunreachableobject'>[](%5214#user-manual-aiddefunreachableobjectaunreachableobject "")unreachable object</dt><dd>
...
</dd><dt id='user-manual-aiddefupstreambranchaupstreambranch'>[](%5214#user-manual-aiddefupstreambranchaupstreambranch "")upstream branch</dt><dd>
...
</dd><dt id='user-manual-aiddefworkingtreeaworkingtree'>[](%5214#user-manual-aiddefworkingtreeaworkingtree "")working tree</dt><dd>
...
# [](%5214#git-quick-start "")Appendix A: Git Quick Reference<a name="git-quick-start"></a>
This is a quick summary of the major commands; the previous chapters explain how these work in more detail.


## [](%5214#quick-creating-a-new-repository "")Creating a new repository<a name="quick-creating-a-new-repository"></a>
...
## [](%5214#managing-branches "")Managing branches<a name="managing-branches"></a>
...
## [](%5214#exploring-history "")Exploring history<a name="exploring-history"></a>
...
## [](%5214#making-changes "")Making changes<a name="making-changes"></a>
...
## [](%5214#merging "")Merging<a name="merging"></a>
...
## [](%5214#sharing-your-changes "")Sharing your changes<a name="sharing-your-changes"></a>
...
## [](%5214#repository-maintenance "")Repository maintenance<a name="repository-maintenance"></a>
...
# [](%5214#todo "")Appendix B: Notes and todo list for this manual<a name="todo"></a>

## [](%5214#todo-list "")Todo list<a name="todo-list"></a>
