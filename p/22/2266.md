...
## [](%7593 "")SYNOPSIS<a name="_synopsis"></a>
...
## [](%7594 "")DESCRIPTION<a name="_description"></a>
...
## [](%7595 "")OPTIONS<a name="_options"></a>
<dl><dt id='git-tag--a'>[](%7596 "")-a</dt><dt id='git-tag---annotate'>[](%7597 "")--annotate</dt><dd>

Make an unsigned, annotated tag object

</dd><dt id='git-tag--s'>[](%7598 "")-s</dt><dt id='git-tag---sign'>[](%7599 "")--sign</dt><dd>

Make a GPG-signed tag, using the default e-mail address’s key.

</dd><dt id='git-tag--ultkeyidgt'>[](%7600 "")-u &lt;keyid&gt;</dt><dt id='git-tag---local-userltkeyidgt'>[](%7601 "")--local-user=&lt;keyid&gt;</dt><dd>

Make a GPG-signed tag, using the given key.

</dd><dt id='git-tag--f'>[](%7602 "")-f</dt><dt id='git-tag---force'>[](%7603 "")--force</dt><dd>

Replace an existing tag with the given name (instead of failing)

</dd><dt id='git-tag--d'>[](%7604 "")-d</dt><dt id='git-tag---delete'>[](%7605 "")--delete</dt><dd>

Delete existing tags with the given names.

</dd><dt id='git-tag--v'>[](%7606 "")-v</dt><dt id='git-tag---verify'>[](%7607 "")--verify</dt><dd>

Verify the GPG signature of the given tag names.

</dd><dt id='git-tag--nltnumgt'>[](%7608 "")-n&lt;num&gt;</dt><dd>
...
</dd><dt id='git-tag--l'>[](%7609 "")-l</dt><dt id='git-tag---list'>[](%7610 "")--list</dt><dd>
...
</dd><dt id='git-tag---sortltkeygt'>[](%7611 "")--sort=&lt;key&gt;</dt><dd>
...
<dl><dt id='git-tag--i'>[](%7612 "")-i</dt><dt id='git-tag---ignore-case'>[](%7613 "")--ignore-case</dt><dd>

Sorting and filtering tags are case insensitive.

</dd><dt id='git-tag---columnltoptionsgt'>[](%7614 "")--column[=&lt;options&gt;]</dt><dt id='git-tag---no-column'>[](%7615 "")--no-column</dt><dd>
...
</dd><dt id='git-tag--Fltfilegt'>[](%7623 "")-F &lt;file&gt;</dt><dt id='git-tag---fileltfilegt'>[](%7624 "")--file=&lt;file&gt;</dt><dd>
...
</dd><dt id='git-tag--e'>[](%7625 "")-e</dt><dt id='git-tag---edit'>[](%7626 "")--edit</dt><dd>
...
</dd><dt id='git-tag---cleanupltmodegt'>[](%7627 "")--cleanup=&lt;mode&gt;</dt><dd>
...
</dd><dt id='git-tag---create-reflog'>[](%7628 "")--create-reflog</dt><dd>
...
</dd><dt id='git-tag-lttagnamegt'>[](%7629 "")&lt;tagname&gt;</dt><dd>
...
</dd><dt id='git-tag-ltcommitgt'>[](%7630 "")&lt;commit&gt;</dt><dt id='git-tag-ltobjectgt'>[](%7631 "")&lt;object&gt;</dt><dd>

The object that the new tag will refer to, usually a commit. Defaults to HEAD.

</dd><dt id='git-tag-ltformatgt'>[](%7632 "")&lt;format&gt;</dt><dd>
...
## [](%7633 "")CONFIGURATION<a name="_configuration"></a>
...
## [](%7634 "")DISCUSSION<a name="_discussion"></a>

### [](%7635 "")On Re-tagging<a name="_on_re_tagging"></a>
...
### [](%7636 "")On Automatic following<a name="_on_automatic_following"></a>
...
### [](%7637 "")On Backdating Tags<a name="_on_backdating_tags"></a>
...
## [](%7638 "")DATE FORMATS<a name="_date_formats"></a>


The`GIT_AUTHOR_DATE`,`GIT_COMMITTER_DATE`environment variables support the following date formats:


<dl><dt id='git-tag-Gitinternalformat'>[](%7639 "")Git internal format</dt><dd>

It is`<unix timestamp> <time zone offset>`, where`<unix timestamp>`is the number of seconds since the UNIX epoch.`<time zone offset>`is a positive or negative offset from UTC. For example CET (which is 1 hour ahead of UTC) is`+0100`.

</dd><dt id='git-tag-RFC2822'>[](%7640 "")RFC 2822</dt><dd>

The standard email format as described by RFC 2822, for example`Thu, 07 Apr 2005 22:13:13 +0200`.

</dd><dt id='git-tag-ISO8601'>[](%7641 "")ISO 8601</dt><dd>
...
## [](%7642 "")SEE ALSO<a name="_see_also"></a>
