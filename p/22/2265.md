...
## [](%7570 "")SYNOPSIS<a name="_synopsis"></a>
...
## [](%7571 "")DESCRIPTION<a name="_description"></a>
...
## [](%7572 "")OPTIONS<a name="_options"></a>
<dl><dt id='git-stash-push-p--patch-k--no-keep-index-u--include-untracked-a--all-q--quiet-m--messageltmessagegt--ltpathspecgt82308203'>[](%7573 "")push [-p|--patch] [-k|--[no-]keep-index] [-u|--include-untracked] [-a|--all] [-q|--quiet] [-m|--message &lt;message&gt;] [--] [&lt;pathspec&gt;…​]</dt><dd>
...
</dd><dt id='git-stash-save-p--patch-k--no-keep-index-u--include-untracked-a--all-q--quietltmessagegt'>[](%7574 "")save [-p|--patch] [-k|--[no-]keep-index] [-u|--include-untracked] [-a|--all] [-q|--quiet] [&lt;message&gt;]</dt><dd>
...
</dd><dt id='git-stash-listltoptionsgt'>[](%7575 "")list [&lt;options&gt;]</dt><dd>
...
</dd><dt id='git-stash-showltstashgt'>[](%7576 "")show [&lt;stash&gt;]</dt><dd>
...
</dd><dt id='git-stash-pop--index-q--quietltstashgt'>[](%7577 "")pop [--index] [-q|--quiet] [&lt;stash&gt;]</dt><dd>
...
</dd><dt id='git-stash-apply--index-q--quietltstashgt'>[](%7578 "")apply [--index] [-q|--quiet] [&lt;stash&gt;]</dt><dd>
...
</dd><dt id='git-stash-branchltbranchnamegtltstashgt'>[](%7579 "")branch &lt;branchname&gt; [&lt;stash&gt;]</dt><dd>
...
</dd><dt id='git-stash-clear'>[](%7580 "")clear</dt><dd>
...
</dd><dt id='git-stash-drop-q--quietltstashgt'>[](%7581 "")drop [-q|--quiet] [&lt;stash&gt;]</dt><dd>
...
</dd><dt id='git-stash-create'>[](%7582 "")create</dt><dd>
...
</dd><dt id='git-stash-store'>[](%7583 "")store</dt><dd>
...
## [](%7584 "")DISCUSSION<a name="_discussion"></a>
...
## [](%7585 "")EXAMPLES<a name="_examples"></a>
<dl><dt id='git-stash-Pullingintoadirtytree'>[](%7586 "")Pulling into a dirty tree</dt><dd>
...
</dd><dt id='git-stash-Interruptedworkflow'>[](%7587 "")Interrupted workflow</dt><dd>
...
</dd><dt id='git-stash-Testingpartialcommits'>[](%7588 "")Testing partial commits</dt><dd>
...
</dd><dt id='git-stash-Recoveringstashentriesthatwerecleareddroppederroneously'>[](%7589 "")Recovering stash entries that were cleared/dropped erroneously</dt><dd>
...
## [](%7590 "")SEE ALSO<a name="_see_also"></a>
