...
version:0
lang:zh
rawUrl:https://developer.mozilla.org/zh-CN/docs/Web/API/SVGAltGlyphDefElement
---



<bdi>我们的志愿者还没有将这篇文章翻译为<bdi>中文 (简体)</bdi>。[加入我们帮助完成翻译]17338 "")<br></br>您也可以阅读此文章的[English (US)]17339 "")版。</bdi>
...
**Deprecated**<br></br>This feature has been removed from the Web standards. Though some browsers may still support it, it is in the process of being dropped. Avoid using it and update existing code if possible; see the[compatibility table](%3073#Browser_compatibility "")at the bottom of this page to guide your decision. Be aware that this feature may cease to work at any time.





The**`SVGAltGlyphDefElement`**interface corresponds to the[`<altGlyphDef>`]17341 "The <altGlyphDef> SVG element defines a substitution representation for glyphs.")element.

<iframe src='https://mdn.mozillademos.org/en-US/docs/Web/API/SVGAltGlyphDefElement$samples/inheritance_diagram?revision=1375598' width='600' height='70'></iframe>
...
[Scalable Vector Graphics (SVG) 1.1 (Second Edition)<br></br><small>The definition of &#39;SVGAltGlyphDefElement&#39; in that specification.</small>]17343 "") | Recommendation | Initial definition 
...
* [`<altGlyphDef>`]17341 "The <altGlyphDef> SVG element defines a substitution representation for glyphs.")
...
**最后编辑者:**[fscholz]60 ""),<time>Apr 20, 2018, 1:45:31 AM</time>
