...
version:2.*
lang:en
rawUrl:https://git-scm.com/docs/giteveryday#INTEGRATOR
---


## [](%2284#_name "")NAME<a name="_name"></a>
...
## [](%2284#_synopsis "")SYNOPSIS<a name="_synopsis"></a>
...
## [](%2284#_description "")DESCRIPTION<a name="_description"></a>
...
## [](%2284#_individual_developer_standalone_a_id_standalone_a "")Individual Developer (Standalone)<a name="_individual_developer_standalone_a_id_standalone_a"></a>
...
### [](%2284#_examples "")Examples<a name="_examples"></a>
<dl><dt id='giteveryday-Useatarballasastartingpointforanewrepository'>[](%2284#giteveryday-Useatarballasastartingpointforanewrepository "")Use a tarball as a starting point for a new repository.</dt><dd>
```
...
</dd><dt id='giteveryday-Createatopicbranchanddevelop'>[](%2284#giteveryday-Createatopicbranchanddevelop "")Create a topic branch and develop.</dt><dd>
```
...
## [](%2284#_individual_developer_participant_a_id_participant_a "")Individual Developer (Participant)<a name="_individual_developer_participant_a_id_participant_a"></a>
...
### [](%2284#_examples_2 "")Examples<a name="_examples_2"></a>
<dl><dt id='giteveryday-ClonetheupstreamandworkonitFeedchangestoupstream'>[](%2284#giteveryday-ClonetheupstreamandworkonitFeedchangestoupstream "")Clone the upstream and work on it. Feed changes to upstream.</dt><dd>
```
...
</dd><dt id='giteveryday-Pushintoanotherrepository'>[](%2284#giteveryday-Pushintoanotherrepository "")Push into another repository.</dt><dd>
```
...
</dd><dt id='giteveryday-Branchoffofaspecifictag'>[](%2284#giteveryday-Branchoffofaspecifictag "")Branch off of a specific tag.</dt><dd>
```
...
## [](%2284#_integrator_a_id_integrator_a "")Integrator<a name="_integrator_a_id_integrator_a"></a>
...
### [](%2284#_examples_3 "")Examples<a name="_examples_3"></a>
<dl><dt id='giteveryday-Atypicalintegrator8217sGitday'>[](%2284#giteveryday-Atypicalintegrator8217sGitday "")A typical integrator’s Git day.</dt><dd>
```
$ git status (1)
...
## [](%2284#_repository_administration_a_id_administration_a "")Repository Administration<a name="_repository_administration_a_id_administration_a"></a>
...
### [](%2284#_examples_4 "")Examples<a name="_examples_4"></a>
<dl><dt id='giteveryday-Weassumethefollowinginetcservices'>[](%2284#giteveryday-Weassumethefollowinginetcservices "")We assume the following in /etc/services</dt><dd>
```
...
</dd><dt id='giteveryday-Rungit-daemontoservepubscmfrominetd'>[](%2284#giteveryday-Rungit-daemontoservepubscmfrominetd "")Run git-daemon to serve /pub/scm from inetd.</dt><dd>
```
...
</dd><dt id='giteveryday-Rungit-daemontoservepubscmfromxinetd'>[](%2284#giteveryday-Rungit-daemontoservepubscmfromxinetd "")Run git-daemon to serve /pub/scm from xinetd.</dt><dd>
```
...
</dd><dt id='giteveryday-Givepushpullonlyaccesstodevelopersusinggit-over-ssh'>[](%2284#giteveryday-Givepushpullonlyaccesstodevelopersusinggit-over-ssh "")Give push/pull only access to developers using git-over-ssh.</dt><dd>
...
</dd><dt id='giteveryday-CVS-stylesharedrepository'>[](%2284#giteveryday-CVS-stylesharedrepository "")CVS-style shared repository.</dt><dd>
```
