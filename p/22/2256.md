...
## [](%6833 "")SYNOPSIS<a name="_synopsis"></a>
...
## [](%6834 "")DESCRIPTION<a name="_description"></a>
...
## [](%6836 "")OPTIONS<a name="_options"></a>
<dl><dt id='git-commit--a'>[](%6838 "")-a</dt><dt id='git-commit---all'>[](%6839 "")--all</dt><dd>

Tell the command to automatically stage files that have been modified and deleted, but new files you have not told Git about are not affected.

</dd><dt id='git-commit--p'>[](%6840 "")-p</dt><dt id='git-commit---patch'>[](%6841 "")--patch</dt><dd>

Use the interactive patch selection interface to chose which changes to commit. See[git-add[1]](%2253 "")for details.

</dd><dt id='git-commit--Cltcommitgt'>[](%6842 "")-C &lt;commit&gt;</dt><dt id='git-commit---reuse-messageltcommitgt'>[](%6843 "")--reuse-message=&lt;commit&gt;</dt><dd>

Take an existing commit object, and reuse the log message and the authorship information (including the timestamp) when creating the commit.

</dd><dt id='git-commit--cltcommitgt'>[](%6844 "")-c &lt;commit&gt;</dt><dt id='git-commit---reedit-messageltcommitgt'>[](%6845 "")--reedit-message=&lt;commit&gt;</dt><dd>

Like<em>-C</em>, but with`-c`the editor is invoked, so that the user can further edit the commit message.

</dd><dt id='git-commit---fixupltcommitgt'>[](%6846 "")--fixup=&lt;commit&gt;</dt><dd>
...
</dd><dt id='git-commit---squashltcommitgt'>[](%6847 "")--squash=&lt;commit&gt;</dt><dd>
...
</dd><dt id='git-commit---reset-author'>[](%6848 "")--reset-author</dt><dd>

When used with -C/-c/--amend options, or when committing after a conflicting cherry-pick, declare that the authorship of the resulting commit now belongs to the committer. This also renews the author timestamp.

</dd><dt id='git-commit---short'>[](%6849 "")--short</dt><dd>

When doing a dry-run, give the output in the short-format. See[git-status[1]](%2254 "")for details. Implies`--dry-run`.

</dd><dt id='git-commit---branch'>[](%6851 "")--branch</dt><dd>

Show the branch and tracking info even in short-format.

</dd><dt id='git-commit---porcelain'>[](%6853 "")--porcelain</dt><dd>

When doing a dry-run, give the output in a porcelain-ready format. See[git-status[1]](%2254 "")for details. Implies`--dry-run`.

</dd><dt id='git-commit---long'>[](%6856 "")--long</dt><dd>

When doing a dry-run, give the output in the long-format. Implies`--dry-run`.

</dd><dt id='git-commit--z'>[](%6858 "")-z</dt><dt id='git-commit---null'>[](%6859 "")--null</dt><dd>
...
</dd><dt id='git-commit--Fltfilegt'>[](%6862 "")-F &lt;file&gt;</dt><dt id='git-commit---fileltfilegt'>[](%6864 "")--file=&lt;file&gt;</dt><dd>

Take the commit message from the given file. Use<em>-</em>to read the message from the standard input.

</dd><dt id='git-commit---authorltauthorgt'>[](%6866 "")--author=&lt;author&gt;</dt><dd>
...
</dd><dt id='git-commit---dateltdategt'>[](%6869 "")--date=&lt;date&gt;</dt><dd>

Override the author date used in the commit.

</dd><dt id='git-commit--mltmsggt'>[](%6870 "")-m &lt;msg&gt;</dt><dt id='git-commit---messageltmsggt'>[](%6871 "")--message=&lt;msg&gt;</dt><dd>
...
</dd><dt id='git-commit--tltfilegt'>[](%6873 "")-t &lt;file&gt;</dt><dt id='git-commit---templateltfilegt'>[](%6874 "")--template=&lt;file&gt;</dt><dd>
...
</dd><dt id='git-commit--s'>[](%6876 "")-s</dt><dt id='git-commit---signoff'>[](%6877 "")--signoff</dt><dd>
...
</dd><dt id='git-commit--n'>[](%6879 "")-n</dt><dt id='git-commit---no-verify'>[](%6880 "")--no-verify</dt><dd>

This option bypasses the pre-commit and commit-msg hooks. See also[githooks[5]](%5492 "").

</dd><dt id='git-commit---allow-empty'>[](%6881 "")--allow-empty</dt><dd>

Usually recording a commit that has the exact same tree as its sole parent commit is a mistake, and the command prevents you from making such a commit. This option bypasses the safety, and is primarily for use by foreign SCM interface scripts.

</dd><dt id='git-commit---allow-empty-message'>[](%6882 "")--allow-empty-message</dt><dd>
...
</dd><dt id='git-commit---cleanupltmodegt'>[](%6883 "")--cleanup=&lt;mode&gt;</dt><dd>
...
<dl><dt id='git-commit-strip'>[](%6885 "")strip</dt><dd>

Strip leading and trailing empty lines, trailing whitespace, commentary and collapse consecutive empty lines.

</dd><dt id='git-commit-whitespace'>[](%6887 "")whitespace</dt><dd>

Same as`strip`except #commentary is not removed.

</dd><dt id='git-commit-verbatim'>[](%6890 "")verbatim</dt><dd>

Do not change the message at all.

</dd><dt id='git-commit-scissors'>[](%6892 "")scissors</dt><dd>
...
</dd><dt id='git-commit-default'>[](%6895 "")default</dt><dd>
...
</dd><dt id='git-commit--e'>[](%6897 "")-e</dt><dt id='git-commit---edit'>[](%6898 "")--edit</dt><dd>
...
</dd><dt id='git-commit---no-edit'>[](%6899 "")--no-edit</dt><dd>
...
</dd><dt id='git-commit---amend'>[](%6900 "")--amend</dt><dd>
...
</dd><dt id='git-commit---no-post-rewrite'>[](%6901 "")--no-post-rewrite</dt><dd>

Bypass the post-rewrite hook.

</dd><dt id='git-commit--i'>[](%6902 "")-i</dt><dt id='git-commit---include'>[](%6903 "")--include</dt><dd>

Before making a commit out of staged contents so far, stage the contents of paths given on the command line as well. This is usually not what you want unless you are concluding a conflicted merge.

</dd><dt id='git-commit--o'>[](%6904 "")-o</dt><dt id='git-commit---only'>[](%6905 "")--only</dt><dd>
...
</dd><dt id='git-commit--ultmodegt'>[](%6906 "")-u[&lt;mode&gt;]</dt><dt id='git-commit---untracked-filesltmodegt'>[](%6907 "")--untracked-files[=&lt;mode&gt;]</dt><dd>
...
</dd><dt id='git-commit--v'>[](%6914 "")-v</dt><dt id='git-commit---verbose'>[](%6916 "")--verbose</dt><dd>
...
</dd><dt id='git-commit--q'>[](%6918 "")-q</dt><dt id='git-commit---quiet'>[](%6919 "")--quiet</dt><dd>

Suppress commit summary message.

</dd><dt id='git-commit---dry-run'>[](%6921 "")--dry-run</dt><dd>

Do not create a commit, but show a list of paths that are to be committed, paths with local changes that will be left uncommitted and paths that are untracked.

</dd><dt id='git-commit---status'>[](%6923 "")--status</dt><dd>
...
</dd><dt id='git-commit---no-status'>[](%6924 "")--no-status</dt><dd>
...
</dd><dt id='git-commit--Sltkeyidgt'>[](%6925 "")-S[&lt;keyid&gt;]</dt><dt id='git-commit---gpg-signltkeyidgt'>[](%6926 "")--gpg-sign[=&lt;keyid&gt;]</dt><dd>

GPG-sign commits. The`keyid`argument is optional and defaults to the committer identity; if specified, it must be stuck to the option without a space.

</dd><dt id='git-commit---no-gpg-sign'>[](%6927 "")--no-gpg-sign</dt><dd>

Countermand`commit.gpgSign`configuration variable that is set to force each and every commit to be signed.

</dd><dt id='git-commit---'>[](%6929 "")--</dt><dd>

Do not interpret any more arguments as options.

</dd><dt id='git-commit-ltfilegt82308203'>[](%6932 "")&lt;file&gt;…​</dt><dd>
...
## [](%6933 "")DATE FORMATS<a name="_date_formats"></a>


The`GIT_AUTHOR_DATE`,`GIT_COMMITTER_DATE`environment variables and the`--date`option support the following date formats:


<dl><dt id='git-commit-Gitinternalformat'>[](%6934 "")Git internal format</dt><dd>

It is`<unix timestamp> <time zone offset>`, where`<unix timestamp>`is the number of seconds since the UNIX epoch.`<time zone offset>`is a positive or negative offset from UTC. For example CET (which is 1 hour ahead of UTC) is`+0100`.

</dd><dt id='git-commit-RFC2822'>[](%6937 "")RFC 2822</dt><dd>

The standard email format as described by RFC 2822, for example`Thu, 07 Apr 2005 22:13:13 +0200`.

</dd><dt id='git-commit-ISO8601'>[](%6939 "")ISO 8601</dt><dd>
...
## [](%6944 "")EXAMPLES<a name="_examples"></a>
...
## [](%6947 "")DISCUSSION<a name="_discussion"></a>
...
## [](%6950 "")ENVIRONMENT AND CONFIGURATION VARIABLES<a name="_environment_and_configuration_variables"></a>
...
## [](%6953 "")FILES<a name="_files"></a>
<dl><dt id='git-commit-codeGITDIRCOMMITEDITMSGcode'>[](%6954 "")`$GIT_DIR/COMMIT_EDITMSG`</dt><dd>
...
## [](%6955 "")SEE ALSO<a name="_see_also"></a>
