...
version:3.x
lang:zh
rawUrl:https://router.vuejs.org/zh/guide/
---
...
教程中的案例代码将使用[ES2015]46752 "")来编写。



同时，所有的例子都将使用完整版的 Vue 以解析模板。更多细节请[移步这里]46753 "")。
...
你可以看看这个[在线的]46754 "")例子。



要注意，当`<router-link>`对应的路由匹配成功，将自动设置 class 属性值`.router-link-active`。查看[API 文档](%27625#router-link "")学习更多相关内容。





←[介绍]46735 "")[动态路由匹配]46737 "")→
