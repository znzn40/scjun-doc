...
version:0
lang:zh
rawUrl:https://developer.mozilla.org/zh-CN/docs/Web/HTML/Element/Input#Form_%3Cinput%3E_types
---
...
你可以在覆盖每个单独类型的页面上找到`<input>`元素用法的多个例子 - 参见[Form &lt;input&gt; types]39272 "")，也可以参考[Live example]39273 "")在文章的顶部。
