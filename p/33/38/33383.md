...
version:0
lang:zh
rawUrl:https://developer.mozilla.org/en-US/docs/Web/CSS/::-ms-check
---
...
The**`::-ms-check`**[CSS]427 "")[pseudo-element]3563 "")is a[Microsoft extension]28320 "")that represents checkboxes and radio button groups created by[&lt;input type=&quot;checkbox&quot;&gt;]29703 "")and[&lt;input type=&quot;radio&quot;&gt;]29704 "").
...
Only the following CSS properties can be used in a rule with`::-ms-check`in its selector. Other properties are ignored.
...
Screenshot | Live sample 
 ---  |  ---  | 
![]37424 "") | <iframe src='https://mdn.mozillademos.org/en-US/docs/Web/CSS/::-ms-check$samples/Examples?revision=1377245' width='null' height='null'></iframe> 
