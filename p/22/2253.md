...
## [](%6462 "")SYNOPSIS<a name="_synopsis"></a>
...
## [](%6465 "")DESCRIPTION<a name="_description"></a>
...
## [](%6468 "")OPTIONS<a name="_options"></a>
<dl><dt id='git-add-ltpathspecgt82308203'>[](%6469 "")&lt;pathspec&gt;…​</dt><dd>
...
</dd><dt id='git-add--n'>[](%6473 "")-n</dt><dt id='git-add---dry-run'>[](%6475 "")--dry-run</dt><dd>

Don’t actually add the file(s), just show if they exist and/or will be ignored.

</dd><dt id='git-add--v'>[](%6476 "")-v</dt><dt id='git-add---verbose'>[](%6477 "")--verbose</dt><dd>

Be verbose.

</dd><dt id='git-add--f'>[](%6478 "")-f</dt><dt id='git-add---force'>[](%6480 "")--force</dt><dd>

Allow adding otherwise ignored files.

</dd><dt id='git-add--i'>[](%6481 "")-i</dt><dt id='git-add---interactive'>[](%6482 "")--interactive</dt><dd>

Add modified contents in the working tree interactively to the index. Optional path arguments may be supplied to limit operation to a subset of the working tree. See “Interactive mode” for details.

</dd><dt id='git-add--p'>[](%6483 "")-p</dt><dt id='git-add---patch'>[](%6484 "")--patch</dt><dd>
...
</dd><dt id='git-add--e'>[](%6485 "")-e</dt><dt id='git-add---edit'>[](%6486 "")--edit</dt><dd>
...
</dd><dt id='git-add--u'>[](%6487 "")-u</dt><dt id='git-add---update'>[](%6488 "")--update</dt><dd>
...
</dd><dt id='git-add--A'>[](%6489 "")-A</dt><dt id='git-add---all'>[](%6490 "")--all</dt><dt id='git-add---no-ignore-removal'>[](%6491 "")--no-ignore-removal</dt><dd>
...
</dd><dt id='git-add---no-all'>[](%6493 "")--no-all</dt><dt id='git-add---ignore-removal'>[](%6494 "")--ignore-removal</dt><dd>
...
</dd><dt id='git-add--N'>[](%6495 "")-N</dt><dt id='git-add---intent-to-add'>[](%6496 "")--intent-to-add</dt><dd>

Record only the fact that the path will be added later. An entry for the path is placed in the index with no content. This is useful for, among other things, showing the unstaged content of such files with`git diff`and committing them with`git commit -a`.

</dd><dt id='git-add---refresh'>[](%6497 "")--refresh</dt><dd>

Don’t add the file(s), but only refresh their stat() information in the index.

</dd><dt id='git-add---ignore-errors'>[](%6498 "")--ignore-errors</dt><dd>

If some files could not be added because of errors indexing them, do not abort the operation, but continue adding the others. The command shall still exit with non-zero status. The configuration variable`add.ignoreErrors`can be set to true to make this the default behaviour.

</dd><dt id='git-add---ignore-missing'>[](%6499 "")--ignore-missing</dt><dd>

This option can only be used together with --dry-run. By using this option the user can check if any of the given files would be ignored, no matter if they are already present in the work tree or not.

</dd><dt id='git-add---no-warn-embedded-repo'>[](%6500 "")--no-warn-embedded-repo</dt><dd>
...
</dd><dt id='git-add---renormalize'>[](%6501 "")--renormalize</dt><dd>
...
</dd><dt id='git-add---chmod-x'>[](%6502 "")--chmod=(+|-)x</dt><dd>

Override the executable bit of the added files. The executable bit is only changed in the index, the files on disk are left unchanged.

</dd><dt id='git-add---'>[](%6503 "")--</dt><dd>
...
## [](%6504 "")CONFIGURATION<a name="_configuration"></a>
...
## [](%6506 "")EXAMPLES<a name="_examples"></a>
...
## [](%6511 "")INTERACTIVE MODE<a name="_interactive_mode"></a>
...
<dl><dt id='git-add-status'>[](%6515 "")status</dt><dd>
...
</dd><dt id='git-add-update'>[](%6519 "")update</dt><dd>
...
</dd><dt id='git-add-revert'>[](%6523 "")revert</dt><dd>
...
</dd><dt id='git-add-diff'>[](%6527 "")diff</dt><dd>
...
## [](%6529 "")EDITING PATCHES<a name="_editing_patches"></a>
...
<dl><dt id='git-add-addedcontent'>[](%6530 "")added content</dt><dd>

Added content is represented by lines beginning with &quot;+&quot;. You can prevent staging any addition lines by deleting them.

</dd><dt id='git-add-removedcontent'>[](%6531 "")removed content</dt><dd>

Removed content is represented by lines beginning with &quot;-&quot;. You can prevent staging their removal by converting the &quot;-&quot; to a &quot; &quot; (space).

</dd><dt id='git-add-modifiedcontent'>[](%6532 "")modified content</dt><dd>
...
<dl><dt id='git-add-removinguntouchedcontent'>[](%6533 "")removing untouched content</dt><dd>
...
</dd><dt id='git-add-modifyingexistingcontent'>[](%6534 "")modifying existing content</dt><dd>
...
</dd><dt id='git-add-newcontent'>[](%6535 "")new content</dt><dd>
...
## [](%6536 "")SEE ALSO<a name="_see_also"></a>
