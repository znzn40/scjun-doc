...
## [](%7159 "")SYNOPSIS<a name="_synopsis"></a>
...
## [](%7160 "")DESCRIPTION<a name="_description"></a>
...
<dl><dt id='git-checkout-emgitcheckoutemltbranchgt'>[](%7161 "")<em>git checkout</em>&lt;branch&gt;</dt><dd>
...
</dd><dt id='git-checkout-emgitcheckoutem-b-Bltnewbranchgtltstartpointgt'>[](%7162 "")<em>git checkout</em>-b|-B &lt;new_branch&gt; [&lt;start point&gt;]</dt><dd>
...
</dd><dt id='git-checkout-emgitcheckoutem--detachltbranchgt'>[](%7164 "")<em>git checkout</em>--detach [&lt;branch&gt;]</dt><dt id='git-checkout-emgitcheckoutem--detachltcommitgt'>[](%7165 "")<em>git checkout</em>[--detach] &lt;commit&gt;</dt><dd>
...
</dd><dt id='git-checkout-emgitcheckoutemlttree-ishgt--ltpathspecgt82308203'>[](%7166 "")<em>git checkout</em>[&lt;tree-ish&gt;] [--] &lt;pathspec&gt;…​</dt><dd>
...
</dd><dt id='git-checkout-emgitcheckoutem-p--patchlttree-ishgt--ltpathspecgt82308203'>[](%7168 "")<em>git checkout</em>(-p|--patch) [&lt;tree-ish&gt;] [--] [&lt;pathspec&gt;…​]</dt><dd>
...
## [](%7169 "")OPTIONS<a name="_options"></a>
<dl><dt id='git-checkout--q'>[](%7170 "")-q</dt><dt id='git-checkout---quiet'>[](%7172 "")--quiet</dt><dd>

Quiet, suppress feedback messages.

</dd><dt id='git-checkout---no-progress'>[](%7173 "")--[no-]progress</dt><dd>

Progress status is reported on the standard error stream by default when it is attached to a terminal, unless`--quiet`is specified. This flag enables progress reporting even if not attached to a terminal, regardless of`--quiet`.

</dd><dt id='git-checkout--f'>[](%7174 "")-f</dt><dt id='git-checkout---force'>[](%7175 "")--force</dt><dd>
...
</dd><dt id='git-checkout---ours'>[](%7176 "")--ours</dt><dt id='git-checkout---theirs'>[](%7177 "")--theirs</dt><dd>
...
</dd><dt id='git-checkout--bltnewbranchgt'>[](%7178 "")-b &lt;new_branch&gt;</dt><dd>

Create a new branch named &lt;new_branch&gt; and start it at &lt;start_point&gt;; see[git-branch[1]](%2260 "")for details.

</dd><dt id='git-checkout--Bltnewbranchgt'>[](%7179 "")-B &lt;new_branch&gt;</dt><dd>
...
</dd><dt id='git-checkout--t'>[](%7180 "")-t</dt><dt id='git-checkout---track'>[](%7181 "")--track</dt><dd>
...
</dd><dt id='git-checkout---no-track'>[](%7183 "")--no-track</dt><dd>

Do not set up &quot;upstream&quot; configuration, even if the branch.autoSetupMerge configuration variable is true.

</dd><dt id='git-checkout--l'>[](%7184 "")-l</dt><dd>

Create the new branch’s reflog; see[git-branch[1]](%2260 "")for details.

</dd><dt id='git-checkout---detach'>[](%7185 "")--detach</dt><dd>

Rather than checking out a branch to work on it, check out a commit for inspection and discardable experiments. This is the default behavior of &quot;git checkout &lt;commit&gt;&quot; when &lt;commit&gt; is not a branch name. See the &quot;DETACHED HEAD&quot; section below for details.

</dd><dt id='git-checkout---orphanltnewbranchgt'>[](%7186 "")--orphan &lt;new_branch&gt;</dt><dd>
...
</dd><dt id='git-checkout---ignore-skip-worktree-bits'>[](%7187 "")--ignore-skip-worktree-bits</dt><dd>
...
</dd><dt id='git-checkout--m'>[](%7188 "")-m</dt><dt id='git-checkout---merge'>[](%7189 "")--merge</dt><dd>
...
</dd><dt id='git-checkout---conflictltstylegt'>[](%7190 "")--conflict=&lt;style&gt;</dt><dd>
...
</dd><dt id='git-checkout--p'>[](%7191 "")-p</dt><dt id='git-checkout---patch'>[](%7192 "")--patch</dt><dd>
...
</dd><dt id='git-checkout---ignore-other-worktrees'>[](%7195 "")--ignore-other-worktrees</dt><dd>
...
</dd><dt id='git-checkout---no-recurse-submodules'>[](%7196 "")--[no-]recurse-submodules</dt><dd>
...
</dd><dt id='git-checkout-ltbranchgt'>[](%7198 "")&lt;branch&gt;</dt><dd>
...
</dd><dt id='git-checkout-ltnewbranchgt'>[](%7200 "")&lt;new_branch&gt;</dt><dd>

Name for the new branch.

</dd><dt id='git-checkout-ltstartpointgt'>[](%7201 "")&lt;start_point&gt;</dt><dd>

The name of a commit at which to start the new branch; see[git-branch[1]](%2260 "")for details. Defaults to HEAD.

</dd><dt id='git-checkout-lttree-ishgt'>[](%7205 "")&lt;tree-ish&gt;</dt><dd>
...
## [](%7207 "")DETACHED HEAD<a name="_detached_head"></a>
...
## [](%7211 "")ARGUMENT DISAMBIGUATION<a name="_argument_disambiguation"></a>
...
## [](%7212 "")EXAMPLES<a name="_examples"></a>
