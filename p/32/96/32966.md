...
version:0
lang:zh
rawUrl:https://developer.mozilla.org/en-US/docs/Web/CSS/:-moz-system-metric(scrollbar-thumb-proportional)
---
...
The**`:-moz-system-metric(scrollbar-thumb-proportional)`**[CSS]427 "")[pseudo-class]29702 "")will match an element if the computer&#39;s user interface uses proportional scrollbar thumbs; that is, the draggable thumb on the scrollbar resizes to indicate the relative size of the visible area of the document.
