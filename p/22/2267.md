...
## [](%7645 "")SYNOPSIS<a name="_synopsis"></a>
...
## [](%7646 "")DESCRIPTION<a name="_description"></a>
...
## [](%7647 "")COMMANDS<a name="_commands"></a>
<dl><dt id='git-worktree-addltpathgtltcommit-ishgt'>[](%7648 "")add &lt;path&gt; [&lt;commit-ish&gt;]</dt><dd>
...
</dd><dt id='git-worktree-list'>[](%7649 "")list</dt><dd>
...
</dd><dt id='git-worktree-lock'>[](%7650 "")lock</dt><dd>
...
</dd><dt id='git-worktree-move'>[](%7651 "")move</dt><dd>
...
</dd><dt id='git-worktree-prune'>[](%7652 "")prune</dt><dd>

Prune working tree information in $GIT_DIR/worktrees.

</dd><dt id='git-worktree-remove'>[](%7653 "")remove</dt><dd>
...
</dd><dt id='git-worktree-unlock'>[](%7654 "")unlock</dt><dd>
...
## [](%7655 "")OPTIONS<a name="_options"></a>
<dl><dt id='git-worktree--f'>[](%7656 "")-f</dt><dt id='git-worktree---force'>[](%7657 "")--force</dt><dd>
...
</dd><dt id='git-worktree--bltnew-branchgt'>[](%7658 "")-b &lt;new-branch&gt;</dt><dt id='git-worktree--Bltnew-branchgt'>[](%7659 "")-B &lt;new-branch&gt;</dt><dd>
...
</dd><dt id='git-worktree---detach'>[](%7660 "")--detach</dt><dd>

With`add`, detach HEAD in the new working tree. See &quot;DETACHED HEAD&quot; in[git-checkout[1]](%2261 "").

</dd><dt id='git-worktree---no-checkout'>[](%7661 "")--[no-]checkout</dt><dd>
...
</dd><dt id='git-worktree---no-guess-remote'>[](%7662 "")--[no-]guess-remote</dt><dd>
...
</dd><dt id='git-worktree---no-track'>[](%7663 "")--[no-]track</dt><dd>
...
</dd><dt id='git-worktree---lock'>[](%7664 "")--lock</dt><dd>
...
</dd><dt id='git-worktree--n'>[](%7665 "")-n</dt><dt id='git-worktree---dry-run'>[](%7666 "")--dry-run</dt><dd>

With`prune`, do not remove anything; just report what it would remove.

</dd><dt id='git-worktree---porcelain'>[](%7667 "")--porcelain</dt><dd>
...
</dd><dt id='git-worktree--v'>[](%7668 "")-v</dt><dt id='git-worktree---verbose'>[](%7669 "")--verbose</dt><dd>

With`prune`, report all removals.

</dd><dt id='git-worktree---expirelttimegt'>[](%7670 "")--expire &lt;time&gt;</dt><dd>

With`prune`, only expire unused working trees older than &lt;time&gt;.

</dd><dt id='git-worktree---reasonltstringgt'>[](%7671 "")--reason &lt;string&gt;</dt><dd>

With`lock`, an explanation why the working tree is locked.

</dd><dt id='git-worktree-ltworktreegt'>[](%7672 "")&lt;worktree&gt;</dt><dd>
...
## [](%7673 "")DETAILS<a name="_details"></a>
...
## [](%7674 "")LIST OUTPUT FORMAT<a name="_list_output_format"></a>
...
### [](%7675 "")Porcelain Format<a name="_porcelain_format"></a>
...
## [](%7676 "")EXAMPLES<a name="_examples"></a>
