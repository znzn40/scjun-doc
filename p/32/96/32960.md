...
version:0
lang:zh
rawUrl:https://developer.mozilla.org/en-US/docs/Web/CSS/:-moz-system-metric(images-in-menus)
---
...
The**`:-moz-system-metric(images-in-menus)`**CSS[pseudo-class](%29702 "")matches an element if the computer&#39;s user interface supports images in menus.
