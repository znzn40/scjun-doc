...
## The chain of operation<a name="_the_chain_of_operation"></a>
...
## diffcore-break: For Splitting Up Complete Rewrites<a name="_diffcore_break_for_splitting_up_complete_rewrites"></a>
...
## diffcore-rename: For Detecting Renames and Copies<a name="_diffcore_rename_for_detecting_renames_and_copies"></a>
...
## diffcore-merge-broken: For Putting Complete Rewrites Back Together<a name="_diffcore_merge_broken_for_putting_complete_rewrites_back_together"></a>
...
## diffcore-pickaxe: For Detecting Addition/Deletion of Specified String<a name="_diffcore_pickaxe_for_detecting_addition_deletion_of_specified_string"></a>
...
## diffcore-order: For Sorting the Output Based on Filenames<a name="_diffcore_order_for_sorting_the_output_based_on_filenames"></a>
