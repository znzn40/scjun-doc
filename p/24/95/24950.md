...
## [Prop 的大小写 (camelCase vs kebab-case)](%25169 "Prop 的大小写 (camelCase vs kebab-case)")<a name="Prop-的大小写-camelCase-vs-kebab-case"></a>
...
## [Prop 类型](%25170 "Prop 类型")<a name="Prop-类型"></a>
...
这不仅为你的组件提供了文档，还会在它们遇到错误的类型时从浏览器的 JavaScript 控制台提示用户。你会在这个页面接下来的部分看到[类型检查和其它 prop 验证](%25171 "")。


## [传递静态或动态 Prop](%25172 "传递静态或动态 Prop")<a name="传递静态或动态-Prop"></a>
...
### [传入一个数字](%25173 "传入一个数字")<a name="传入一个数字"></a>
```
...
### [传入一个布尔值](%25174 "传入一个布尔值")<a name="传入一个布尔值"></a>
```
...
### [传入一个数组](%25175 "传入一个数组")<a name="传入一个数组"></a>
```
...
### [传入一个对象](%25176 "传入一个对象")<a name="传入一个对象"></a>
```
...
### [传入一个对象的所有属性](%25177 "传入一个对象的所有属性")<a name="传入一个对象的所有属性"></a>
...
## [单向数据流](%25178 "单向数据流")<a name="单向数据流"></a>
...
## [Prop 验证](%25171 "Prop 验证")<a name="Prop-验证"></a>
...
## [非 Prop 的特性](%25180 "非 Prop 的特性")<a name="非-Prop-的特性"></a>
...
### [替换/合并已有的特性](%25181 "替换/合并已有的特性")<a name="替换-合并已有的特性"></a>
...
### [禁用特性继承](%25182 "禁用特性继承")<a name="禁用特性继承"></a>
