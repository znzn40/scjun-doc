...
## pack-*.pack files have the following format:<a name="_pack_pack_files_have_the_following_format"></a>
...
### Object types<a name="_object_types"></a>
...
### Deltified representation<a name="_deltified_representation"></a>
...
#### Instruction to copy from base object<a name="_instruction_to_copy_from_base_object"></a>
...
#### Instruction to add new data<a name="_instruction_to_add_new_data"></a>
...
#### Reserved instruction<a name="_reserved_instruction"></a>
...
## Original (version 1) pack-*.idx files have the following format:<a name="_original_version_1_pack_idx_files_have_the_following_format"></a>
...
## Version 2 pack-*.idx files support packs larger than 4 GiB, and<a name="_version_2_pack_idx_files_support_packs_larger_than_4_gib_and"></a>
