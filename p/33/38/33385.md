...
version:0
lang:zh
rawUrl:https://developer.mozilla.org/en-US/docs/Web/CSS/::-ms-expand
---
...
The**`::-ms-expand`**CSS[pseudo-element]28397 "en/CSS/Pseudo-elements")is a[Microsoft extension]28320 "")that represents the button of a[`<select>`]18852 "The HTML <select> element represents a control that provides a menu of options:")menu control that opens or closes the drop-down menu. Typically it is a triangle that points downward.


## Allowable Properties<a name="Allowable_properties"></a>


Only the following CSS properties can be used in a rule with`::-ms-expand`in its selector. Other properties are ignored.
