...
## [Router 初始化](%25431 "Router 初始化")<a name="Router-初始化"></a>

### [`router.start`<sup>替换</sup>](%25432 "router.start 替换")<a name="router-start-替换"></a>
...
## [Route 定义](%25433 "Route 定义")<a name="Route-定义"></a>

### [`router.map`<sup>替换</sup>](%25434 "router.map 替换")<a name="router-map-替换"></a>
...
### [`router.on`<sup>移除</sup>](%25436 "router.on 移除")<a name="router-on-移除"></a>
...
### [`router.beforeEach`<sup>changed</sup>](%25437 "router.beforeEach changed")<a name="router-beforeEach-changed"></a>
...
### [`subRoutes`<sup>换名</sup>](%25438 "subRoutes 换名")<a name="subRoutes-换名"></a>
...
### [`router.redirect`<sup>替换</sup>](%25440 "router.redirect 替换")<a name="router-redirect-替换"></a>
...
### [`router.alias`<sup>替换</sup>](%25442 "router.alias 替换")<a name="router-alias-替换"></a>
...
### [任意的 Route 属性<sup>替换</sup>](%25443 "任意的 Route 属性 替换")<a name="任意的-Route-属性-替换"></a>
...
### [URL 中的 Query 数组 [] 语法<sup>移除</sup>](%25444 "URL 中的 Query 数组 [] 语法 移除")<a name="URL-中的-Query-数组-语法-移除"></a>
...
## [Route 匹配](%25445 "Route 匹配")<a name="Route-匹配"></a>


路由匹配现在使用[path-to-regexp](%25446 "")这个包，这将会使得工作与之前相比更加灵活。


### [一个或者更多的命名参数<sup>改变</sup>](%25447 "一个或者更多的命名参数 改变")<a name="一个或者更多的命名参数-改变"></a>
...
## [链接](%25448 "链接")<a name="链接"></a>

### [`v-link`<sup>替换</sup>](%25449 "v-link 替换")<a name="v-link-替换"></a>
...
### [`v-link-active`<sup>替换</sup>](%25451 "v-link-active 替换")<a name="v-link-active-替换"></a>
...
## [编程导航](%25452 "编程导航")<a name="编程导航"></a>

### [`router.go`<sup>改变</sup>](%25453 "router.go 改变")<a name="router-go-改变"></a>
...
## [路由选择：Modes](%25457 "路由选择：Modes")<a name="路由选择：Modes"></a>

### [`hashbang: false`<sup>移除</sup>](%25458 "hashbang: false 移除")<a name="hashbang-false-移除"></a>
...
### [`history: true`<sup>替换</sup>](%25459 "history: true 替换")<a name="history-true-替换"></a>
...
### [`abstract: true`<sup>替换</sup>](%25461 "abstract: true 替换")<a name="abstract-true-替换"></a>
...
## [路由选项：Misc](%25462 "路由选项：Misc")<a name="路由选项：Misc"></a>

### [`saveScrollPosition`<sup>替换</sup>](%25463 "saveScrollPosition 替换")<a name="saveScrollPosition-替换"></a>
...
### [`root`<sup>换名</sup>](%25465 "root 换名")<a name="root-换名"></a>
...
### [`transitionOnLoad`<sup>移除</sup>](%25467 "transitionOnLoad 移除")<a name="transitionOnLoad-移除"></a>


由于 Vue 的过渡系统[`appear`transition control](%24928 "")的存在，这个选项将不再需要。
...
### [`suppressTransitionError`<sup>移除</sup>](%25468 "suppressTransitionError 移除")<a name="suppressTransitionError-移除"></a>
...
## [路由挂钩](%25470 "路由挂钩")<a name="路由挂钩"></a>

### [`activate`<sup>替换</sup>](%25471 "activate 替换")<a name="activate-替换"></a>
...
### [`canActivate`<sup>替换</sup>](%25473 "canActivate 替换")<a name="canActivate-替换"></a>
...
### [`deactivate`<sup>移除</sup>](%25475 "deactivate 移除")<a name="deactivate-移除"></a>
...
### [`canDeactivate`<sup>替换</sup>](%25477 "canDeactivate 替换")<a name="canDeactivate-替换"></a>
...
### [`canReuse: false`<sup>移除</sup>](%25478 "canReuse: false 移除")<a name="canReuse-false-移除"></a>
...
### [`data`<sup>替换</sup>](%25479 "data 替换")<a name="data-替换"></a>
...
### [`$loadingRouteData`<sup>移除</sup>](%25480 "$loadingRouteData 移除")<a name="loadingRouteData-移除"></a>
