...
version:0
lang:zh
rawUrl:https://developer.mozilla.org/en-US/docs/Web/CSS/-webkit-border-bottom-left-radius
---
...
<iframe src='https://interactive-examples.mdn.mozilla.net/pages/css/border-bottom-left-radius.html' width='100%' height='250'></iframe>
...
Specification | Status | Comment 
 ---  |  ---  |  ---  | 
[CSS Backgrounds and Borders Module Level 3<br></br><small>The definition of &#39;border-bottom-left-radius&#39; in that specification.</small>]28912 "") | Candidate Recommendation | Initial definition 
