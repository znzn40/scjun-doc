...
<dl><dt id='git-fast-import---force'>--force</dt><dd>
...
</dd><dt id='git-fast-import---quiet'>--quiet</dt><dd>
...
</dd><dt id='git-fast-import---stats'>--stats</dt><dd>
...
### Options for Frontends<a name="_options_for_frontends"></a>
<dl><dt id='git-fast-import---cat-blob-fdltfdgt'>--cat-blob-fd=&lt;fd&gt;</dt><dd>
...
</dd><dt id='git-fast-import---date-formatltfmtgt'>--date-format=&lt;fmt&gt;</dt><dd>
...
</dd><dt id='git-fast-import---done'>--done</dt><dd>
...
### Locations of Marks Files<a name="_locations_of_marks_files"></a>
<dl><dt id='git-fast-import---export-marksltfilegt'>--export-marks=&lt;file&gt;</dt><dd>
...
</dd><dt id='git-fast-import---import-marksltfilegt'>--import-marks=&lt;file&gt;</dt><dd>
...
</dd><dt id='git-fast-import---import-marks-if-existsltfilegt'>--import-marks-if-exists=&lt;file&gt;</dt><dd>

Like --import-marks but instead of erroring out, silently skips the file if it does not exist.

</dd><dt id='git-fast-import---no-relative-marks'>--[no-]relative-marks</dt><dd>
...
### Performance and Compression Tuning<a name="_performance_and_compression_tuning"></a>
<dl><dt id='git-fast-import---active-branchesltngt'>--active-branches=&lt;n&gt;</dt><dd>

Maximum number of branches to maintain active at once. See “Memory Utilization” below for details. Default is 5.

</dd><dt id='git-fast-import---big-file-thresholdltngt'>--big-file-threshold=&lt;n&gt;</dt><dd>
...
</dd><dt id='git-fast-import---depthltngt'>--depth=&lt;n&gt;</dt><dd>

Maximum delta depth, for blob and tree deltification. Default is 50.

</dd><dt id='git-fast-import---export-pack-edgesltfilegt'>--export-pack-edges=&lt;file&gt;</dt><dd>
...
</dd><dt id='git-fast-import---max-pack-sizeltngt'>--max-pack-size=&lt;n&gt;</dt><dd>

Maximum size of each output packfile. The default is unlimited.

</dd><dt id='git-fast-import-fastimportunpackLimit'>fastimport.unpackLimit</dt><dd>
...
## DEVELOPMENT COST<a name="_development_cost"></a>
...
## PARALLEL OPERATION<a name="_parallel_operation"></a>
...
## TECHNICAL DISCUSSION<a name="_technical_discussion"></a>
...
### Stream Comments<a name="_stream_comments"></a>
...
<dl><dt id='git-fast-import-coderawcode'>`raw`</dt><dd>
...
</dd><dt id='git-fast-import-coderfc2822code'>`rfc2822`</dt><dd>
...
</dd><dt id='git-fast-import-codenowcode'>`now`</dt><dd>
...
<dl><dt id='git-fast-import-codecommitcode'>`commit`</dt><dd>
...
</dd><dt id='git-fast-import-codetagcode'>`tag`</dt><dd>
...
</dd><dt id='git-fast-import-coderesetcode'>`reset`</dt><dd>
...
</dd><dt id='git-fast-import-codeblobcode'>`blob`</dt><dd>
...
</dd><dt id='git-fast-import-codecheckpointcode'>`checkpoint`</dt><dd>
...
</dd><dt id='git-fast-import-codeprogresscode'>`progress`</dt><dd>
...
</dd><dt id='git-fast-import-codedonecode'>`done`</dt><dd>
...
</dd><dt id='git-fast-import-codeget-markcode'>`get-mark`</dt><dd>
...
</dd><dt id='git-fast-import-codecat-blobcode'>`cat-blob`</dt><dd>
...
</dd><dt id='git-fast-import-codelscode'>`ls`</dt><dd>
...
### `commit`<a name="_code_commit_code"></a>
...
#### `author`<a name="_code_author_code"></a>
...
#### `committer`<a name="_code_committer_code"></a>
...
#### `merge`<a name="_code_merge_code"></a>
...
#### `filemodify`<a name="_code_filemodify_code"></a>
...
<dl><dt id='git-fast-import-Externaldataformat'>External data format</dt><dd>
...
</dd><dt id='git-fast-import-Inlinedataformat'>Inline data format</dt><dd>
...
#### `filedelete`<a name="_code_filedelete_code"></a>
...
#### `filecopy`<a name="_code_filecopy_code"></a>
...
#### `filerename`<a name="_code_filerename_code"></a>
...
#### `filedeleteall`<a name="_code_filedeleteall_code"></a>
...
#### `notemodify`<a name="_code_notemodify_code"></a>
...
### `reset`<a name="_code_reset_code"></a>
...
<dl><dt id='git-fast-import-Exactbytecountformat'>Exact byte count format</dt><dd>
...
</dd><dt id='git-fast-import-Delimitedformat'>Delimited format</dt><dd>
...
### `checkpoint`<a name="_code_checkpoint_code"></a>
...
### `progress`<a name="_code_progress_code"></a>
...
### `get-mark`<a name="_code_get_mark_code"></a>
...
### `cat-blob`<a name="_code_cat_blob_code"></a>
...
<dl><dt id='git-fast-import-Readingfromtheactivecommit'>Reading from the active commit</dt><dd>
...
</dd><dt id='git-fast-import-Readingfromanamedtree'>Reading from a named tree</dt><dd>
...
### `feature`<a name="_code_feature_code"></a>
...
<dl><dt id='git-fast-import-date-format'>date-format</dt><dt id='git-fast-import-export-marks'>export-marks</dt><dt id='git-fast-import-relative-marks'>relative-marks</dt><dt id='git-fast-import-no-relative-marks'>no-relative-marks</dt><dt id='git-fast-import-force'>force</dt><dd>

Act as though the corresponding command-line option with a leading`--`was passed on the command line (see OPTIONS, above).

</dd><dt id='git-fast-import-import-marks'>import-marks</dt><dt id='git-fast-import-import-marks-if-exists'>import-marks-if-exists</dt><dd>
...
</dd><dt id='git-fast-import-get-mark'>get-mark</dt><dt id='git-fast-import-cat-blob'>cat-blob</dt><dt id='git-fast-import-ls'>ls</dt><dd>
...
</dd><dt id='git-fast-import-notes'>notes</dt><dd>
...
### `option`<a name="_code_option_code"></a>
...
## RESPONSES TO COMMANDS<a name="_responses_to_commands"></a>
...
## CRASH REPORTS<a name="_crash_reports"></a>
...
## TIPS AND TRICKS<a name="_tips_and_tricks"></a>
...
### Use One Mark Per Commit<a name="_use_one_mark_per_commit"></a>
...
### Freely Skip Around Branches<a name="_freely_skip_around_branches"></a>
...
### Handling Renames<a name="_handling_renames"></a>
...
### Use Tag Fixup Branches<a name="_use_tag_fixup_branches"></a>
...
### Import Now, Repack Later<a name="_import_now_repack_later"></a>
...
### Repacking Historical Data<a name="_repacking_historical_data"></a>
...
### Include Some Progress Messages<a name="_include_some_progress_messages"></a>
...
## PACKFILE OPTIMIZATION<a name="_packfile_optimization"></a>
...
## MEMORY UTILIZATION<a name="_memory_utilization"></a>
...
### per object<a name="_per_object"></a>
...
### per branch<a name="_per_branch"></a>
...
### per active tree<a name="_per_active_tree"></a>
...
### per active file entry<a name="_per_active_file_entry"></a>
