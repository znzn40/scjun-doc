...
## [](%7073 "")SYNOPSIS<a name="_synopsis"></a>
...
## [](%7074 "")DESCRIPTION<a name="_description"></a>
...
## [](%7075 "")OPTIONS<a name="_options"></a>
<dl><dt id='git-branch--d'>[](%7076 "")-d</dt><dt id='git-branch---delete'>[](%7077 "")--delete</dt><dd>

Delete a branch. The branch must be fully merged in its upstream branch, or in`HEAD`if no upstream was set with`--track`or`--set-upstream-to`.

</dd><dt id='git-branch--D'>[](%7079 "")-D</dt><dd>

Shortcut for`--delete --force`.

</dd><dt id='git-branch--l'>[](%7081 "")-l</dt><dt id='git-branch---create-reflog'>[](%7082 "")--create-reflog</dt><dd>
...
</dd><dt id='git-branch--f'>[](%7085 "")-f</dt><dt id='git-branch---force'>[](%7086 "")--force</dt><dd>
...
</dd><dt id='git-branch--m'>[](%7089 "")-m</dt><dt id='git-branch---move'>[](%7090 "")--move</dt><dd>

Move/rename a branch and the corresponding reflog.

</dd><dt id='git-branch--M'>[](%7091 "")-M</dt><dd>

Shortcut for`--move --force`.

</dd><dt id='git-branch--c'>[](%7092 "")-c</dt><dt id='git-branch---copy'>[](%7093 "")--copy</dt><dd>

Copy a branch and the corresponding reflog.

</dd><dt id='git-branch--C'>[](%7094 "")-C</dt><dd>

Shortcut for`--copy --force`.

</dd><dt id='git-branch---colorltwhengt'>[](%7095 "")--color[=&lt;when&gt;]</dt><dd>

Color branches to highlight current, local, and remote-tracking branches. The value must be always (the default), never, or auto.

</dd><dt id='git-branch---no-color'>[](%7096 "")--no-color</dt><dd>

Turn off branch colors, even when the configuration file gives the default to color output. Same as`--color=never`.

</dd><dt id='git-branch--i'>[](%7097 "")-i</dt><dt id='git-branch---ignore-case'>[](%7098 "")--ignore-case</dt><dd>

Sorting and filtering branches are case insensitive.

</dd><dt id='git-branch---columnltoptionsgt'>[](%7099 "")--column[=&lt;options&gt;]</dt><dt id='git-branch---no-column'>[](%7100 "")--no-column</dt><dd>
...
</dd><dt id='git-branch--r'>[](%7103 "")-r</dt><dt id='git-branch---remotes'>[](%7104 "")--remotes</dt><dd>

List or delete (if used with -d) the remote-tracking branches.

</dd><dt id='git-branch--a'>[](%7105 "")-a</dt><dt id='git-branch---all'>[](%7106 "")--all</dt><dd>

List both remote-tracking branches and local branches.

</dd><dt id='git-branch---list'>[](%7107 "")--list</dt><dd>
...
</dd><dt id='git-branch--v'>[](%7110 "")-v</dt><dt id='git-branch--vv'>[](%7111 "")-vv</dt><dt id='git-branch---verbose'>[](%7112 "")--verbose</dt><dd>
...
</dd><dt id='git-branch--q'>[](%7113 "")-q</dt><dt id='git-branch---quiet'>[](%7114 "")--quiet</dt><dd>

Be more quiet when creating or deleting a branch, suppressing non-error messages.

</dd><dt id='git-branch---abbrevltlengthgt'>[](%7115 "")--abbrev=&lt;length&gt;</dt><dd>
...
</dd><dt id='git-branch---no-abbrev'>[](%7116 "")--no-abbrev</dt><dd>

Display the full sha1s in the output listing rather than abbreviating them.

</dd><dt id='git-branch--t'>[](%7117 "")-t</dt><dt id='git-branch---track'>[](%7118 "")--track</dt><dd>
...
</dd><dt id='git-branch---no-track'>[](%7119 "")--no-track</dt><dd>

Do not set up &quot;upstream&quot; configuration, even if the branch.autoSetupMerge configuration variable is true.

</dd><dt id='git-branch---set-upstream'>[](%7120 "")--set-upstream</dt><dd>

As this option had confusing syntax, it is no longer supported. Please use`--track`or`--set-upstream-to`instead.

</dd><dt id='git-branch--ultupstreamgt'>[](%7121 "")-u &lt;upstream&gt;</dt><dt id='git-branch---set-upstream-toltupstreamgt'>[](%7122 "")--set-upstream-to=&lt;upstream&gt;</dt><dd>

Set up &lt;branchname&gt;&#39;s tracking information so &lt;upstream&gt; is considered &lt;branchname&gt;&#39;s upstream branch. If no &lt;branchname&gt; is specified, then it defaults to the current branch.

</dd><dt id='git-branch---unset-upstream'>[](%7123 "")--unset-upstream</dt><dd>

Remove the upstream information for &lt;branchname&gt;. If no branch is specified it defaults to the current branch.

</dd><dt id='git-branch---edit-description'>[](%7124 "")--edit-description</dt><dd>
...
</dd><dt id='git-branch---containsltcommitgt'>[](%7127 "")--contains [&lt;commit&gt;]</dt><dd>

Only list branches which contain the specified commit (HEAD if not specified). Implies`--list`.

</dd><dt id='git-branch---no-containsltcommitgt'>[](%7129 "")--no-contains [&lt;commit&gt;]</dt><dd>

Only list branches which don’t contain the specified commit (HEAD if not specified). Implies`--list`.

</dd><dt id='git-branch---mergedltcommitgt'>[](%7131 "")--merged [&lt;commit&gt;]</dt><dd>
...
</dd><dt id='git-branch---no-mergedltcommitgt'>[](%7132 "")--no-merged [&lt;commit&gt;]</dt><dd>
...
</dd><dt id='git-branch-ltbranchnamegt'>[](%7133 "")&lt;branchname&gt;</dt><dd>
...
</dd><dt id='git-branch-ltstart-pointgt'>[](%7135 "")&lt;start-point&gt;</dt><dd>

The new branch head will point to this commit. It may be given as a branch name, a commit-id, or a tag. If this option is omitted, the current HEAD will be used instead.

</dd><dt id='git-branch-ltoldbranchgt'>[](%7136 "")&lt;oldbranch&gt;</dt><dd>

The name of an existing branch to rename.

</dd><dt id='git-branch-ltnewbranchgt'>[](%7137 "")&lt;newbranch&gt;</dt><dd>

The new name for an existing branch. The same restrictions as for &lt;branchname&gt; apply.

</dd><dt id='git-branch---sortltkeygt'>[](%7138 "")--sort=&lt;key&gt;</dt><dd>
...
</dd><dt id='git-branch---points-atltobjectgt'>[](%7139 "")--points-at &lt;object&gt;</dt><dd>

Only list branches of the given object.

</dd><dt id='git-branch---formatltformatgt'>[](%7140 "")--format &lt;format&gt;</dt><dd>
...
## [](%7141 "")CONFIGURATION<a name="_configuration"></a>
...
## [](%7144 "")EXAMPLES<a name="_examples"></a>
<dl><dt id='git-branch-Startdevelopmentfromaknowntag'>[](%7146 "")Start development from a known tag</dt><dd>
```
...
</dd><dt id='git-branch-Deleteanunneededbranch'>[](%7147 "")Delete an unneeded branch</dt><dd>
```
...
## [](%7149 "")SEE ALSO<a name="_see_also"></a>


[git-check-ref-format[1]](%5448 ""),[git-fetch[1]](%2268 ""),[git-remote[1]](%2271 ""),[“Understanding history: What is a branch?”](%7150 "")in the Git User’s Manual.





## [](%7152 "")GIT<a name="_git"></a>
