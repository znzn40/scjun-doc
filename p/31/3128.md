...
version:0
lang:zh
rawUrl:https://developer.mozilla.org/zh-CN/docs/Web/API/SVGFETileElement
---



<bdi>我们的志愿者还没有将这篇文章翻译为<bdi>中文 (简体)</bdi>。[加入我们帮助完成翻译]17799 "")<br></br>您也可以阅读此文章的[English (US)]17800 "")版。</bdi>
...
The**`SVGFETileElement`**interface corresponds to the[`<feTile>`]17801 "The <feTile> SVG filter primitive allows to fill a target rectangle with a repeated, tiled pattern of an input image. The effect is similar to the one of a <pattern>.")element.

<iframe src='https://mdn.mozillademos.org/en-US/docs/Web/API/SVGFETileElement$samples/inheritance_diagram?revision=1377372' width='600' height='140'></iframe>
...
[Filter Effects Module Level 1<br></br><small>The definition of &#39;SVGFETileElement&#39; in that specification.</small>]17803 "") | Working Draft | No change 
[Scalable Vector Graphics (SVG) 1.1 (Second Edition)<br></br><small>The definition of &#39;SVGFETileElement&#39; in that specification.</small>]17804 "") | Recommendation | Initial definition 
...
* [`<feTile>`]17801 "The <feTile> SVG filter primitive allows to fill a target rectangle with a repeated, tiled pattern of an input image. The effect is similar to the one of a <pattern>.")
...
**最后编辑者:**[fscholz]60 ""),<time>Apr 27, 2018, 5:19:37 AM</time>
