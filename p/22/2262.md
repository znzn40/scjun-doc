...
## [](%7215 "")SYNOPSIS<a name="_synopsis"></a>
...
## [](%7216 "")DESCRIPTION<a name="_description"></a>
...
## [](%7217 "")OPTIONS<a name="_options"></a>
<dl><dt id='git-merge---commit'>[](%7218 "")--commit</dt><dt id='git-merge---no-commit'>[](%7219 "")--no-commit</dt><dd>
...
</dd><dt id='git-merge---edit'>[](%7220 "")--edit</dt><dt id='git-merge--e'>[](%7221 "")-e</dt><dt id='git-merge---no-edit'>[](%7222 "")--no-edit</dt><dd>
...
</dd><dt id='git-merge---ff'>[](%7223 "")--ff</dt><dd>

When the merge resolves as a fast-forward, only update the branch pointer, without creating a merge commit. This is the default behavior.

</dd><dt id='git-merge---no-ff'>[](%7224 "")--no-ff</dt><dd>
...
</dd><dt id='git-merge---ff-only'>[](%7225 "")--ff-only</dt><dd>

Refuse to merge and exit with a non-zero status unless the current`HEAD`is already up to date or the merge can be resolved as a fast-forward.

</dd><dt id='git-merge--Sltkeyidgt'>[](%7226 "")-S[&lt;keyid&gt;]</dt><dt id='git-merge---gpg-signltkeyidgt'>[](%7227 "")--gpg-sign[=&lt;keyid&gt;]</dt><dd>
...
</dd><dt id='git-merge---logltngt'>[](%7228 "")--log[=&lt;n&gt;]</dt><dt id='git-merge---no-log'>[](%7229 "")--no-log</dt><dd>
...
</dd><dt id='git-merge---signoff'>[](%7230 "")--signoff</dt><dt id='git-merge---no-signoff'>[](%7231 "")--no-signoff</dt><dd>
...
</dd><dt id='git-merge---stat'>[](%7232 "")--stat</dt><dt id='git-merge--n'>[](%7233 "")-n</dt><dt id='git-merge---no-stat'>[](%7234 "")--no-stat</dt><dd>
...
</dd><dt id='git-merge---squash'>[](%7235 "")--squash</dt><dt id='git-merge---no-squash'>[](%7236 "")--no-squash</dt><dd>
...
</dd><dt id='git-merge--sltstrategygt'>[](%7237 "")-s &lt;strategy&gt;</dt><dt id='git-merge---strategyltstrategygt'>[](%7238 "")--strategy=&lt;strategy&gt;</dt><dd>
...
</dd><dt id='git-merge--Xltoptiongt'>[](%7241 "")-X &lt;option&gt;</dt><dt id='git-merge---strategy-optionltoptiongt'>[](%7242 "")--strategy-option=&lt;option&gt;</dt><dd>

Pass merge strategy specific option through to the merge strategy.

</dd><dt id='git-merge---verify-signatures'>[](%7243 "")--verify-signatures</dt><dt id='git-merge---no-verify-signatures'>[](%7245 "")--no-verify-signatures</dt><dd>

Verify that the tip commit of the side branch being merged is signed with a valid key, i.e. a key that has a valid uid: in the default trust model, this means the signing key has been signed by a trusted key. If the tip commit of the side branch is not signed with a valid key, the merge is aborted.

</dd><dt id='git-merge---summary'>[](%7248 "")--summary</dt><dt id='git-merge---no-summary'>[](%7249 "")--no-summary</dt><dd>

Synonyms to --stat and --no-stat; these are deprecated and will be removed in the future.

</dd><dt id='git-merge--q'>[](%7250 "")-q</dt><dt id='git-merge---quiet'>[](%7251 "")--quiet</dt><dd>

Operate quietly. Implies --no-progress.

</dd><dt id='git-merge--v'>[](%7252 "")-v</dt><dt id='git-merge---verbose'>[](%7254 "")--verbose</dt><dd>

Be verbose.

</dd><dt id='git-merge---progress'>[](%7255 "")--progress</dt><dt id='git-merge---no-progress'>[](%7256 "")--no-progress</dt><dd>

Turn progress on/off explicitly. If neither is specified, progress is shown if standard error is connected to a terminal. Note that not all merge strategies may support progress reporting.

</dd><dt id='git-merge---allow-unrelated-histories'>[](%7257 "")--allow-unrelated-histories</dt><dd>

By default,`git merge`command refuses to merge histories that do not share a common ancestor. This option can be used to override this safety when merging histories of two projects that started their lives independently. As that is a very rare occasion, no configuration variable to enable this by default exists and will not be added.

</dd></dl>
<dl><dt id='git-merge--mltmsggt'>[](%7258 "")-m &lt;msg&gt;</dt><dd>
...
</dd><dt id='git-merge---no-rerere-autoupdate'>[](%7259 "")--[no-]rerere-autoupdate</dt><dd>

Allow the rerere mechanism to update the index with the result of auto-conflict resolution if possible.

</dd><dt id='git-merge---abort'>[](%7260 "")--abort</dt><dd>
...
</dd><dt id='git-merge---continue'>[](%7261 "")--continue</dt><dd>
...
</dd><dt id='git-merge-ltcommitgt82308203'>[](%7262 "")&lt;commit&gt;…​</dt><dd>
...
## [](%7264 "")PRE-MERGE CHECKS<a name="_pre_merge_checks"></a>
...
## [](%7266 "")FAST-FORWARD MERGE<a name="_fast_forward_merge"></a>
...
## [](%7271 "")TRUE MERGE<a name="_true_merge"></a>
...
## [](%7273 "")MERGING TAG<a name="_merging_tag"></a>
...
## [](%7274 "")HOW CONFLICTS ARE PRESENTED<a name="_how_conflicts_are_presented"></a>
...
## [](%7275 "")HOW TO RESOLVE CONFLICTS<a name="_how_to_resolve_conflicts"></a>
...
## [](%7276 "")EXAMPLES<a name="_examples"></a>
...
## [](%7277 "")MERGE STRATEGIES<a name="_merge_strategies"></a>
...
<dl><dt id='git-merge-resolve'>[](%7278 "")resolve</dt><dd>

This can only resolve two heads (i.e. the current branch and another branch you pulled from) using a 3-way merge algorithm. It tries to carefully detect criss-cross merge ambiguities and is considered generally safe and fast.

</dd><dt id='git-merge-recursive'>[](%7279 "")recursive</dt><dd>
...
<dl><dt id='git-merge-ours'>[](%7280 "")ours</dt><dd>
...
</dd><dt id='git-merge-theirs'>[](%7281 "")theirs</dt><dd>
...
</dd><dt id='git-merge-patience'>[](%7282 "")patience</dt><dd>
...
</dd><dt id='git-merge-diff-algorithmpatienceminimalhistogrammyers'>[](%7283 "")diff-algorithm=[patience|minimal|histogram|myers]</dt><dd>
...
</dd><dt id='git-merge-ignore-space-change'>[](%7284 "")ignore-space-change</dt><dt id='git-merge-ignore-all-space'>[](%7285 "")ignore-all-space</dt><dt id='git-merge-ignore-space-at-eol'>[](%7286 "")ignore-space-at-eol</dt><dt id='git-merge-ignore-cr-at-eol'>[](%7287 "")ignore-cr-at-eol</dt><dd>
...
</dd><dt id='git-merge-renormalize'>[](%7288 "")renormalize</dt><dd>

This runs a virtual check-out and check-in of all three stages of a file when resolving a three-way merge. This option is meant to be used when merging branches with different clean filters or end-of-line normalization rules. See &quot;Merging branches with differing checkin/checkout attributes&quot; in[gitattributes[5]](%2283 "")for details.

</dd><dt id='git-merge-no-renormalize'>[](%7289 "")no-renormalize</dt><dd>

Disables the`renormalize`option. This overrides the`merge.renormalize`configuration variable.

</dd><dt id='git-merge-no-renames'>[](%7290 "")no-renames</dt><dd>

Turn off rename detection. This overrides the`merge.renames`configuration variable. See also[git-diff[1]](%2255 "")`--no-renames`.

</dd><dt id='git-merge-find-renamesltngt'>[](%7291 "")find-renames[=&lt;n&gt;]</dt><dd>
...
</dd><dt id='git-merge-rename-thresholdltngt'>[](%7292 "")rename-threshold=&lt;n&gt;</dt><dd>

Deprecated synonym for`find-renames=<n>`.

</dd><dt id='git-merge-subtreeltpathgt'>[](%7293 "")subtree[=&lt;path&gt;]</dt><dd>
...
</dd><dt id='git-merge-octopus'>[](%7294 "")octopus</dt><dd>

This resolves cases with more than two heads, but refuses to do a complex merge that needs manual resolution. It is primarily meant to be used for bundling topic branch heads together. This is the default merge strategy when pulling or merging more than one branch.

</dd><dt id='git-merge-ours'>[](%7280 "")ours</dt><dd>
...
</dd><dt id='git-merge-subtree'>[](%7295 "")subtree</dt><dd>
...
## [](%7296 "")CONFIGURATION<a name="_configuration"></a>
<dl><dt id='git-merge-mergeconflictStyle'>[](%7297 "")merge.conflictStyle</dt><dd>

Specify the style in which conflicted hunks are written out to working tree files upon merge. The default is &quot;merge&quot;, which shows a`<<<<<<<`conflict marker, changes made by one side, a`=======`marker, changes made by the other side, and then a`>>>>>>>`marker. An alternate style, &quot;diff3&quot;, adds a`|||||||`marker and the original text before the`=======`marker.

</dd><dt id='git-merge-mergedefaultToUpstream'>[](%7298 "")merge.defaultToUpstream</dt><dd>

If merge is called without any commit argument, merge the upstream branches configured for the current branch by using their last observed values stored in their remote-tracking branches. The values of the`branch.<current branch>.merge`that name the branches at the remote named by`branch.<current branch>.remote`are consulted, and then they are mapped via`remote.<remote>.fetch`to their corresponding remote-tracking branches, and the tips of these tracking branches are merged.

</dd><dt id='git-merge-mergeff'>[](%7299 "")merge.ff</dt><dd>

By default, Git does not create an extra merge commit when merging a commit that is a descendant of the current commit. Instead, the tip of the current branch is fast-forwarded. When set to`false`, this variable tells Git to create an extra merge commit in such a case (equivalent to giving the`--no-ff`option from the command line). When set to`only`, only such fast-forward merges are allowed (equivalent to giving the`--ff-only`option from the command line).

</dd><dt id='git-merge-mergeverifySignatures'>[](%7300 "")merge.verifySignatures</dt><dd>

If true, this is equivalent to the --verify-signatures command line option. See[git-merge[1]](%2262 "")for details.

</dd><dt id='git-merge-mergebranchdesc'>[](%7301 "")merge.branchdesc</dt><dd>

In addition to branch names, populate the log message with the branch description text associated with them. Defaults to false.

</dd><dt id='git-merge-mergelog'>[](%7302 "")merge.log</dt><dd>

In addition to branch names, populate the log message with at most the specified number of one-line descriptions from the actual commits that are being merged. Defaults to false, and true is a synonym for 20.

</dd></dl>
<dl><dt id='git-merge-mergerenameLimit'>[](%7303 "")merge.renameLimit</dt><dd>
...
</dd><dt id='git-merge-mergerenames'>[](%7304 "")merge.renames</dt><dd>
...
</dd><dt id='git-merge-mergerenormalize'>[](%7305 "")merge.renormalize</dt><dd>
...
</dd><dt id='git-merge-mergestat'>[](%7306 "")merge.stat</dt><dd>

Whether to print the diffstat between ORIG_HEAD and the merge result at the end of the merge. True by default.

</dd><dt id='git-merge-mergetool'>[](%7307 "")merge.tool</dt><dd>
...
<dl><dt id='git-merge-branchltnamegtmergeOptions'>[](%7312 "")branch.&lt;name&gt;.mergeOptions</dt><dd>
...
## [](%7313 "")SEE ALSO<a name="_see_also"></a>
