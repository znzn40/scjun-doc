...
</dd><dt id='git-config-pushNeedsForce'>[](%2249#git-config-pushNeedsForce "")pushNeedsForce</dt><dd>
...
</dd><dt id='git-config-coreprotectNTFS'>[](%2249#git-config-coreprotectNTFS "")core.protectNTFS</dt><dd>
...
</dd><dt id='git-config-coresafecrlf'>[](%2249#git-config-coresafecrlf "")core.safecrlf</dt><dd>
...
</dd><dt id='git-config-alias'>[](%2249#git-config-alias "")alias.*</dt><dd>
...
</dd><dt id='git-config-blamedate'>[](%2249#git-config-blamedate "")blame.date</dt><dd>
...
</dd><dt id='git-config-branchltnamegtmergeOptions'>[](%2249#git-config-branchltnamegtmergeOptions "")branch.&lt;name&gt;.mergeOptions</dt><dd>
...
</dd><dt id='git-config-coloradvicehint'>[](%2249#git-config-coloradvicehint "")color.advice.hint</dt><dd>
...
</dd><dt id='git-config-colorgrepltslotgt'>[](%2249#git-config-colorgrepltslotgt "")color.grep.&lt;slot&gt;</dt><dd>
...
</dd><dt id='git-config-commitstatus'>[](%2249#git-config-commitstatus "")commit.status</dt><dd>
...
</dd><dt id='git-config-diffdirstat'>[](%2249#git-config-diffdirstat "")diff.dirstat</dt><dd>
...
</dd><dt id='git-config-diffinterHunkContext'>[](%2249#git-config-diffinterHunkContext "")diff.interHunkContext</dt><dd>
...
</dd><dt id='git-config-difforderFile'>[](%2249#git-config-difforderFile "")diff.orderFile</dt><dd>
...
</dd><dt id='git-config-diffltdrivergtwordRegex'>[](%2249#git-config-diffltdrivergtwordRegex "")diff.&lt;driver&gt;.wordRegex</dt><dd>
...
<dl><dt id='git-config-codedefaultcodecodemyerscode'>[](%2249#git-config-codedefaultcodecodemyerscode "")`default`,`myers`</dt><dd>
...
</dd><dt id='git-config-fetchfsckObjects'>[](%2249#git-config-fetchfsckObjects "")fetch.fsckObjects</dt><dd>
...
</dd><dt id='git-config-fetchunpackLimit'>[](%2249#git-config-fetchunpackLimit "")fetch.unpackLimit</dt><dd>

If the number of objects fetched over the Git native transfer is below this limit, then the objects will be unpacked into loose object files. However if the number of received objects equals or exceeds this limit then the received pack will be stored as a pack, after adding any missing delta bases. Storing the pack from a push can make the push operation complete faster, especially on slow filesystems. If not set, the value of`transfer.unpackLimit`is used instead.

</dd><dt id='git-config-fetchprune'>[](%2249#git-config-fetchprune "")fetch.prune</dt><dd>
...
</dd><dt id='git-config-fetchpruneTags'>[](%2249#git-config-fetchpruneTags "")fetch.pruneTags</dt><dd>
...
</dd><dt id='git-config-fetchoutput'>[](%2249#git-config-fetchoutput "")fetch.output</dt><dd>
...
</dd><dt id='git-config-formatattach'>[](%2249#git-config-formatattach "")format.attach</dt><dd>
...
</dd><dt id='git-config-formatfrom'>[](%2249#git-config-formatfrom "")format.from</dt><dd>
...
</dd><dt id='git-config-formatnumbered'>[](%2249#git-config-formatnumbered "")format.numbered</dt><dd>
...
</dd><dt id='git-config-formatheaders'>[](%2249#git-config-formatheaders "")format.headers</dt><dd>

Additional email headers to include in a patch to be submitted by mail. See[git-format-patch[1]](%2292  "").

</dd><dt id='git-config-formatto'>[](%2249#git-config-formatto "")format.to</dt><dt id='git-config-formatcc'>[](%2249#git-config-formatcc "")format.cc</dt><dd>

Additional recipients to include in a patch to be submitted by mail. See the --to and --cc options in[git-format-patch[1]](%2292  "").

</dd><dt id='git-config-formatsubjectPrefix'>[](%2249#git-config-formatsubjectPrefix "")format.subjectPrefix</dt><dd>
...
</dd><dt id='git-config-formatsignature'>[](%2249#git-config-formatsignature "")format.signature</dt><dd>
...
</dd><dt id='git-config-formatsignatureFile'>[](%2249#git-config-formatsignatureFile "")format.signatureFile</dt><dd>
...
</dd><dt id='git-config-formatsuffix'>[](%2249#git-config-formatsuffix "")format.suffix</dt><dd>
...
</dd><dt id='git-config-formatpretty'>[](%2249#git-config-formatpretty "")format.pretty</dt><dd>

The default pretty format for log/show/whatchanged command, See[git-log[1]](%2264  ""),[git-show[1]](%2273  ""),[git-whatchanged[1]](%5341  "").

</dd><dt id='git-config-formatthread'>[](%2249#git-config-formatthread "")format.thread</dt><dd>
...
</dd><dt id='git-config-formatsignOff'>[](%2249#git-config-formatsignOff "")format.signOff</dt><dd>
...
</dd><dt id='git-config-formatcoverLetter'>[](%2249#git-config-formatcoverLetter "")format.coverLetter</dt><dd>
...
</dd><dt id='git-config-formatoutputDirectory'>[](%2249#git-config-formatoutputDirectory "")format.outputDirectory</dt><dd>

Set a custom directory to store the resulting files instead of the current working directory.

</dd><dt id='git-config-formatuseAutoBase'>[](%2249#git-config-formatuseAutoBase "")format.useAutoBase</dt><dd>

A boolean value which lets you enable the`--base=auto`option of format-patch by default.

</dd><dt id='git-config-filterltdrivergtclean'>[](%2249#git-config-filterltdrivergtclean "")filter.&lt;driver&gt;.clean</dt><dd>
...
</dd><dt id='git-config-filterltdrivergtsmudge'>[](%2249#git-config-filterltdrivergtsmudge "")filter.&lt;driver&gt;.smudge</dt><dd>
...
</dd><dt id='git-config-fsckltmsg-idgt'>[](%2249#git-config-fsckltmsg-idgt "")fsck.&lt;msg-id&gt;</dt><dd>
...
</dd><dt id='git-config-fsckskipList'>[](%2249#git-config-fsckskipList "")fsck.skipList</dt><dd>
...
</dd><dt id='git-config-gcaggressiveDepth'>[](%2249#git-config-gcaggressiveDepth "")gc.aggressiveDepth</dt><dd>

The depth parameter used in the delta compression algorithm used by<em>git gc --aggressive</em>. This defaults to 50.

</dd><dt id='git-config-gcaggressiveWindow'>[](%2249#git-config-gcaggressiveWindow "")gc.aggressiveWindow</dt><dd>

The window size parameter used in the delta compression algorithm used by<em>git gc --aggressive</em>. This defaults to 250.

</dd><dt id='git-config-gcauto'>[](%2249#git-config-gcauto "")gc.auto</dt><dd>
...
</dd><dt id='git-config-gcautoPackLimit'>[](%2249#git-config-gcautoPackLimit "")gc.autoPackLimit</dt><dd>
...
</dd><dt id='git-config-gcautoDetach'>[](%2249#git-config-gcautoDetach "")gc.autoDetach</dt><dd>

Make`git gc --auto`return immediately and run in background if the system supports it. Default is true.

</dd><dt id='git-config-gcbigPackThreshold'>[](%2249#git-config-gcbigPackThreshold "")gc.bigPackThreshold</dt><dd>
...
</dd><dt id='git-config-gclogExpiry'>[](%2249#git-config-gclogExpiry "")gc.logExpiry</dt><dd>
...
</dd><dt id='git-config-gcpackRefs'>[](%2249#git-config-gcpackRefs "")gc.packRefs</dt><dd>
...
</dd><dt id='git-config-gcpruneExpire'>[](%2249#git-config-gcpruneExpire "")gc.pruneExpire</dt><dd>
...
</dd><dt id='git-config-gcworktreePruneExpire'>[](%2249#git-config-gcworktreePruneExpire "")gc.worktreePruneExpire</dt><dd>
...
</dd><dt id='git-config-gcreflogExpire'>[](%2249#git-config-gcreflogExpire "")gc.reflogExpire</dt><dt id='git-config-gcltpatterngtreflogExpire'>[](%2249#git-config-gcltpatterngtreflogExpire "")gc.&lt;pattern&gt;.reflogExpire</dt><dd>
...
</dd><dt id='git-config-gcreflogExpireUnreachable'>[](%2249#git-config-gcreflogExpireUnreachable "")gc.reflogExpireUnreachable</dt><dt id='git-config-gcltpatterngtreflogExpireUnreachable'>[](%2249#git-config-gcltpatterngtreflogExpireUnreachable "")gc.&lt;pattern&gt;.reflogExpireUnreachable</dt><dd>
...
</dd><dt id='git-config-gcrerereResolved'>[](%2249#git-config-gcrerereResolved "")gc.rerereResolved</dt><dd>
...
</dd><dt id='git-config-gcrerereUnresolved'>[](%2249#git-config-gcrerereUnresolved "")gc.rerereUnresolved</dt><dd>
...
</dd><dt id='git-config-gitcvscommitMsgAnnotation'>[](%2249#git-config-gitcvscommitMsgAnnotation "")gitcvs.commitMsgAnnotation</dt><dd>

Append this string to each commit message. Set to empty string to disable this feature. Defaults to &quot;via git-CVS emulator&quot;.

</dd><dt id='git-config-gitcvsenabled'>[](%2249#git-config-gitcvsenabled "")gitcvs.enabled</dt><dd>

Whether the CVS server interface is enabled for this repository. See[git-cvsserver[1]](%5350  "").

</dd><dt id='git-config-gitcvslogFile'>[](%2249#git-config-gitcvslogFile "")gitcvs.logFile</dt><dd>

Path to a log file where the CVS server interface well…​ logs various stuff. See[git-cvsserver[1]](%5350  "").

</dd><dt id='git-config-gitcvsusecrlfattr'>[](%2249#git-config-gitcvsusecrlfattr "")gitcvs.usecrlfattr</dt><dd>
...
</dd><dt id='git-config-gitcvsallBinary'>[](%2249#git-config-gitcvsallBinary "")gitcvs.allBinary</dt><dd>
...
</dd><dt id='git-config-gitcvsdbName'>[](%2249#git-config-gitcvsdbName "")gitcvs.dbName</dt><dd>
...
</dd><dt id='git-config-gitcvsdbDriver'>[](%2249#git-config-gitcvsdbDriver "")gitcvs.dbDriver</dt><dd>
...
</dd><dt id='git-config-gitcvsdbUsergitcvsdbPass'>[](%2249#git-config-gitcvsdbUsergitcvsdbPass "")gitcvs.dbUser, gitcvs.dbPass</dt><dd>
...
</dd><dt id='git-config-gitcvsdbTableNamePrefix'>[](%2249#git-config-gitcvsdbTableNamePrefix "")gitcvs.dbTableNamePrefix</dt><dd>
...
<dl><dt id='git-config-gitwebcategory'>[](%2249#git-config-gitwebcategory "")gitweb.category</dt><dt id='git-config-gitwebdescription'>[](%2249#git-config-gitwebdescription "")gitweb.description</dt><dt id='git-config-gitwebowner'>[](%2249#git-config-gitwebowner "")gitweb.owner</dt><dt id='git-config-gitweburl'>[](%2249#git-config-gitweburl "")gitweb.url</dt><dd>

See[gitweb[1]](%5339  "")for description.

</dd><dt id='git-config-gitwebavatar'>[](%2249#git-config-gitwebavatar "")gitweb.avatar</dt><dt id='git-config-gitwebblame'>[](%2249#git-config-gitwebblame "")gitweb.blame</dt><dt id='git-config-gitwebgrep'>[](%2249#git-config-gitwebgrep "")gitweb.grep</dt><dt id='git-config-gitwebhighlight'>[](%2249#git-config-gitwebhighlight "")gitweb.highlight</dt><dt id='git-config-gitwebpatches'>[](%2249#git-config-gitwebpatches "")gitweb.patches</dt><dt id='git-config-gitwebpickaxe'>[](%2249#git-config-gitwebpickaxe "")gitweb.pickaxe</dt><dt id='git-config-gitwebremoteheads'>[](%2249#git-config-gitwebremoteheads "")gitweb.remote_heads</dt><dt id='git-config-gitwebshowSizes'>[](%2249#git-config-gitwebshowSizes "")gitweb.showSizes</dt><dt id='git-config-gitwebsnapshot'>[](%2249#git-config-gitwebsnapshot "")gitweb.snapshot</dt><dd>

See[gitweb.conf[5]](%5963  "")for description.

</dd><dt id='git-config-greplineNumber'>[](%2249#git-config-greplineNumber "")grep.lineNumber</dt><dd>

If set to true, enable`-n`option by default.

</dd><dt id='git-config-greppatternType'>[](%2249#git-config-greppatternType "")grep.patternType</dt><dd>
...
</dd><dt id='git-config-grepextendedRegexp'>[](%2249#git-config-grepextendedRegexp "")grep.extendedRegexp</dt><dd>
...
</dd><dt id='git-config-grepthreads'>[](%2249#git-config-grepthreads "")grep.threads</dt><dd>

Number of grep worker threads to use. See`grep.threads`in[git-grep[1]](%2282  "")for more information.

</dd><dt id='git-config-grepfallbackToNoIndex'>[](%2249#git-config-grepfallbackToNoIndex "")grep.fallbackToNoIndex</dt><dd>

If set to true, fall back to git grep --no-index if git grep is executed outside of a git repository. Defaults to false.

</dd><dt id='git-config-gpgprogram'>[](%2249#git-config-gpgprogram "")gpg.program</dt><dd>

Use this custom program instead of &quot;`gpg`&quot; found on`$PATH`when making or verifying a PGP signature. The program must support the same command-line interface as GPG, namely, to verify a detached signature, &quot;`gpg --verify $file - <$signature`&quot; is run, and the program is expected to signal a good signature by exiting with code 0, and to generate an ASCII-armored detached signature, the standard input of &quot;`gpg -bsau $key`&quot; is fed with the contents to be signed, and the program is expected to send the result to its standard output.

</dd><dt id='git-config-guicommitMsgWidth'>[](%2249#git-config-guicommitMsgWidth "")gui.commitMsgWidth</dt><dd>

Defines how wide the commit message window is in the[git-gui[1]](%5275  ""). &quot;75&quot; is the default.

</dd><dt id='git-config-guidiffContext'>[](%2249#git-config-guidiffContext "")gui.diffContext</dt><dd>

Specifies how many context lines should be used in calls to diff made by the[git-gui[1]](%5275  ""). The default is &quot;5&quot;.

</dd><dt id='git-config-guidisplayUntracked'>[](%2249#git-config-guidisplayUntracked "")gui.displayUntracked</dt><dd>

Determines if[git-gui[1]](%5275  "")shows untracked files in the file list. The default is &quot;true&quot;.

</dd><dt id='git-config-guiencoding'>[](%2249#git-config-guiencoding "")gui.encoding</dt><dd>
...
</dd><dt id='git-config-guimatchTrackingBranch'>[](%2249#git-config-guimatchTrackingBranch "")gui.matchTrackingBranch</dt><dd>
...
</dd><dt id='git-config-guinewBranchTemplate'>[](%2249#git-config-guinewBranchTemplate "")gui.newBranchTemplate</dt><dd>

Is used as suggested name when creating new branches using the[git-gui[1]](%5275  "").

</dd><dt id='git-config-guipruneDuringFetch'>[](%2249#git-config-guipruneDuringFetch "")gui.pruneDuringFetch</dt><dd>

&quot;true&quot; if[git-gui[1]](%5275  "")should prune remote-tracking branches when performing a fetch. The default value is &quot;false&quot;.

</dd><dt id='git-config-guitrustmtime'>[](%2249#git-config-guitrustmtime "")gui.trustmtime</dt><dd>
...
</dd><dt id='git-config-guispellingDictionary'>[](%2249#git-config-guispellingDictionary "")gui.spellingDictionary</dt><dd>
...
</dd><dt id='git-config-guifastCopyBlame'>[](%2249#git-config-guifastCopyBlame "")gui.fastCopyBlame</dt><dd>
...
</dd><dt id='git-config-guicopyBlameThreshold'>[](%2249#git-config-guicopyBlameThreshold "")gui.copyBlameThreshold</dt><dd>
...
</dd><dt id='git-config-guiblamehistoryctx'>[](%2249#git-config-guiblamehistoryctx "")gui.blamehistoryctx</dt><dd>
...
</dd><dt id='git-config-guitoolltnamegtcmd'>[](%2249#git-config-guitoolltnamegtcmd "")guitool.&lt;name&gt;.cmd</dt><dd>
...
</dd><dt id='git-config-guitoolltnamegtneedsFile'>[](%2249#git-config-guitoolltnamegtneedsFile "")guitool.&lt;name&gt;.needsFile</dt><dd>

Run the tool only if a diff is selected in the GUI. It guarantees that<em>FILENAME</em>is not empty.

</dd><dt id='git-config-guitoolltnamegtnoConsole'>[](%2249#git-config-guitoolltnamegtnoConsole "")guitool.&lt;name&gt;.noConsole</dt><dd>

Run the command silently, without creating a window to display its output.

</dd><dt id='git-config-guitoolltnamegtnoRescan'>[](%2249#git-config-guitoolltnamegtnoRescan "")guitool.&lt;name&gt;.noRescan</dt><dd>

Don’t rescan the working directory for changes after the tool finishes execution.

</dd><dt id='git-config-guitoolltnamegtconfirm'>[](%2249#git-config-guitoolltnamegtconfirm "")guitool.&lt;name&gt;.confirm</dt><dd>

Show a confirmation dialog before actually running the tool.

</dd><dt id='git-config-guitoolltnamegtargPrompt'>[](%2249#git-config-guitoolltnamegtargPrompt "")guitool.&lt;name&gt;.argPrompt</dt><dd>
...
</dd><dt id='git-config-guitoolltnamegtrevPrompt'>[](%2249#git-config-guitoolltnamegtrevPrompt "")guitool.&lt;name&gt;.revPrompt</dt><dd>
...
</dd><dt id='git-config-guitoolltnamegtrevUnmerged'>[](%2249#git-config-guitoolltnamegtrevUnmerged "")guitool.&lt;name&gt;.revUnmerged</dt><dd>
...
</dd><dt id='git-config-guitoolltnamegttitle'>[](%2249#git-config-guitoolltnamegttitle "")guitool.&lt;name&gt;.title</dt><dd>

Specifies the title to use for the prompt dialog. The default is the tool name.

</dd><dt id='git-config-guitoolltnamegtprompt'>[](%2249#git-config-guitoolltnamegtprompt "")guitool.&lt;name&gt;.prompt</dt><dd>
...
</dd><dt id='git-config-helpbrowser'>[](%2249#git-config-helpbrowser "")help.browser</dt><dd>

Specify the browser that will be used to display help in the<em>web</em>format. See[git-help[1]](%2250  "").

</dd><dt id='git-config-helpformat'>[](%2249#git-config-helpformat "")help.format</dt><dd>
...
</dd><dt id='git-config-helpautoCorrect'>[](%2249#git-config-helpautoCorrect "")help.autoCorrect</dt><dd>
...
</dd><dt id='git-config-helphtmlPath'>[](%2249#git-config-helphtmlPath "")help.htmlPath</dt><dd>
...
</dd><dt id='git-config-httpproxy'>[](%2249#git-config-httpproxy "")http.proxy</dt><dd>
...
</dd><dt id='git-config-httpproxyAuthMethod'>[](%2249#git-config-httpproxyAuthMethod "")http.proxyAuthMethod</dt><dd>
...
</dd><dt id='git-config-httpemptyAuth'>[](%2249#git-config-httpemptyAuth "")http.emptyAuth</dt><dd>
...
</dd><dt id='git-config-httpdelegation'>[](%2249#git-config-httpdelegation "")http.delegation</dt><dd>
...
</dd><dt id='git-config-httpextraHeader'>[](%2249#git-config-httpextraHeader "")http.extraHeader</dt><dd>
...
</dd><dt id='git-config-httpcookieFile'>[](%2249#git-config-httpcookieFile "")http.cookieFile</dt><dd>
...
</dd><dt id='git-config-httpsaveCookies'>[](%2249#git-config-httpsaveCookies "")http.saveCookies</dt><dd>
...
</dd><dt id='git-config-httpsslVersion'>[](%2249#git-config-httpsslVersion "")http.sslVersion</dt><dd>
...
</dd><dt id='git-config-httpsslCipherList'>[](%2249#git-config-httpsslCipherList "")http.sslCipherList</dt><dd>
...
</dd><dt id='git-config-httpsslVerify'>[](%2249#git-config-httpsslVerify "")http.sslVerify</dt><dd>
...
</dd><dt id='git-config-httpsslCert'>[](%2249#git-config-httpsslCert "")http.sslCert</dt><dd>
...
</dd><dt id='git-config-httpsslKey'>[](%2249#git-config-httpsslKey "")http.sslKey</dt><dd>
...
</dd><dt id='git-config-httpsslCertPasswordProtected'>[](%2249#git-config-httpsslCertPasswordProtected "")http.sslCertPasswordProtected</dt><dd>
...
</dd><dt id='git-config-httpsslCAInfo'>[](%2249#git-config-httpsslCAInfo "")http.sslCAInfo</dt><dd>
...
</dd><dt id='git-config-httpsslCAPath'>[](%2249#git-config-httpsslCAPath "")http.sslCAPath</dt><dd>
...
</dd><dt id='git-config-httppinnedpubkey'>[](%2249#git-config-httppinnedpubkey "")http.pinnedpubkey</dt><dd>
...
</dd><dt id='git-config-httpsslTry'>[](%2249#git-config-httpsslTry "")http.sslTry</dt><dd>
...
</dd><dt id='git-config-httpmaxRequests'>[](%2249#git-config-httpmaxRequests "")http.maxRequests</dt><dd>
...
</dd><dt id='git-config-httpminSessions'>[](%2249#git-config-httpminSessions "")http.minSessions</dt><dd>
...
</dd><dt id='git-config-httppostBuffer'>[](%2249#git-config-httppostBuffer "")http.postBuffer</dt><dd>

Maximum size in bytes of the buffer used by smart HTTP transports when POSTing data to the remote system. For requests larger than this buffer size, HTTP/1.1 and Transfer-Encoding: chunked is used to avoid creating a massive pack file locally. Default is 1 MiB, which is sufficient for most requests.

</dd><dt id='git-config-httplowSpeedLimithttplowSpeedTime'>[](%2249#git-config-httplowSpeedLimithttplowSpeedTime "")http.lowSpeedLimit, http.lowSpeedTime</dt><dd>
...
</dd><dt id='git-config-httpnoEPSV'>[](%2249#git-config-httpnoEPSV "")http.noEPSV</dt><dd>
...
</dd><dt id='git-config-httpuserAgent'>[](%2249#git-config-httpuserAgent "")http.userAgent</dt><dd>
...
</dd><dt id='git-config-httpfollowRedirects'>[](%2249#git-config-httpfollowRedirects "")http.followRedirects</dt><dd>
...
</dd><dt id='git-config-httplturlgt'>[](%2249#git-config-httplturlgt "")http.&lt;url&gt;.*</dt><dd>
...
</dd><dt id='git-config-sshvariant'>[](%2249#git-config-sshvariant "")ssh.variant</dt><dd>
...
</dd><dt id='git-config-i18ncommitEncoding'>[](%2249#git-config-i18ncommitEncoding "")i18n.commitEncoding</dt><dd>
...
</dd><dt id='git-config-interactivediffFilter'>[](%2249#git-config-interactivediffFilter "")interactive.diffFilter</dt><dd>
...
</dd><dt id='git-config-logabbrevCommit'>[](%2249#git-config-logabbrevCommit "")log.abbrevCommit</dt><dd>
...
</dd><dt id='git-config-logdate'>[](%2249#git-config-logdate "")log.date</dt><dd>
...
</dd><dt id='git-config-logdecorate'>[](%2249#git-config-logdecorate "")log.decorate</dt><dd>
...
</dd><dt id='git-config-logfollow'>[](%2249#git-config-logfollow "")log.follow</dt><dd>
...
</dd><dt id='git-config-loggraphColors'>[](%2249#git-config-loggraphColors "")log.graphColors</dt><dd>

A list of colors, separated by commas, that can be used to draw history lines in`git log --graph`.

</dd><dt id='git-config-logshowRoot'>[](%2249#git-config-logshowRoot "")log.showRoot</dt><dd>
...
</dd><dt id='git-config-logshowSignature'>[](%2249#git-config-logshowSignature "")log.showSignature</dt><dd>

If true, makes[git-log[1]](%2264  ""),[git-show[1]](%2273  ""), and[git-whatchanged[1]](%5341  "")assume`--show-signature`.

</dd><dt id='git-config-logmailmap'>[](%2249#git-config-logmailmap "")log.mailmap</dt><dd>

If true, makes[git-log[1]](%2264  ""),[git-show[1]](%2273  ""), and[git-whatchanged[1]](%5341  "")assume`--use-mailmap`.

</dd><dt id='git-config-mailinfoscissors'>[](%2249#git-config-mailinfoscissors "")mailinfo.scissors</dt><dd>
...
</dd><dt id='git-config-mailmapfile'>[](%2249#git-config-mailmapfile "")mailmap.file</dt><dd>
...
</dd><dt id='git-config-mailmapblob'>[](%2249#git-config-mailmapblob "")mailmap.blob</dt><dd>
...
</dd><dt id='git-config-manviewer'>[](%2249#git-config-manviewer "")man.viewer</dt><dd>

Specify the programs that may be used to display help in the<em>man</em>format. See[git-help[1]](%2250  "").

</dd><dt id='git-config-manlttoolgtcmd'>[](%2249#git-config-manlttoolgtcmd "")man.&lt;tool&gt;.cmd</dt><dd>
...
</dd><dt id='git-config-manlttoolgtpath'>[](%2249#git-config-manlttoolgtpath "")man.&lt;tool&gt;.path</dt><dd>

Override the path for the given tool that may be used to display help in the<em>man</em>format. See[git-help[1]](%2250  "").

</dd><dt id='git-config-mergeconflictStyle'>[](%2249#git-config-mergeconflictStyle "")merge.conflictStyle</dt><dd>

Specify the style in which conflicted hunks are written out to working tree files upon merge. The default is &quot;merge&quot;, which shows a`<<<<<<<`conflict marker, changes made by one side, a`=======`marker, changes made by the other side, and then a`>>>>>>>`marker. An alternate style, &quot;diff3&quot;, adds a`|||||||`marker and the original text before the`=======`marker.

</dd><dt id='git-config-mergedefaultToUpstream'>[](%2249#git-config-mergedefaultToUpstream "")merge.defaultToUpstream</dt><dd>

If merge is called without any commit argument, merge the upstream branches configured for the current branch by using their last observed values stored in their remote-tracking branches. The values of the`branch.<current branch>.merge`that name the branches at the remote named by`branch.<current branch>.remote`are consulted, and then they are mapped via`remote.<remote>.fetch`to their corresponding remote-tracking branches, and the tips of these tracking branches are merged.

</dd><dt id='git-config-mergeff'>[](%2249#git-config-mergeff "")merge.ff</dt><dd>

By default, Git does not create an extra merge commit when merging a commit that is a descendant of the current commit. Instead, the tip of the current branch is fast-forwarded. When set to`false`, this variable tells Git to create an extra merge commit in such a case (equivalent to giving the`--no-ff`option from the command line). When set to`only`, only such fast-forward merges are allowed (equivalent to giving the`--ff-only`option from the command line).

</dd><dt id='git-config-mergeverifySignatures'>[](%2249#git-config-mergeverifySignatures "")merge.verifySignatures</dt><dd>

If true, this is equivalent to the --verify-signatures command line option. See[git-merge[1]](%2262  "")for details.

</dd><dt id='git-config-mergebranchdesc'>[](%2249#git-config-mergebranchdesc "")merge.branchdesc</dt><dd>

In addition to branch names, populate the log message with the branch description text associated with them. Defaults to false.

</dd><dt id='git-config-mergelog'>[](%2249#git-config-mergelog "")merge.log</dt><dd>

In addition to branch names, populate the log message with at most the specified number of one-line descriptions from the actual commits that are being merged. Defaults to false, and true is a synonym for 20.

</dd></dl>
<dl><dt id='git-config-mergerenameLimit'>[](%2249#git-config-mergerenameLimit "")merge.renameLimit</dt><dd>
...
</dd><dt id='git-config-mergerenames'>[](%2249#git-config-mergerenames "")merge.renames</dt><dd>
...
</dd><dt id='git-config-mergerenormalize'>[](%2249#git-config-mergerenormalize "")merge.renormalize</dt><dd>
...
</dd><dt id='git-config-mergestat'>[](%2249#git-config-mergestat "")merge.stat</dt><dd>

Whether to print the diffstat between ORIG_HEAD and the merge result at the end of the merge. True by default.

</dd><dt id='git-config-mergetool'>[](%2249#git-config-mergetool "")merge.tool</dt><dd>
...
<dl><dt id='git-config-mergeverbosity'>[](%2249#git-config-mergeverbosity "")merge.verbosity</dt><dd>

Controls the amount of output shown by the recursive merge strategy. Level 0 outputs nothing except a final error message if conflicts were detected. Level 1 outputs only conflicts, 2 outputs conflicts and file changes. Level 5 and above outputs debugging information. The default is level 2. Can be overridden by the`GIT_MERGE_VERBOSITY`environment variable.

</dd><dt id='git-config-mergeltdrivergtname'>[](%2249#git-config-mergeltdrivergtname "")merge.&lt;driver&gt;.name</dt><dd>

Defines a human-readable name for a custom low-level merge driver. See[gitattributes[5]](%2283  "")for details.

</dd><dt id='git-config-mergeltdrivergtdriver'>[](%2249#git-config-mergeltdrivergtdriver "")merge.&lt;driver&gt;.driver</dt><dd>

Defines the command that implements a custom low-level merge driver. See[gitattributes[5]](%2283  "")for details.

</dd><dt id='git-config-mergeltdrivergtrecursive'>[](%2249#git-config-mergeltdrivergtrecursive "")merge.&lt;driver&gt;.recursive</dt><dd>
...
<dl><dt id='git-config-mergetoollttoolgtpath'>[](%2249#git-config-mergetoollttoolgtpath "")mergetool.&lt;tool&gt;.path</dt><dd>

Override the path for the given tool. This is useful in case your tool is not in the PATH.

</dd><dt id='git-config-mergetoollttoolgtcmd'>[](%2249#git-config-mergetoollttoolgtcmd "")mergetool.&lt;tool&gt;.cmd</dt><dd>
...
</dd><dt id='git-config-mergetoollttoolgttrustExitCode'>[](%2249#git-config-mergetoollttoolgttrustExitCode "")mergetool.&lt;tool&gt;.trustExitCode</dt><dd>

For a custom merge command, specify whether the exit code of the merge command can be used to determine whether the merge was successful. If this is not set to true then the merge target file timestamp is checked and the merge assumed to have been successful if the file has been updated, otherwise the user is prompted to indicate the success of the merge.

</dd><dt id='git-config-mergetoolmeldhasOutput'>[](%2249#git-config-mergetoolmeldhasOutput "")mergetool.meld.hasOutput</dt><dd>
...
</dd><dt id='git-config-mergetoolkeepBackup'>[](%2249#git-config-mergetoolkeepBackup "")mergetool.keepBackup</dt><dd>
...
</dd><dt id='git-config-mergetoolkeepTemporaries'>[](%2249#git-config-mergetoolkeepTemporaries "")mergetool.keepTemporaries</dt><dd>
...
</dd><dt id='git-config-mergetoolwriteToTemp'>[](%2249#git-config-mergetoolwriteToTemp "")mergetool.writeToTemp</dt><dd>
...
</dd><dt id='git-config-mergetoolprompt'>[](%2249#git-config-mergetoolprompt "")mergetool.prompt</dt><dd>

Prompt before each invocation of the merge resolution program.

</dd><dt id='git-config-notesmergeStrategy'>[](%2249#git-config-notesmergeStrategy "")notes.mergeStrategy</dt><dd>
...
</dd><dt id='git-config-notesltnamegtmergeStrategy'>[](%2249#git-config-notesltnamegtmergeStrategy "")notes.&lt;name&gt;.mergeStrategy</dt><dd>
...
</dd><dt id='git-config-notesdisplayRef'>[](%2249#git-config-notesdisplayRef "")notes.displayRef</dt><dd>
...
</dd><dt id='git-config-notesrewriteltcommandgt'>[](%2249#git-config-notesrewriteltcommandgt "")notes.rewrite.&lt;command&gt;</dt><dd>
...
</dd><dt id='git-config-notesrewriteMode'>[](%2249#git-config-notesrewriteMode "")notes.rewriteMode</dt><dd>
...
</dd><dt id='git-config-notesrewriteRef'>[](%2249#git-config-notesrewriteRef "")notes.rewriteRef</dt><dd>
...
</dd><dt id='git-config-packwindow'>[](%2249#git-config-packwindow "")pack.window</dt><dd>

The size of the window used by[git-pack-objects[1]](%5380  "")when no window size is given on the command line. Defaults to 10.

</dd><dt id='git-config-packdepth'>[](%2249#git-config-packdepth "")pack.depth</dt><dd>
...
</dd><dt id='git-config-packwindowMemory'>[](%2249#git-config-packwindowMemory "")pack.windowMemory</dt><dd>
...
</dd><dt id='git-config-packcompression'>[](%2249#git-config-packcompression "")pack.compression</dt><dd>
...
</dd><dt id='git-config-packdeltaCacheSize'>[](%2249#git-config-packdeltaCacheSize "")pack.deltaCacheSize</dt><dd>
...
</dd><dt id='git-config-packdeltaCacheLimit'>[](%2249#git-config-packdeltaCacheLimit "")pack.deltaCacheLimit</dt><dd>
...
</dd><dt id='git-config-packthreads'>[](%2249#git-config-packthreads "")pack.threads</dt><dd>
...
</dd><dt id='git-config-packindexVersion'>[](%2249#git-config-packindexVersion "")pack.indexVersion</dt><dd>
...
</dd><dt id='git-config-packpackSizeLimit'>[](%2249#git-config-packpackSizeLimit "")pack.packSizeLimit</dt><dd>
...
</dd><dt id='git-config-packuseBitmaps'>[](%2249#git-config-packuseBitmaps "")pack.useBitmaps</dt><dd>
...
</dd><dt id='git-config-packwriteBitmapsdeprecated'>[](%2249#git-config-packwriteBitmapsdeprecated "")pack.writeBitmaps (deprecated)</dt><dd>

This is a deprecated synonym for`repack.writeBitmaps`.

</dd><dt id='git-config-packwriteBitmapHashCache'>[](%2249#git-config-packwriteBitmapHashCache "")pack.writeBitmapHashCache</dt><dd>
...
</dd><dt id='git-config-pagerltcmdgt'>[](%2249#git-config-pagerltcmdgt "")pager.&lt;cmd&gt;</dt><dd>
...
</dd><dt id='git-config-prettyltnamegt'>[](%2249#git-config-prettyltnamegt "")pretty.&lt;name&gt;</dt><dd>
...
</dd><dt id='git-config-protocolallow'>[](%2249#git-config-protocolallow "")protocol.allow</dt><dd>
...
</dd><dt id='git-config-protocolltnamegtallow'>[](%2249#git-config-protocolltnamegtallow "")protocol.&lt;name&gt;.allow</dt><dd>
...
</dd><dt id='git-config-protocolversion'>[](%2249#git-config-protocolversion "")protocol.version</dt><dd>
...
</dd><dt id='git-config-pullff'>[](%2249#git-config-pullff "")pull.ff</dt><dd>
...
</dd><dt id='git-config-pullrebase'>[](%2249#git-config-pullrebase "")pull.rebase</dt><dd>
...
</dd><dt id='git-config-pulloctopus'>[](%2249#git-config-pulloctopus "")pull.octopus</dt><dd>

The default merge strategy to use when pulling multiple branches at once.

</dd><dt id='git-config-pulltwohead'>[](%2249#git-config-pulltwohead "")pull.twohead</dt><dd>

The default merge strategy to use when pulling a single branch.

</dd><dt id='git-config-pushdefault'>[](%2249#git-config-pushdefault "")push.default</dt><dd>
...
</dd><dt id='git-config-pushfollowTags'>[](%2249#git-config-pushfollowTags "")push.followTags</dt><dd>
...
</dd><dt id='git-config-pushgpgSign'>[](%2249#git-config-pushgpgSign "")push.gpgSign</dt><dd>
...
</dd><dt id='git-config-pushpushOption'>[](%2249#git-config-pushpushOption "")push.pushOption</dt><dd>
...
</dd><dt id='git-config-pushrecurseSubmodules'>[](%2249#git-config-pushrecurseSubmodules "")push.recurseSubmodules</dt><dd>
...
</dd><dt id='git-config-rebasestat'>[](%2249#git-config-rebasestat "")rebase.stat</dt><dd>

Whether to show a diffstat of what changed upstream since the last rebase. False by default.

</dd><dt id='git-config-rebaseautoSquash'>[](%2249#git-config-rebaseautoSquash "")rebase.autoSquash</dt><dd>

If set to true enable`--autosquash`option by default.

</dd><dt id='git-config-rebaseautoStash'>[](%2249#git-config-rebaseautoStash "")rebase.autoStash</dt><dd>

When set to true, automatically create a temporary stash entry before the operation begins, and apply it after the operation ends. This means that you can run rebase on a dirty worktree. However, use with care: the final stash application after a successful rebase might result in non-trivial conflicts. This option can be overridden by the`--no-autostash`and`--autostash`options of[git-rebase[1]](%2278  ""). Defaults to false.

</dd><dt id='git-config-rebasemissingCommitsCheck'>[](%2249#git-config-rebasemissingCommitsCheck "")rebase.missingCommitsCheck</dt><dd>
...
</dd><dt id='git-config-rebaseinstructionFormat'>[](%2249#git-config-rebaseinstructionFormat "")rebase.instructionFormat</dt><dd>
...
</dd><dt id='git-config-rebaseabbreviateCommands'>[](%2249#git-config-rebaseabbreviateCommands "")rebase.abbreviateCommands</dt><dd>
...
<dl><dt id='git-config-receiveadvertiseAtomic'>[](%2249#git-config-receiveadvertiseAtomic "")receive.advertiseAtomic</dt><dd>
...
</dd><dt id='git-config-receiveadvertisePushOptions'>[](%2249#git-config-receiveadvertisePushOptions "")receive.advertisePushOptions</dt><dd>

When set to true, git-receive-pack will advertise the push options capability to its clients. False by default.

</dd><dt id='git-config-receiveautogc'>[](%2249#git-config-receiveautogc "")receive.autogc</dt><dd>
...
</dd><dt id='git-config-receivecertNonceSeed'>[](%2249#git-config-receivecertNonceSeed "")receive.certNonceSeed</dt><dd>
...
</dd><dt id='git-config-receivecertNonceSlop'>[](%2249#git-config-receivecertNonceSlop "")receive.certNonceSlop</dt><dd>
...
</dd><dt id='git-config-receivefsckObjects'>[](%2249#git-config-receivefsckObjects "")receive.fsckObjects</dt><dd>
...
</dd><dt id='git-config-receivefsckltmsg-idgt'>[](%2249#git-config-receivefsckltmsg-idgt "")receive.fsck.&lt;msg-id&gt;</dt><dd>
...
</dd><dt id='git-config-receivefsckskipList'>[](%2249#git-config-receivefsckskipList "")receive.fsck.skipList</dt><dd>

The path to a sorted list of object names (i.e. one SHA-1 per line) that are known to be broken in a non-fatal way and should be ignored. This feature is useful when an established project should be accepted despite early commits containing errors that can be safely ignored such as invalid committer email addresses. Note: corrupt objects cannot be skipped with this setting.

</dd><dt id='git-config-receivekeepAlive'>[](%2249#git-config-receivekeepAlive "")receive.keepAlive</dt><dd>
...
</dd><dt id='git-config-receiveunpackLimit'>[](%2249#git-config-receiveunpackLimit "")receive.unpackLimit</dt><dd>

If the number of objects received in a push is below this limit then the objects will be unpacked into loose object files. However if the number of received objects equals or exceeds this limit then the received pack will be stored as a pack, after adding any missing delta bases. Storing the pack from a push can make the push operation complete faster, especially on slow filesystems. If not set, the value of`transfer.unpackLimit`is used instead.

</dd><dt id='git-config-receivemaxInputSize'>[](%2249#git-config-receivemaxInputSize "")receive.maxInputSize</dt><dd>
...
</dd><dt id='git-config-receivedenyDeletes'>[](%2249#git-config-receivedenyDeletes "")receive.denyDeletes</dt><dd>
...
</dd><dt id='git-config-receivedenyDeleteCurrent'>[](%2249#git-config-receivedenyDeleteCurrent "")receive.denyDeleteCurrent</dt><dd>
...
</dd><dt id='git-config-receivedenyCurrentBranch'>[](%2249#git-config-receivedenyCurrentBranch "")receive.denyCurrentBranch</dt><dd>
...
</dd><dt id='git-config-receivedenyNonFastForwards'>[](%2249#git-config-receivedenyNonFastForwards "")receive.denyNonFastForwards</dt><dd>

If set to true, git-receive-pack will deny a ref update which is not a fast-forward. Use this to prevent such an update via a push, even if that push is forced. This configuration variable is set when initializing a shared repository.

</dd><dt id='git-config-receivehideRefs'>[](%2249#git-config-receivehideRefs "")receive.hideRefs</dt><dd>
...
</dd><dt id='git-config-receiveupdateServerInfo'>[](%2249#git-config-receiveupdateServerInfo "")receive.updateServerInfo</dt><dd>

If set to true, git-receive-pack will run git-update-server-info after receiving data from git-push and updating refs.

</dd><dt id='git-config-receiveshallowUpdate'>[](%2249#git-config-receiveshallowUpdate "")receive.shallowUpdate</dt><dd>

If set to true, .git/shallow can be updated when new refs require new shallow roots. Otherwise those refs are rejected.

</dd><dt id='git-config-remotepushDefault'>[](%2249#git-config-remotepushDefault "")remote.pushDefault</dt><dd>
...
</dd><dt id='git-config-remoteltnamegturl'>[](%2249#git-config-remoteltnamegturl "")remote.&lt;name&gt;.url</dt><dd>

The URL of a remote repository. See[git-fetch[1]](%2268  "")or[git-push[1]](%2270  "").

</dd><dt id='git-config-remoteltnamegtpushurl'>[](%2249#git-config-remoteltnamegtpushurl "")remote.&lt;name&gt;.pushurl</dt><dd>

The push URL of a remote repository. See[git-push[1]](%2270  "").

</dd><dt id='git-config-remoteltnamegtproxy'>[](%2249#git-config-remoteltnamegtproxy "")remote.&lt;name&gt;.proxy</dt><dd>
...
</dd><dt id='git-config-remoteltnamegtproxyAuthMethod'>[](%2249#git-config-remoteltnamegtproxyAuthMethod "")remote.&lt;name&gt;.proxyAuthMethod</dt><dd>
...
</dd><dt id='git-config-remoteltnamegtfetch'>[](%2249#git-config-remoteltnamegtfetch "")remote.&lt;name&gt;.fetch</dt><dd>

The default set of &quot;refspec&quot; for[git-fetch[1]](%2268  ""). See[git-fetch[1]](%2268  "").

</dd><dt id='git-config-remoteltnamegtpush'>[](%2249#git-config-remoteltnamegtpush "")remote.&lt;name&gt;.push</dt><dd>

The default set of &quot;refspec&quot; for[git-push[1]](%2270  ""). See[git-push[1]](%2270  "").

</dd><dt id='git-config-remoteltnamegtmirror'>[](%2249#git-config-remoteltnamegtmirror "")remote.&lt;name&gt;.mirror</dt><dd>

If true, pushing to this remote will automatically behave as if the`--mirror`option was given on the command line.

</dd><dt id='git-config-remoteltnamegtskipDefaultUpdate'>[](%2249#git-config-remoteltnamegtskipDefaultUpdate "")remote.&lt;name&gt;.skipDefaultUpdate</dt><dd>
...
</dd><dt id='git-config-remoteltnamegtskipFetchAll'>[](%2249#git-config-remoteltnamegtskipFetchAll "")remote.&lt;name&gt;.skipFetchAll</dt><dd>

If true, this remote will be skipped by default when updating using[git-fetch[1]](%2268  "")or the`update`subcommand of[git-remote[1]](%2271  "").

</dd><dt id='git-config-remoteltnamegtreceivepack'>[](%2249#git-config-remoteltnamegtreceivepack "")remote.&lt;name&gt;.receivepack</dt><dd>

The default program to execute on the remote side when pushing. See option --receive-pack of[git-push[1]](%2270  "").

</dd><dt id='git-config-remoteltnamegtuploadpack'>[](%2249#git-config-remoteltnamegtuploadpack "")remote.&lt;name&gt;.uploadpack</dt><dd>

The default program to execute on the remote side when fetching. See option --upload-pack of[git-fetch-pack[1]](%5421  "").

</dd><dt id='git-config-remoteltnamegttagOpt'>[](%2249#git-config-remoteltnamegttagOpt "")remote.&lt;name&gt;.tagOpt</dt><dd>
...
</dd><dt id='git-config-remoteltnamegtvcs'>[](%2249#git-config-remoteltnamegtvcs "")remote.&lt;name&gt;.vcs</dt><dd>

Setting this to a value &lt;vcs&gt; will cause Git to interact with the remote with the git-remote-&lt;vcs&gt; helper.

</dd><dt id='git-config-remoteltnamegtprune'>[](%2249#git-config-remoteltnamegtprune "")remote.&lt;name&gt;.prune</dt><dd>
...
</dd><dt id='git-config-remoteltnamegtpruneTags'>[](%2249#git-config-remoteltnamegtpruneTags "")remote.&lt;name&gt;.pruneTags</dt><dd>
...
</dd><dt id='git-config-remotesltgroupgt'>[](%2249#git-config-remotesltgroupgt "")remotes.&lt;group&gt;</dt><dd>

The list of remotes which are fetched by &quot;git remote update &lt;group&gt;&quot;. See[git-remote[1]](%2271  "").

</dd><dt id='git-config-repackuseDeltaBaseOffset'>[](%2249#git-config-repackuseDeltaBaseOffset "")repack.useDeltaBaseOffset</dt><dd>
...
</dd><dt id='git-config-repackpackKeptObjects'>[](%2249#git-config-repackpackKeptObjects "")repack.packKeptObjects</dt><dd>
...
</dd><dt id='git-config-repackwriteBitmaps'>[](%2249#git-config-repackwriteBitmaps "")repack.writeBitmaps</dt><dd>
...
</dd><dt id='git-config-rerereautoUpdate'>[](%2249#git-config-rerereautoUpdate "")rerere.autoUpdate</dt><dd>
...
</dd><dt id='git-config-rerereenabled'>[](%2249#git-config-rerereenabled "")rerere.enabled</dt><dd>
...
</dd><dt id='git-config-sendemailidentity'>[](%2249#git-config-sendemailidentity "")sendemail.identity</dt><dd>
...
</dd><dt id='git-config-sendemailsmtpEncryption'>[](%2249#git-config-sendemailsmtpEncryption "")sendemail.smtpEncryption</dt><dd>

See[git-send-email[1]](%2293  "")for description. Note that this setting is not subject to the<em>identity</em>mechanism.

</dd><dt id='git-config-sendemailsmtpssldeprecated'>[](%2249#git-config-sendemailsmtpssldeprecated "")sendemail.smtpssl (deprecated)</dt><dd>

Deprecated alias for<em>sendemail.smtpEncryption = ssl</em>.

</dd><dt id='git-config-sendemailsmtpsslcertpath'>[](%2249#git-config-sendemailsmtpsslcertpath "")sendemail.smtpsslcertpath</dt><dd>
...
</dd><dt id='git-config-sendemailltidentitygt'>[](%2249#git-config-sendemailltidentitygt "")sendemail.&lt;identity&gt;.*</dt><dd>
...
</dd><dt id='git-config-sendemailaliasesFile'>[](%2249#git-config-sendemailaliasesFile "")sendemail.aliasesFile</dt><dt id='git-config-sendemailaliasFileType'>[](%2249#git-config-sendemailaliasFileType "")sendemail.aliasFileType</dt><dt id='git-config-sendemailannotate'>[](%2249#git-config-sendemailannotate "")sendemail.annotate</dt><dt id='git-config-sendemailbcc'>[](%2249#git-config-sendemailbcc "")sendemail.bcc</dt><dt id='git-config-sendemailcc'>[](%2249#git-config-sendemailcc "")sendemail.cc</dt><dt id='git-config-sendemailccCmd'>[](%2249#git-config-sendemailccCmd "")sendemail.ccCmd</dt><dt id='git-config-sendemailchainReplyTo'>[](%2249#git-config-sendemailchainReplyTo "")sendemail.chainReplyTo</dt><dt id='git-config-sendemailconfirm'>[](%2249#git-config-sendemailconfirm "")sendemail.confirm</dt><dt id='git-config-sendemailenvelopeSender'>[](%2249#git-config-sendemailenvelopeSender "")sendemail.envelopeSender</dt><dt id='git-config-sendemailfrom'>[](%2249#git-config-sendemailfrom "")sendemail.from</dt><dt id='git-config-sendemailmultiEdit'>[](%2249#git-config-sendemailmultiEdit "")sendemail.multiEdit</dt><dt id='git-config-sendemailsignedoffbycc'>[](%2249#git-config-sendemailsignedoffbycc "")sendemail.signedoffbycc</dt><dt id='git-config-sendemailsmtpPass'>[](%2249#git-config-sendemailsmtpPass "")sendemail.smtpPass</dt><dt id='git-config-sendemailsuppresscc'>[](%2249#git-config-sendemailsuppresscc "")sendemail.suppresscc</dt><dt id='git-config-sendemailsuppressFrom'>[](%2249#git-config-sendemailsuppressFrom "")sendemail.suppressFrom</dt><dt id='git-config-sendemailto'>[](%2249#git-config-sendemailto "")sendemail.to</dt><dt id='git-config-sendemailtocmd'>[](%2249#git-config-sendemailtocmd "")sendemail.tocmd</dt><dt id='git-config-sendemailsmtpDomain'>[](%2249#git-config-sendemailsmtpDomain "")sendemail.smtpDomain</dt><dt id='git-config-sendemailsmtpServer'>[](%2249#git-config-sendemailsmtpServer "")sendemail.smtpServer</dt><dt id='git-config-sendemailsmtpServerPort'>[](%2249#git-config-sendemailsmtpServerPort "")sendemail.smtpServerPort</dt><dt id='git-config-sendemailsmtpServerOption'>[](%2249#git-config-sendemailsmtpServerOption "")sendemail.smtpServerOption</dt><dt id='git-config-sendemailsmtpUser'>[](%2249#git-config-sendemailsmtpUser "")sendemail.smtpUser</dt><dt id='git-config-sendemailthread'>[](%2249#git-config-sendemailthread "")sendemail.thread</dt><dt id='git-config-sendemailtransferEncoding'>[](%2249#git-config-sendemailtransferEncoding "")sendemail.transferEncoding</dt><dt id='git-config-sendemailvalidate'>[](%2249#git-config-sendemailvalidate "")sendemail.validate</dt><dt id='git-config-sendemailxmailer'>[](%2249#git-config-sendemailxmailer "")sendemail.xmailer</dt><dd>

See[git-send-email[1]](%2293  "")for description.

</dd><dt id='git-config-sendemailsignedoffccdeprecated'>[](%2249#git-config-sendemailsignedoffccdeprecated "")sendemail.signedoffcc (deprecated)</dt><dd>

Deprecated alias for`sendemail.signedoffbycc`.

</dd><dt id='git-config-sendemailsmtpBatchSize'>[](%2249#git-config-sendemailsmtpBatchSize "")sendemail.smtpBatchSize</dt><dd>
...
</dd><dt id='git-config-sendemailsmtpReloginDelay'>[](%2249#git-config-sendemailsmtpReloginDelay "")sendemail.smtpReloginDelay</dt><dd>

Seconds wait before reconnecting to smtp server. See also the`--relogin-delay`option of[git-send-email[1]](%2293  "").

</dd><dt id='git-config-showbranchdefault'>[](%2249#git-config-showbranchdefault "")showbranch.default</dt><dd>

The default set of branches for[git-show-branch[1]](%5333  ""). See[git-show-branch[1]](%5333  "").

</dd><dt id='git-config-splitIndexmaxPercentChange'>[](%2249#git-config-splitIndexmaxPercentChange "")splitIndex.maxPercentChange</dt><dd>
...
</dd><dt id='git-config-splitIndexsharedIndexExpire'>[](%2249#git-config-splitIndexsharedIndexExpire "")splitIndex.sharedIndexExpire</dt><dd>
...
</dd><dt id='git-config-statusrelativePaths'>[](%2249#git-config-statusrelativePaths "")status.relativePaths</dt><dd>
...
</dd><dt id='git-config-statusshort'>[](%2249#git-config-statusshort "")status.short</dt><dd>

Set to true to enable --short by default in[git-status[1]](%2254  ""). The option --no-short takes precedence over this variable.

</dd><dt id='git-config-statusbranch'>[](%2249#git-config-statusbranch "")status.branch</dt><dd>

Set to true to enable --branch by default in[git-status[1]](%2254  ""). The option --no-branch takes precedence over this variable.

</dd><dt id='git-config-statusdisplayCommentPrefix'>[](%2249#git-config-statusdisplayCommentPrefix "")status.displayCommentPrefix</dt><dd>
...
</dd><dt id='git-config-statusrenameLimit'>[](%2249#git-config-statusrenameLimit "")status.renameLimit</dt><dd>
...
</dd><dt id='git-config-statusrenames'>[](%2249#git-config-statusrenames "")status.renames</dt><dd>
...
</dd><dt id='git-config-statusshowStash'>[](%2249#git-config-statusshowStash "")status.showStash</dt><dd>

If set to true,[git-status[1]](%2254  "")will display the number of entries currently stashed away. Defaults to false.

</dd><dt id='git-config-statusshowUntrackedFiles'>[](%2249#git-config-statusshowUntrackedFiles "")status.showUntrackedFiles</dt><dd>
...
</dd><dt id='git-config-statussubmoduleSummary'>[](%2249#git-config-statussubmoduleSummary "")status.submoduleSummary</dt><dd>
...
</dd><dt id='git-config-stashshowPatch'>[](%2249#git-config-stashshowPatch "")stash.showPatch</dt><dd>
...
</dd><dt id='git-config-stashshowStat'>[](%2249#git-config-stashshowStat "")stash.showStat</dt><dd>
...
</dd><dt id='git-config-submoduleltnamegturl'>[](%2249#git-config-submoduleltnamegturl "")submodule.&lt;name&gt;.url</dt><dd>
...
</dd><dt id='git-config-submoduleltnamegtupdate'>[](%2249#git-config-submoduleltnamegtupdate "")submodule.&lt;name&gt;.update</dt><dd>
...
</dd><dt id='git-config-submoduleltnamegtbranch'>[](%2249#git-config-submoduleltnamegtbranch "")submodule.&lt;name&gt;.branch</dt><dd>
...
</dd><dt id='git-config-submoduleltnamegtfetchRecurseSubmodules'>[](%2249#git-config-submoduleltnamegtfetchRecurseSubmodules "")submodule.&lt;name&gt;.fetchRecurseSubmodules</dt><dd>
...
</dd><dt id='git-config-submoduleltnamegtignore'>[](%2249#git-config-submoduleltnamegtignore "")submodule.&lt;name&gt;.ignore</dt><dd>
...
</dd><dt id='git-config-submoduleltnamegtactive'>[](%2249#git-config-submoduleltnamegtactive "")submodule.&lt;name&gt;.active</dt><dd>
...
</dd><dt id='git-config-submoduleactive'>[](%2249#git-config-submoduleactive "")submodule.active</dt><dd>
...
</dd><dt id='git-config-submodulerecurse'>[](%2249#git-config-submodulerecurse "")submodule.recurse</dt><dd>
...
</dd><dt id='git-config-submodulefetchJobs'>[](%2249#git-config-submodulefetchJobs "")submodule.fetchJobs</dt><dd>
...
</dd><dt id='git-config-submodulealternateLocation'>[](%2249#git-config-submodulealternateLocation "")submodule.alternateLocation</dt><dd>
...
</dd><dt id='git-config-submodulealternateErrorStrategy'>[](%2249#git-config-submodulealternateErrorStrategy "")submodule.alternateErrorStrategy</dt><dd>
...
</dd><dt id='git-config-tagforceSignAnnotated'>[](%2249#git-config-tagforceSignAnnotated "")tag.forceSignAnnotated</dt><dd>
...
</dd><dt id='git-config-tagsort'>[](%2249#git-config-tagsort "")tag.sort</dt><dd>
...
</dd><dt id='git-config-tarumask'>[](%2249#git-config-tarumask "")tar.umask</dt><dd>
...
</dd><dt id='git-config-transferfsckObjects'>[](%2249#git-config-transferfsckObjects "")transfer.fsckObjects</dt><dd>

When`fetch.fsckObjects`or`receive.fsckObjects`are not set, the value of this variable is used instead. Defaults to false.

</dd><dt id='git-config-transferhideRefs'>[](%2249#git-config-transferhideRefs "")transfer.hideRefs</dt><dd>
...
</dd><dt id='git-config-transferunpackLimit'>[](%2249#git-config-transferunpackLimit "")transfer.unpackLimit</dt><dd>
...
</dd><dt id='git-config-uploadarchiveallowUnreachable'>[](%2249#git-config-uploadarchiveallowUnreachable "")uploadarchive.allowUnreachable</dt><dd>
...
</dd><dt id='git-config-uploadpackhideRefs'>[](%2249#git-config-uploadpackhideRefs "")uploadpack.hideRefs</dt><dd>
...
</dd><dt id='git-config-uploadpackallowTipSHA1InWant'>[](%2249#git-config-uploadpackallowTipSHA1InWant "")uploadpack.allowTipSHA1InWant</dt><dd>
...
</dd><dt id='git-config-uploadpackallowReachableSHA1InWant'>[](%2249#git-config-uploadpackallowReachableSHA1InWant "")uploadpack.allowReachableSHA1InWant</dt><dd>
...
</dd><dt id='git-config-uploadpackallowAnySHA1InWant'>[](%2249#git-config-uploadpackallowAnySHA1InWant "")uploadpack.allowAnySHA1InWant</dt><dd>

Allow`upload-pack`to accept a fetch request that asks for any object at all. Defaults to`false`.

</dd><dt id='git-config-uploadpackkeepAlive'>[](%2249#git-config-uploadpackkeepAlive "")uploadpack.keepAlive</dt><dd>
...
</dd><dt id='git-config-uploadpackpackObjectsHook'>[](%2249#git-config-uploadpackpackObjectsHook "")uploadpack.packObjectsHook</dt><dd>
...
</dd><dt id='git-config-uploadpackallowFilter'>[](%2249#git-config-uploadpackallowFilter "")uploadpack.allowFilter</dt><dd>
...
</dd><dt id='git-config-urlltbasegtinsteadOf'>[](%2249#git-config-urlltbasegtinsteadOf "")url.&lt;base&gt;.insteadOf</dt><dd>
...
</dd><dt id='git-config-urlltbasegtpushInsteadOf'>[](%2249#git-config-urlltbasegtpushInsteadOf "")url.&lt;base&gt;.pushInsteadOf</dt><dd>
...
</dd><dt id='git-config-useremail'>[](%2249#git-config-useremail "")user.email</dt><dd>
...
</dd><dt id='git-config-username'>[](%2249#git-config-username "")user.name</dt><dd>
...
</dd><dt id='git-config-useruseConfigOnly'>[](%2249#git-config-useruseConfigOnly "")user.useConfigOnly</dt><dd>
...
</dd><dt id='git-config-usersigningKey'>[](%2249#git-config-usersigningKey "")user.signingKey</dt><dd>
...
</dd><dt id='git-config-versionsortprereleaseSuffixdeprecated'>[](%2249#git-config-versionsortprereleaseSuffixdeprecated "")versionsort.prereleaseSuffix (deprecated)</dt><dd>

Deprecated alias for`versionsort.suffix`. Ignored if`versionsort.suffix`is set.

</dd><dt id='git-config-versionsortsuffix'>[](%2249#git-config-versionsortsuffix "")versionsort.suffix</dt><dd>
...
</dd><dt id='git-config-webbrowser'>[](%2249#git-config-webbrowser "")web.browser</dt><dd>
...
</dd><dt id='git-config-worktreeguessRemote'>[](%2249#git-config-worktreeguessRemote "")worktree.guessRemote</dt><dd>
