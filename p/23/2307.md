...
<dl><dt id='git-cat-file-ltobjectgt'>&lt;object&gt;</dt><dd>
...
</dd><dt id='git-cat-file--t'>-t</dt><dd>

Instead of the content, show the object type identified by &lt;object&gt;.

</dd><dt id='git-cat-file--s'>-s</dt><dd>

Instead of the content, show the object size identified by &lt;object&gt;.

</dd><dt id='git-cat-file--e'>-e</dt><dd>
...
</dd><dt id='git-cat-file--p'>-p</dt><dd>

Pretty-print the contents of &lt;object&gt; based on its type.

</dd><dt id='git-cat-file-lttypegt'>&lt;type&gt;</dt><dd>
...
</dd><dt id='git-cat-file---textconv'>--textconv</dt><dd>
...
</dd><dt id='git-cat-file---filters'>--filters</dt><dd>
...
</dd><dt id='git-cat-file---pathltpathgt'>--path=&lt;path&gt;</dt><dd>
...
</dd><dt id='git-cat-file---batch'>--batch</dt><dt id='git-cat-file---batchltformatgt'>--batch=&lt;format&gt;</dt><dd>
...
</dd><dt id='git-cat-file---batch-check'>--batch-check</dt><dt id='git-cat-file---batch-checkltformatgt'>--batch-check=&lt;format&gt;</dt><dd>
...
</dd><dt id='git-cat-file---batch-all-objects'>--batch-all-objects</dt><dd>
...
</dd><dt id='git-cat-file---buffer'>--buffer</dt><dd>
...
</dd><dt id='git-cat-file---allow-unknown-type'>--allow-unknown-type</dt><dd>

Allow -s or -t to query broken/corrupt objects of unknown type.

</dd><dt id='git-cat-file---follow-symlinks'>--follow-symlinks</dt><dd>
...
## BATCH OUTPUT<a name="_batch_output"></a>
...
<dl><dt id='git-cat-file-codeobjectnamecode'>`objectname`</dt><dd>

The 40-hex object name of the object.

</dd><dt id='git-cat-file-codeobjecttypecode'>`objecttype`</dt><dd>

The type of the object (the same as`cat-file -t`reports).

</dd><dt id='git-cat-file-codeobjectsizecode'>`objectsize`</dt><dd>

The size, in bytes, of the object (the same as`cat-file -s`reports).

</dd><dt id='git-cat-file-codeobjectsizediskcode'>`objectsize:disk`</dt><dd>

The size, in bytes, that the object takes up on disk. See the note about on-disk sizes in the`CAVEATS`section below.

</dd><dt id='git-cat-file-codedeltabasecode'>`deltabase`</dt><dd>
...
</dd><dt id='git-cat-file-coderestcode'>`rest`</dt><dd>
