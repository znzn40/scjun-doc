...
version:0
lang:zh
rawUrl:https://developer.mozilla.org/en-US/docs/Web/CSS/-ms-flow-from
---
...
The**`-ms-flow-from`**[CSS]427 "")property is a[Microsoft extension]28320 "")that gets or sets a value identifying a region container in the document that accepts the content flow from the data source.
