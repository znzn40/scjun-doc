...
version:0
lang:zh
rawUrl:https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/Global_Objects/Atomics/sub
---



<bdi>我们的志愿者还没有将这篇文章翻译为<bdi>中文 (简体)</bdi>。[加入我们帮助完成翻译]45261 "")<br></br>您也可以阅读此文章的[English (US)]45250 "")版。</bdi>
...
<iframe src='https://interactive-examples.mdn.mozilla.net/pages/js/atomics-sub.html' width='100%' height='250'></iframe>
...
[ECMAScript Latest Draft (ECMA-262)<br></br><small>The definition of &#39;Atomics.sub&#39; in that specification.</small>]45262 "") | Draft | Initial definition in ES2017. 
...
* [`Atomics.add()`]45243 "The static Atomics.add() method adds a given value at a given position in the array and returns the old value at that position. This atomic operation guarantees that no other write happens until the modified value is written back.")
