...
version:0
lang:zh
rawUrl:https://developer.mozilla.org/zh-CN/docs/Web/CSS/padding-block-end
---



<bdi>我们的志愿者还没有将这篇文章翻译为<bdi>中文 (简体)</bdi>。[加入我们帮助完成翻译]31481 "")<br></br>您也可以阅读此文章的[English (US)]31482 "")版。</bdi>
...
The`padding-block-end`property takes the same values as the[`padding-left`]31486 "The padding-left CSS property sets the width of the padding area on the left side of an element.")property.
...
<iframe src='https://mdn.mozillademos.org/en-US/docs/Web/CSS/padding-block-end$samples/Example?revision=1319181' width='140' height='140'></iframe>
...
Specification | Status | Comment 
 ---  |  ---  |  ---  | 
[CSS Logical Properties and Values Level 1<br></br><small>The definition of &#39;padding-block-end&#39; in that specification.</small>]31490 "") | Editor&#39;s Draft | Initial definition 
