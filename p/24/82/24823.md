...
[开发版本](%24975 "")包含完整的警告和调试模式

[生产版本](%24976 "")删除了警告，30.90KB min+gzip
...
在用 Vue 构建大型应用时推荐使用 NPM 安装<sup>[[1]](%24823#footnote-1 "")</sup>。NPM 能很好地和诸如[webpack](%1019 "")或[Browserify](%24984 "")模块打包器配合使用。同时 Vue 也提供配套工具来开发[单文件组件](%24799 "")。
...
<small>
**译者注**
[1] 对于中国大陆用户，建议将 NPM 源设置为[国内的镜像](%25011 "")，可以大幅提升安装速度。
</small>
