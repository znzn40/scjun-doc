...
version:0
lang:zh
rawUrl:https://developer.mozilla.org/en-US/docs/Web/CSS/mask-size
---
...
**This is an[experimental technology](%3404 "")**<br></br>Check the[Browser compatibility table](%35270 "")carefully before using this in production.
...
* using the keyword`[contain](%35271 "")`
* using the keyword`[cover](%35272 "")`
...
* If only one value is given it sets the width, with the height set to`[auto](%35273 "")`.
* If two values are given, the first sets width and the second sets height.


Each value can be a`[&lt;length&gt;](%35274 "")`, a`[&lt;percentage&gt;](%35275 "")`, or`[auto](%35273 "")`.
