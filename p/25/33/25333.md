...
## [类 Flux 状态管理的官方实现](%25764 "类 Flux 状态管理的官方实现")<a name="类-Flux-状态管理的官方实现"></a>
...
### [React 的开发者请参考以下信息](%25766 "React 的开发者请参考以下信息")<a name="React-的开发者请参考以下信息"></a>
...
## [简单状态管理起步使用](%25768 "简单状态管理起步使用")<a name="简单状态管理起步使用"></a>
