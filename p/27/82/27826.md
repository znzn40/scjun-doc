...
version:0
lang:zh
rawUrl:https://developer.mozilla.org/zh-CN/docs/Web/CSS/border-block-start-width
---



<bdi>我们的志愿者还没有将这篇文章翻译为<bdi>中文 (简体)</bdi>。[加入我们帮助完成翻译]28883 "")<br></br>您也可以阅读此文章的[English (US)]28852 "")版。</bdi>
...
<iframe src='https://mdn.mozillademos.org/en-US/docs/Web/CSS/border-block-start-width$samples/Example?revision=1314879' width='140' height='140'></iframe>
...
Specification | Status | Comment 
 ---  |  ---  |  ---  | 
[CSS Logical Properties and Values Level 1<br></br><small>The definition of &#39;border-block-start-width&#39; in that specification.</small>]28884 "") | Editor&#39;s Draft | Initial definition 
