...
## [](%24751 "")Typical setup<a name="_typical_setup"></a>
...
### [](%24753 "")Data Structures<a name="_data_structures"></a>
<dl><dt id='api-credentials-codestructcredentialcode'>[](%24754 "")`struct credential`</dt><dd>
...
### [](%24755 "")Functions<a name="_functions"></a>
<dl><dt id='api-credentials-codecredentialinitcode'>[](%24756 "")`credential_init`</dt><dd>

Initialize a credential structure, setting all fields to empty.

</dd><dt id='api-credentials-codecredentialclearcode'>[](%24757 "")`credential_clear`</dt><dd>

Free any resources associated with the credential structure, returning it to a pristine initialized state.

</dd><dt id='api-credentials-codecredentialfillcode'>[](%24758 "")`credential_fill`</dt><dd>
...
</dd><dt id='api-credentials-codecredentialrejectcode'>[](%24759 "")`credential_reject`</dt><dd>
...
</dd><dt id='api-credentials-codecredentialapprovecode'>[](%24760 "")`credential_approve`</dt><dd>
...
</dd><dt id='api-credentials-codecredentialfromurlcode'>[](%24761 "")`credential_from_url`</dt><dd>
...
### [](%24762 "")Example<a name="_example"></a>
...
## [](%24763 "")Credential Helpers<a name="_credential_helpers"></a>
...
<dl><dt id='api-credentials-codegetcode'>[](%24764 "")`get`</dt><dd>

Return a matching credential, if any exists.

</dd><dt id='api-credentials-codestorecode'>[](%24765 "")`store`</dt><dd>

Store the credential, if applicable to the helper.

</dd><dt id='api-credentials-codeerasecode'>[](%24766 "")`erase`</dt><dd>
...
## [](%24767 "")See also<a name="_see_also"></a>
