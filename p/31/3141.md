...
version:0
lang:zh
rawUrl:https://developer.mozilla.org/zh-CN/docs/Web/API/SVGGlyphElement
---



<bdi>我们的志愿者还没有将这篇文章翻译为<bdi>中文 (简体)</bdi>。[加入我们帮助完成翻译]17908 "")<br></br>您也可以阅读此文章的[English (US)]17909 "")版。</bdi>
...
**Deprecated**<br></br>This feature has been removed from the Web standards. Though some browsers may still support it, it is in the process of being dropped. Avoid using it and update existing code if possible; see the[compatibility table](%3141#Browser_compatibility "")at the bottom of this page to guide your decision. Be aware that this feature may cease to work at any time.





The**`SVGGlyphElement`**interface corresponds to the[`<glyph>`]17911 "A <glyph> defines a single glyph in an SVG font.")element.



Object-oriented access to the attributes of the`<glyph>`element via the SVG DOM is not possible.

<iframe src='https://mdn.mozillademos.org/en-US/docs/Web/API/SVGGlyphElement$samples/inheritance_diagram?revision=1377383' width='600' height='70'></iframe>
...
[Scalable Vector Graphics (SVG) 1.1 (Second Edition)<br></br><small>The definition of &#39;SVGGlyphElement&#39; in that specification.</small>]17912 "") | Recommendation | Initial definition 
...
* [`<glyph>`]17911 "A <glyph> defines a single glyph in an SVG font.")
...
**最后编辑者:**[fscholz]60 ""),<time>Apr 27, 2018, 5:27:55 AM</time>
