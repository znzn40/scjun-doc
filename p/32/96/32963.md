...
version:0
lang:zh
rawUrl:https://developer.mozilla.org/en-US/docs/Web/CSS/:-moz-system-metric(scrollbar-end-forward)
---
...
The**`:-moz-system-metric(scrollbar-end-forward)`**[CSS]427 "")[pseudo-class]29702 "")will match an element if the computer&#39;s user interface includes a forward arrow button at the end of scrollbars.
